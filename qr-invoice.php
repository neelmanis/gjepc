...
else { $registration_id = intval(filter($_SESSION['USERID']));  }
?>
...
$query4 = $conn ->query("select membership_issued_dt,membership_renewal_dt,invoice_no,invoice_date,receipt_no,receipt_date,membership_type from approval_master where registration_id='$registration_id'");
...
<a id="prints" onClick="PrintContent();" target="_blank" style="cursor:pointer;float:right;color:#FF0000;font-size:13px;">Print</a>

<table style="margin:0 auto; text-align:center; font-family: 'Roboto', sans-serif; font-size:10px;" cellpadding="0" cellspacing="0" align="center">

<tr><td><h1 style="font-size:13px;">The Gem and Jewellery Export Promotion Council</h1></td></tr>
<tr><td><?php echo $result5['region_address'];?><br/> State : <?php echo $result5['state'];?> GST : <?php echo $result5['gst_no'];?></td>
</tr>

<tr><td><h1 style="font-size:11px;"><u>Membership Invoice</u></h1></td></tr>
<tr>
<td style="cursor:pointer;float:right;color:#FF0000;font-size:13px;"><img src="https://chart.googleapis.com/chart?chs=228x228&cht=qr&chl=<?php echo $result3['qr_code'];?>&choe=UTF-8" title="Membership Invoice"/></td>
</tr>
...
<tr>
<td>IRN : <?php echo $result3['irn'];?></td>
<td>&nbsp;</td>
</tr>
...
<tr style="height:2px;"><td><hr></td></tr>
...
<tr style="height:1px;"><td><hr></td></tr>
...
<td></td>
<td align="right">For The Gem &amp; Jewellery Export Promotion Council</td>
</tr>
