...
<section class="py-5">	
    <div class="container inner_container">	
		<div class="row justify-content-center grey_title_bg">           	
			...
			<div class="d-block"><img src="assets/images/gold_star.png"></div><strong>परिचय कार्ड आवेदन फॉर्म</strong></div>                    
        </div>  
        ...
        <div class="langBtn d-table mx-auto" style="position:relative; top:auto">
            <div class="d-flex justify-content-center mb-3 lang_switcher">
                <div><button onclick="location.href = 'add-karigar-person.php';" class="lang">English</button></div>
                <div><button onclick="location.href = 'add-karigar-person-hindi.php?via=person';" class="lang active">Hindi</button></div>
            </div>
        </div>              	           
     </div>       
				...
				<?php if(isset($signup_aadhar)){ echo '<div class="alert alert-danger" role="alert">'.$signup_aadhar.'</div>';} ?>
                        ...
                        <div class="row"> 
                         <div class="col-12 mb-3">
                          	<ul class="inner_under_listing">ध्यान दें:
							...
							<div class="form-group col-sm-6">
								<label for="Company"><input type="radio" name="valueType" id="companyType" value="companyType" class="mr-2">
                              	कंपनी<span>*</span></label>
                                <label class="d-inline-block mr-4"></label>
                               <label for="Association"> <input type="radio" name="valueType" id="associationType" value="associationType" class="mr-2">
                                	एसोसिएशन<span>*</span></label>                              
                            </div>
                            ...
                            <div class="form-group col-sm-6">
								<label class="form-label" for="gender"><strong>लिंग</strong></label>
                                <div class="d-flex mt-2">                                
                                    <div class="mr-3">
                                    <label for="Male"><input type="radio" id="gender" name="gender" value="Male"> पुरूष</label>
									</div>                                    
                                    <div class="mr-3">
                                    <label for="Female"><input type="radio" id="gender" name="gender" value="Female"> महिला</label>
									</div>                                    
                                    <div>
                            ...
                            <div class="form-group col-sm-6">
                                <label for="blood_group">बल्ड ग्रुप </label>
                            ...
                            <div class="form-group col-sm-6">
								<label class="form-label" for="education"><strong>शैक्षणिक योग्यता</strong></label>
                                <div class="d-flex mt-2"> 
                                <div class="mr-3">
                                    <label for="Yes"><input type="radio" id="education" name="education" value="Below 10">10 वीं से नीचे</label>		</div>                                    
                                    <div class="mr-3">
                                    <label for="Yes"><input type="radio" id="education" name="education" value="10"> 10 वीं</label>		</div>
                                                                   
                                    <div class="mr-3">
                                    <label for="No"><input type="radio" id="education" name="education" value="12"> 12 वीं</label>		</div>                                    
                                    <div class="mr-3">
                                    <label for="No"><input type="radio" id="education" name="education" value="graduate"> ग्रेजुएट</label>	</div>                                    
                                    <div>
                                    <label for="No"><input type="radio" id="education" name="education" value="p_graduate"> पोस्ट- ग्रेजुएट</label>				
                                    </div>
                                </div>
							</div>
                            
                            <div class="form-group col-sm-6">
                            <label class="form-label" for="id_proof">आयडी प्रुफ अपलोड करें</label>
                            <input type="file" id="id_proof" name="id_proof" class="form-control" autocomplete="off">
                             <i>(आधार कार्ड/वोटर आयडी/ड्रांइविंग लाइसेंस)</i>
							</div>
							
                            <div class="form-group col-12">
                            <p class="blue">संपर्क हेतु जानकारी</p>
                            </div>
                            
                            <div class="form-group col-sm-6 col-md-4">
                            <label for="mobile1">मोबाइल1<span>*</span></label>
							...
							<div class="form-group col-sm-4">
                            <label for="enter_otp">OTP डालें <span>*</span></label><div id="error" style="color:#FF0000;padding-left:50px;"></div>
                            ...
                            <div class="form-group col-sm-6 col-md-4">
                            <label for="mobile2">मोबाइल 2</label>
                            ...
                            <div class="form-group col-sm-6 col-md-4">
                            <label for="state">राज्य <span>*</span></label>
                            ...
                            <div class="form-group col-sm-6 col-md-4">
                            <label for="authorised_mobile1">पिनकोड <span>*</span></label>
                            <input type="text" class="form-control numeric" id="p_pin_code" name="p_pin_code" value="<?php echo $p_pin_code;?>" autocomplete="off" maxlength="6" onkeypress="if(this.value.length==6) return false;">		
								...
								<div class="form-group col-12">
                                	...
                                	<div class="d-block"><label for="Current Address">कंरट एड्रेस<span>*</span></label></div>
                                	<div class="row">
                                	<div class="col-6">
                                    <label for="Yes" style="font-size:13px; font-style:italic;">
                                     <input type="radio" name="address" value="YES" onclick="data_copy()";>कृपा कर यहाँ टिक करें यदि आपका परमानेंट  एड्रेस और कंरट एड्रेस एक ही है।</label>		
									</div>
									<div class="col-6">
                                    <label for="Yes" style="font-size:13px; font-style:italic;">
                            ...
                            <div class="form-group col-sm-6 col-md-4">
                            <label for="authorised_mobile1">पिनकोड</label>
                            ...
                            <div class="form-group col-12">
                                <p class="blue">बैंक का विवरण</p>
                            </div>
                            
                            <div class="form-group col-sm-6">
                                <label for="authorised_mobile1">बैंक का नाम</label>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="d-flex mt-2">
                                    ...
                                    <div class="mr-3">
                                        <label for="Yes">
                                        <input type="radio" id="employment_status" value="Permanent" name="employment_status"> परमानेंट </label>				
                                    </div>                                    
                                    <div class="mr-3">
                                        <label for="No">
                                        <input type="radio" id="employment_status" value="Contracted" name="employment_status"> कोंट्रक्टेड</label>					
                                    </div>                                    
                                    <div>
                                        <label for="No">
                                        <input type="radio" id="employment_status" value="Unemployed" name="employment_status"> बेरोजगार</label>					
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-sm-6">
                            <label for="authorised_mobile1">रत्न तथा आभूषण उद्योग जगत में कुल अनुभव (साल में) </label>
                            <input type="number" class="form-control" id="work_experience" name="work_experience" maxlength="2" autocomplete="off">		
                            </div>
                            
                            <div class="form-group col-sm-6">
								<label class="form-label" for="applicable_industry"><strong>एप्लीकेबल  इंडस्ट्री </strong></label>
                                <div class="d-flex mt-2">
                                
                                    <div class="mr-3">
                                        <label for="Yes">
                                        <input type="radio" id="applicable_industry" value="Diamond" name="applicable_industry"> डायमंड </label>						
                                    </div>                                    
                                    <div class="mr-3">
                                        <label for="No">
                                        <input type="radio" id="applicable_industry" value="Gemstones" name="applicable_industry"> जेमस्टोन</label>					
                                    </div>                                    
                                    <div>
                                        <label for="No">
                                        <input type="radio" id="applicable_industry" value="Jewellery" name="applicable_industry"> ज्वेलरी</label>					
                                    </div>                                    
                                </div>
                            ...
                            <div class="form-group col-12">
								<label class="form-label" for="applicable_skill"><strong>लागू स्किल पर टिक करें </strong> (लागू होने वाले सभी का चयन करें)</label>
                                <div class="row mt-2">
                                
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="mould" name="applicable_skills[]"> मॉडल और मोल्ड बनाना </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="finishing" name="applicable_skills[]"> फिनिशिंग / पॉलिशिंग </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="retail" name="applicable_skills[]"> खुदरा बिक्री </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="waxing" name="applicable_skills[]"> वैक्सिंग </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="grading" name="applicable_skills[]"> ग्रेडिंग </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="grinding" name="applicable_skills[]"> ग्राइंडिंग  और असेंबली</label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="procurement" name="applicable_skills[]"> प्रोक्योरमेंट </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="casting" name="applicable_skills[]"> कास्टिंग</label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="trading" name="applicable_skills[]"> ट्रेडिंग</label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                    <label for="Yes">
                                    <input type="checkbox" id="applicable_skills" value="assortment" name="applicable_skills[]"> एसोर्टमेन्ट  और प्लानिंग </label>			
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="admin" name="applicable_skills[]"> एडमिन /एचआऱ/फाइनेंस  </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="handcrafting" name="applicable_skills[]">  हैंडक्राफ्टिंग   </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes"> <input type="checkbox" id="applicable_skills" value="setting" name="applicable_skills[]"> सेंटिंग </label>						
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="designing" name="applicable_skills[]"> डिज़ाइन बनाना </label>					
                                    </div> 
									<div class="col-md-4">
                                        <label for="Yes">
                                        <input type="checkbox" id="applicable_skills" value="cutting" name="applicable_skills[]"> कटिंग / पॉलिशिंग / फेसिंग </label>					
                                    </div>
									<div class="col-md-4">
                                    <label for="Yes">
                            ...
                            <div id="kosh">
                            <div class="form-group col-12">
                                <p class="blue"><label> <input type="checkbox" id="swasthya_kosh_option" class="mr-3" value="Y" name="swasthya_kosh_option">यदि आप स्वास्थ्य बीमा योजना का चयन करना चाहते हैं तो कृपया (√) पर निशान लगाएं - स्वास्थ्य कोष (केवल संविदा कर्मचारी के लिए)</label> </p>
                                <p class="blue">नोट: स्वयं और पत्नी के 80 वर्ष से कम और केवल 25 वर्ष से कम उम्र के बच्चे के लिए</p>
                            </div>
                            ...
                            <div class="form-group col-12" >
                              ...
                              <div class="form-group col-12">
                        	<label><input type="checkbox" name="agree_terms" value="yes" id="agree_terms"> नियम और शर्तें स्वीकार करें देखने के लिए यहां क्लिक करें</label>
