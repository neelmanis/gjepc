...
if(isset($_SESSION['token']) && $_POST['token'] === $_SESSION['token']) {
	...
	$sql="insert into tender_download_info (company_name,name,email,mobile,address,download_status,tender_id,post_date) values ('$company_name','$name','$email','$mobile','$address','1','$pdf_id','$post_date')";
	...
	echo "<script type='text/javascript'> alert('Invalid Token');window.location.href='tenders.php';</script>";	
}
?>