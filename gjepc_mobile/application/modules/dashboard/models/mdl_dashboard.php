...
function rent_seller($regId)
{
	...
	$sql="Select orderitem.*,product.* from orderitem,orders,product where orders.orderId=orderitem.orderId AND orderitem.productId=product.proId AND orderitem.rentID=$regId AND orderitem.status='Y' AND orderitem.transactionStatus='Y' AND orderitem.productTo >= NOW() ";
...
{
	$sql="Select orderitem.*,product.*,orderitem.rentID as renterId from orderitem,orders,product where orders.orderId=orderitem.orderId AND orderitem.productId=product.proId AND orders.regId=$regId AND orderitem.status='P' AND orderitem.transactionStatus='P' ";
	$query=$this->db->query($sql);
	return $query->result();
}
...
function borrow_disapproved($regId)
{
	...
	$sql="Select orderitem.*,product.*,orderitem.rentID as renterId from orderitem,orders,product where orders.orderId=orderitem.orderId AND orderitem.productId=product.proId AND orders.regId=$regId AND orderitem.status='N' AND orderitem.transactionStatus='N' ";
	$query=$this->db->query($sql);
	return $query->result();
}
...
function borrow_order_history($regId)
{
	...
	$sql="Select orderitem.*,product.*,orderitem.rentID as renterId from orderitem,orders,product where orders.orderId=orderitem.orderId AND orderitem.productId=product.proId AND orders.regId=$regId AND orderitem.status='Y' AND orderitem.transactionStatus='Y' order by orderitem.orderItemId DESC";
	$query=$this->db->query($sql);
	return $query->result();	
}
//----------------wishlist-------------------
...
{
	$sql="Select orderitem.*,product.*,orderitem.rentID as renterId from orderitem,orders,product where orders.orderId=orderitem.orderId AND orderitem.productId=product.proId AND orderitem.rentID=$regId AND orderitem.status='P' AND orderitem.transactionStatus='P' ";
	$query=$this->db->query($sql);
	return $query->result();
...
{
	$sql="Select orderitem.*,product.*,orderitem.rentID as renterId, sum(orderitem.productPrice) as total_price from orderitem,orders,product where orders.orderId=orderitem.orderId AND orderitem.productId=product.proId AND orderitem.rentID=$regId AND orderitem.status='Y' AND orderitem.transactionStatus='Y' group by orderitem.productId order by orderitem.orderItemId DESC ";
	$query=$this->db->query($sql);
	return $query->result();
...
{
	$sql="Select orderitem.*,product.*,orderitem.rentID as renterId, registration.lastLogin from orderitem,orders,product,registration where orders.orderId=orderitem.orderId AND orderitem.productId=product.proId AND orders.orderId=registration.regId AND orders.regId=$regId AND orderitem.status='Y' AND orderitem.transactionStatus='Y' AND registration.lastLogin <= orderitem.modifiedDate order by orderitem.orderItemId DESC ";
	$query=$this->db->query($sql);
	return $query->result();
...
{
	$sql="select orderitem.productId,orderitem.orderId,orders.regId from orderitem,orders where orderitem.orderItemId=$orderItemId AND orderitem.orderId=orders.orderId";
	$query=$this->db->query($sql);
	return $query->result();
...
{
	$sql="select orderitem.rentID orderitem,orders where orders.orderId=$orderId AND orderitem.orderId=orders.orderId";
	$query=$this->db->query($sql);
	return $query->result();
...
function add_address()
{
		...
		$this->form_validation->set_rules('addtitle','title','trim|required|max_length[100]|xss_clean');
...
//----------------------- get produc detail from product	
