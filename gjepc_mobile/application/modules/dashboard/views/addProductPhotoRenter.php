...
if($before=='') 
	 { ?> 
		 ...
		 <div class="form-group row">
				<form id="imageuploadArrivalRenter">
				  ...
				  <input type="hidden" name="renterId" value="<?php //echo $renterId; ?>" />
				   <input type="hidden" name="type" value="renter-departure" />
...
if($before!='') 
  ...
  <?php  if($after=='') 
	 { ?>        
		  <div class="form-group row">
				<form id="imageuploadDepartureRenter">
				  ...
				  <div class="col-xs-6 col-md-3">
				   ...
				   <input type="hidden" name="orderItemId" value="<?php echo $orderItemId; ?>" />
				  <input type="hidden" name="renterId" value="<?php //echo $renterId; ?>" />
				   <input type="hidden" name="type" value="renter-arrival" />
				  <div class="form-group text-center">
					<input type="submit" class="btn" value="Upload All" >
				 </div>
				</form>	
