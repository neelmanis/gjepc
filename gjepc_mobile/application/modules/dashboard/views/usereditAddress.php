...
?>
<div class="col-sm-9">
          <form class="profile FlowupLabels" id="edit_address">
            <fieldset>
			  ...
			  <div class="validError">
                ...
                <div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="addtitle" id="addtitle" value="<?php echo $add->title;?>">
              ...
              <div class="form-group row">
                <div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="firstName" value="<?php echo $add->firstName?>" id="firstName" >
				    <span id="first" class="error"></span>
				     <!--<div class="right" id="first_right"><img src="<?php echo base_url()?>assets/images/right.png"></div>
                     <div class="wrong" id="first_wrong"><img src="<?php echo base_url()?>assets/images/wrng.png"></div> -->          
                </div>
			 </div>
			  ...
			  <div class="form-group row">
				 ...
				 <div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="MiddleName" value="<?php echo $add->MiddleName ?>" >
                </div>
			 </div>
			   ...
			   <div class="form-group row">              
                <div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="lastName" id="lastName"  value="<?php echo $add->lastName?>"/> 
				  <span id="last" class="error"></span>
					<!--<div id="last_right" class="right"><img src="<?php echo base_url()?>assets/images/right.png"></div>
			   ...
			   <div class="form-group row">              
                <div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="building" id="building" value="<?php echo $add->building?>">
					 <span class="error" id="build"></span>
				    <!-- <div id="build_right" class="right"><img src="<?php echo base_url()?>assets/images/right.png"></div>
				...
				<div class="form-group row">              
                 <div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="street" id="street"  value="<?php echo $add->street?>" >
				   <span class="error" id="street_text"></span>
                   <!--<div id="street_right" class="right"><img src="<?php echo base_url()?>assets/images/right.png"></div>
			   ...
			   <div class="form-group row">              
                <div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="pincode"  id="pincode" value="<?php echo $add->pincode?>" >
						<span class="error" id="pin_code"></span>
                       <!-- <div id="pin_right" class="right"><img src="<?php echo base_url()?>assets/images/right.png"></div>
				...
				<div class="col-xs-6 fl_wrap">
                  ...
                  <input type="text" class="form-control fl_input" name="mobileNo"  id="mobile" value="<?php echo $add->mobileNo?>">
					<span class="error" id="contact"></span>
					  <!-- <div id="phone_right" class="right"><img src="<?php echo base_url()?>assets/images/right.png"></div>
			  ...
			  <div class="form-group row">
				...
				<input type="hidden" id="addId" value="<?php echo $add->addId; ?>" />
