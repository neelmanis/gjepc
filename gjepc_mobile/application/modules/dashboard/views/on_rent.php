<!--<form class="container-fluid FlowupLabels">
          ...
          <thead>
		   ...
		   <td data-th="Edit / Delete" class="editDelete"><a href="<?php echo base_url() ?>dashboard/addProductPhoto/<?php echo base64_encode($prod->orderItemId); ?>/renter" class="addProductPhoto" >Add product photos</a></td>
	...
	<?php	}  else { ?>
			 <td class="editDelete"><a href="" class="dispute" id="<?php  echo $prod->orderItemId."-renter"; ?>">Dispute</a></td>
