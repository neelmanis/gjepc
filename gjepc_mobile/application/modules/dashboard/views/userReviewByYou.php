...
<div class="col-sm-9">
          <div class="reviewTab"><a href="<?php echo base_url()?>dashboard/review_about_you/<?php echo $userId; ?>" >Reviews About You <span>(<?php echo $countAbout; ?>)</span></a><a class="active" href="<?php echo base_url()?>dashboard/review_by_you/<?php echo $userId; ?>">Reviews By You <span>(<?php echo $countBy; ?>)</span></a></div>
          <ul class="reviewList">
			<?php 
			if(!empty($review))
			{	
					...
					<li>
						<div class="review">
							<div class="avatar container-fluid">
								<div class="avatarImg"><img src="<?php echo $pic; ?>"></div>
	...
	<?php	}  ?>
		...
		{ ?>	
		  ...
		  <a  id="<?php echo $reviewId; ?>" class="loadMoreButton loadMoreButtonByYou">Load more </a>
		  </div>
