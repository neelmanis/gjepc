...
<div class="form-panel">
        <h4 class="mb">Edit Firebase Details</h4>
		
			<?php
			if(is_array($editmsg)){
            foreach($editmsg as $row){
			 //echo '<pre>';print_r($row);
			?>
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("firebase/updateMsg");?>" enctype="multipart/form-data">
