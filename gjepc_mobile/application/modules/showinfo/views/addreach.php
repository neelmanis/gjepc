<div class="form-panel">
        <h4 class="mb">Add How to Reach Details</h4>
			 
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("showinfo/addreachDetails");?>" enctype="multipart/form-data">		
