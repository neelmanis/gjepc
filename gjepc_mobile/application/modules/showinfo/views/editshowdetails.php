<div class="form-panel">
        <h4 class="mb">Edit Show Details</h4>
        	
			<?php
			if(is_array($editshowdetails)){
            foreach($editshowdetails as $row){
			// echo '<pre>';print_r($row);
			?>
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("showinfo/updateDetails");?>" enctype="multipart/form-data">
