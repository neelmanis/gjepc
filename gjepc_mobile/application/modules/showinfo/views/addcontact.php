<div class="form-panel">
        <h4 class="mb">Add Contact Details</h4>
			 
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("showinfo/addContactDetails");?>" enctype="multipart/form-data">		
