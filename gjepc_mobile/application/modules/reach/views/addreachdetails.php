<div class="form-panel">
        <h4 class="mb">Add Details</h4>
			
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("reach/addDetails");?>" enctype="multipart/form-data">			   
