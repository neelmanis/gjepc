<div class="form-panel">
	...
	<form class="form-horizontal style-form categoryform" >
		    ...
		    <div class="col-sm-9">
			<textarea class="form-control" Placeholder="Description Here" name="description" id="description" rows="3" disabled="disabled" required>
			...
			<div class="col-sm-9">
				<a href="<?php echo base_url("show/showList");?>"><button class="btn btn-primary" type="button">BACK</button></a>
			</div>
			</div>			
