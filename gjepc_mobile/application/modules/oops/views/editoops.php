<div class="form-panel">
        <h4 class="mb">Edit Details</h4>
			...
			?>
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("oops/updateDetails");?>" enctype="multipart/form-data">
			...
			<?php if(!empty($row->html_files)) { ?>
				 <a href="<?php echo base_url();?>uploads/oops/<?php echo $row->html_files;?>" target="_blank">Your File</a>
					<?php } ?>
			</div>
			</div>
