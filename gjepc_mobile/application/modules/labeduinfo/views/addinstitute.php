...
<div class="form-panel">
        <h4 class="mb">Add Institues Details</h4>
			 
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("labeduinfo/addInsDetails");?>" enctype="multipart/form-data">		
