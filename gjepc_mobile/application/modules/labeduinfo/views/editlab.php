...
<div class="form-panel">
        <h4 class="mb">Edit Laboratories Details</h4>
			...
			?>
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("labeduinfo/updateLab");?>" enctype="multipart/form-data">
			...
			<?php if(!empty($row->image)) { ?>
				<img src="<?php echo base_url();?>uploads/labandeducation/<?php echo $row->image;?>" width="150">
					<?php } ?>
			</div>
			</div>
