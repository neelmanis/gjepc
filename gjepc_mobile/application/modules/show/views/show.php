<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="content-panel">
        	<h4 style="display: inline-block; padding-right: 1em">Show Updates List</h4>
			
			<a href="<?php echo base_url("show/addshowdetails");?>"><button class="btn btn-primary" type="button">ADD NEW</button></a>
				...
				<tbody>
				  ...
				  ?>
					 <tr>
                        ...
                        <td><?php echo Modules::run('show/eventName',$row['event_name'])?></td>
						<td><?php echo Modules::run('show/yearName',$row['year'])?></td>						
