<div class="form-panel">
        <h4 class="mb">Add Venue Details</h4>
			
			<form method="post" class="form-horizontal style-form categoryform" action="<?php echo base_url("venue/addDetails");?>" enctype="multipart/form-data">			   
