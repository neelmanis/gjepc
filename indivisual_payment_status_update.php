<?php
$querys =  $conn ->query("select * from challan_master where challan_financial_year='2022' and (Response_Code is null || Response_Code!='E000') and registration_id='$registration_id'");
//$querys =  $conn ->query("select * from challan_master where challan_financial_year='2020' and registration_id='$registration_id'");
