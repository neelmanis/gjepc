...
$sqlxy = "SELECT association_registration_no,authorised_email FROM parichay_card WHERE parichay_card_id!='$parichay_card_id'";
...
$val_registration_no = $mysqlrow['association_registration_no'];
...
elseif(in_array($association_registration_no, $match_registration_no))
...
//	echo $sql1;
	...
	if($resultx){
	 echo "<script langauge=\"javascript\">alert(\"Detail has been updated successfully.\");location.href='association_update_details.php';</script>";
...
<section class="py-5">	
    <div class="container inner_container">
		...
		<div class="row justify-content-center grey_title_bg">           	
			...
			<div class="d-block"><img src="assets/images/gold_star.png"></div>Association Registration </div>                    
        </div>
            ...
            <div class="container">				
				...
				<div class="row ab_none justify-content-between align-items-center">
					...
					<strong>Association Enrolment Process</strong></p></div>
                </div>
                    <div class="row mb-4">                    
                            ...
                            <div class="row align-items-center">
                                <div class="col-6 pl-0"><input type="file" id="association_request_letter" name="association_request_letter" class="form-control" autocomplete="off"></div>									
							...
							<input type="text" class="form-control" id="company_name" name="company_name" value="<?php echo $company_name;?>" autocomplete="off" maxlength="70" readonly>
							</div>                    
							...
							<div class="form-group col-sm-6">                            	
                            <label for="association_registration_certificate">Registration certificate of association<span>*</span></label>
                            	...
                            	<div class="row align-items-center">                                	
                                    ...
                                    <div class="col-auto ">
                                    <a href="images/parichay_card/association_registration_certificate/<?php echo $association_registration_certificate;?>"   target="_blank" class="fade_anim cta"> View</a>
                                    </div>
									<?php } ?>                                                                   
                                </div>
                            </div>
							...
							<input type="text" class="form-control" id="association_head_name" name="association_head_name" value="<?php echo $association_head_name;?>" autocomplete="off" maxlength="30">
							</div>
							
							<div class="form-group col-sm-6">
                            <label for="association_head_visiting_card">Visiting card of the association Head</label>
							...
							<div class="form-group col-sm-6">
							<label for="total_member">Total No. of Members in Association as on date </label>
                            ...
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Exporters" <?php if(preg_match('/Exporters/',$nature_of_buisness)){ echo 'checked="checked"'; } ?>>
							<span class="tr" key="Exporters"> Exporters</span>	
                            </div>						
                            
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Manufacturer" <?php if(preg_match('/Manufacturer/',$nature_of_buisness)){ echo 'checked="checked"'; } ?>>
							<span class="tr" key="Manufacturer"> Manufacturer</span>
                            </div>
                            ...
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Brokers" <?php if(preg_match('/Brokers/',$nature_of_buisness)){ echo 'checked="checked"'; } ?>>
							<span class="tr" key="Brokers"> Brokers</span>
                            </div>
							
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Karigars" <?php if(preg_match('/Karigars/',$nature_of_buisness)){ echo 'checked="checked"'; } ?>>
							<span class="tr" key="Karigars"> Karigars</span>
                            </div>
						...
						<div class="form-group col-sm-6">
                        <label for="no_of_parichay_card">No. of Parichay Cards required by your Association</label>
                        <input type="text" class="form-control numeric" id="no_of_parichay_card" name="no_of_parichay_card" value="<?php echo $no_of_parichay_card;?>" autocomplete="off" maxlength="4" onkeypress="if(this.value.length==4) return false;">
                        </div>
						
						<div class="form-group col-12">
                        <label for="association_office_address">Please upload scanned proof of address of association office (Electricity Bill, Phone Bill etc.)</label>	
                        ...
                        <div class="row mb-4"> 
                            ...
                            <div class="form-group col-sm-6">
                                <label for="authorised_mobile1">Mobile 1</label><p id="chkAuthoMob1"></p> 
				...
				<div class="col-lg col-md-12"> 			
                <form class="cmxform box-shadow mb-5" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" autocomplete="off"/>
				...
				<div class="row ab_none justify-content-between align-items-center">
                    ...
                    <div class="row mb-4">                    
                            ...
                            <div class="form-group col-12">
                            <label for="association_request_letter">Request letter of your association</label>
                                                          								
                                <?php if(!empty($association_request_letter)){ ?>
                                <div class="col-6 pl-0">
                                <a href="images/parichay_card/association_request_letter/<?php echo $association_request_letter;?>"   target="_blank" class="fade_anim cta"> View</a>
                                </div>
								<?php } ?>
                            </div>
							...
							<label for="association_registration_no">Registration No. of Association<span>*</span></label>
							<p id="chkRegisNo"></p>						
							<input type="text" class="form-control" id="association_registration_no" name="association_registration_no" value="<?php echo $association_registration_no;?>" autocomplete="off" maxlength="30" readonly>
							</div>
                            ...
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Exporters" <?php if(preg_match('/Exporters/',$nature_of_buisness)){ echo 'checked="checked"'; } ?> disabled>
							<span class="tr" key="Exporters"> Exporters</span>	
                            </div>						
                            
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Manufacturer" <?php if(preg_match('/Manufacturer/',$nature_of_buisness)){ echo 'checked="checked"'; } ?> disabled>
							<span class="tr" key="Manufacturer"> Manufacturer</span>
                            </div>
							
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Retailer" <?php if(preg_match('/Retailer/',$nature_of_buisness)){ echo 'checked="checked"'; } ?> disabled>
							<span class="tr" key="Retailer"> Retailer </span>
                            </div>
							
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Brokers" <?php if(preg_match('/Brokers/',$nature_of_buisness)){ echo 'checked="checked"'; } ?> disabled>
							<span class="tr" key="Brokers"> Brokers</span>
                            </div>
							
                            <div class="col-auto px-2">
                            <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Karigars" <?php if(preg_match('/Karigars/',$nature_of_buisness)){ echo 'checked="checked"'; } ?> disabled>
							<span class="tr" key="Karigars"> Karigars</span>
                            </div>
                            
                            <div>                            
							<span class="tr" key="Other">Others please specify</span>
							<div><input type="text" name="nature_of_buisness[]" id="other" class="form-control" style="width:100px; height:30px;"  autocomplete="off" disabled>
                            </div>                            
                            </div>                            
							</div>
						...
						<div class="form-group col-sm-6">
                        <label for="no_of_parichay_card">No. of Parichay Cards required by your Association</label>
                        <input type="text" class="form-control numeric" id="no_of_parichay_card" name="no_of_parichay_card" value="<?php echo $no_of_parichay_card;?>" autocomplete="off" maxlength="4" onkeypress="if(this.value.length==4) return false;" readonly>
                        </div>
