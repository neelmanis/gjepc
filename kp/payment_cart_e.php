...
$FORM_TYPE="E";
	...
	if($PAYMENT_MST_ID!=''){
		...
		$detail = "insert into kp_payment_details set EXPORT_APP_ID='$EXPORT_APP_ID',PAYMENT_MST_ID='$PAYMENT_MST_ID',RECIEPT_NO='$RECIEPT_NO',APPLICANT_ID ='$APPLICANT_ID',MEMBER_TYPE_ID='$MEMBER_TYPE_ID',MEMBER_ID='$MEMBER_ID',FORM_TYPE='E',TRAN_ID='$TRAN_ID'";
...
<section class="py-5">
	...
	<div class="container inner_container">
		...
		<div class="search_app_div"><p class="error mb-3"> <b>Important information : </b> Dear User, Kindly Use the mozilla firefox browser,for the hassle free transaction for KP applications & avoid using other browsers.</p>		</div>
		<div class="row">
			<div class="col-12">
