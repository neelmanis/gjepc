...
if($i==0){$CARATS1=$result_link['CARATS'];}
if($i==1){$CARATS2=$result_link['CARATS'];}
if($i==2){$CARATS3=$result_link['CARATS'];}
$i++;
}
...
<div class="row justify-content-center no-gutters">
			...
			<form action="import_application_inc.php" class="col-lg-12 box-shadow p-0" method="post" name="form1" id="form1" onSubmit="return validate()" enctype="multipart/form-data">
				<div class="col-md-12  form-block  col-sm-12 col-xs-12 loginform p-3"> 
			
				<div class="row">
					 <div class="form-group col-12 mb-4">
				<p class="blue">Application for endorsement of Kimberley process certificate for IMPORT of rough diamonds into India</p>                          
                <p>Please fill up the Import Application Form below and submit it after attaching the requirement attachments.</p>
						...
						<div class="form-group">
							...
							<select  class="form-control" name="Member" id="Member">
								...
								<option  value="member|<?php echo $rows['MEMBER_ID'];?>" <?php if($rows['MEMBER_ID']==$MEMBER_ID){echo "selected='selected'";}?>>
									<?php echo getMemberName($conn,"Member",$rows['MEMBER_ID']);?>
								</option>
								<?php
									}
									}
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input name="M_DATE" id="M_DATE" class="form-control" type="text" value="<?php echo date('Y-m-d');?>" readonly/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<select  class="form-control" name="M_STATE" id="M_STATE">
								...
								while($rows=mysqli_fetch_array($result))
								{ 
								if($rows['state_code']==$STATE_ID || $rows['state_code']==$M_STATE)
								{
					...
					<div class="col-md-12 form-group ">
						<p class="blue">We are enclosing herewith application for endorsment of Kimberley process certificate for Import of rough diamonds into India as per details given below.</p>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Country Of Provinance: </label>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Select Exporter Name:</label>
							<select name="Exporter_Name" id="Exporter_Name"  class="form-control"  value="<?php echo $LONGNAME; ?>" />					
							</select>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Telephone No 1</label>
							<input name="IE_TEL1" id="IE_TEL1" class="form-control" type="text" readonly value="<?php echo $IE_TEL1;?>" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Telephone No 2</label>
							<input name="IE_TEL2" id="IE_TEL2" class="form-control" type="text" readonly value="<?php echo $IE_TEL2;?>" />
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input name="IE_CITY" class="form-control ac_input" id="IE_CITY" type="text" value="<?php echo $IE_CITY;?>" autocomplete="off" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Pincode:</label>
							<input name="IE_PIN" id="IE_PIN" class="form-control" value="<?php echo $IE_PIN;?>" type="text" readonly/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">KP Certificate No:</label>
							<input name="KP_CERT_NO" id="KP_CERT_NO" class="form-control" type="text" value="<?php echo $KP_CERT_NO;?>" maxlength="30"/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">KP Batch No:</label>
							<input name="KP_BATCH_NO" id="KP_BATCH_NO" class="form-control" type="text" value="<?php echo $KP_BATCH_NO;?>" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Certificate Issue Date:</label>
							<input onkeydown="return false" name="KP_CERT_ISSUE_DATE" id="popupDatepicker" class="form-control" type="text" value="<?php echo $KP_CERT_ISSUE_DATE;?>" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Certificate Expiry Date</label>
							<input onkeydown="return false" name="KP_CERT_EXPIRY_DATE" id="popupDatepicker1" class="form-control" type="text" value="<?php echo $KP_CERT_EXPIRY_DATE;?>" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Invoice No:</label>
							<input name="INVOICE_NO" id="INVOICE_NO" class="form-control" type="text" value="<?php echo $INVOICE_NO;?>" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="star">Invoice Date:</label>
							<input onkeydown="return false" name="INVOICE_DATE" id="popupDatepicker2" class="form-control" type="text" value="<?php echo $INVOICE_DATE;?>" />
						</div>
					</div>
					<div class="col-12">
			...
			<?php }?>
			<div class="col-12">
				<label><input name="Declaration" id="Declaration" type="checkbox" value="Y" checked="checked" /> <strong>Declaration</strong> </label>
			...
			<!--<div class="col-12 form-group">
				<p class="blue">Please Submit physical copies of the following documents along with the application confirmation to the processing location </p>
			</div>
			<div class="col-12">				
				<ul class="inner_under_listing">
					<li>Copy of KP Certificate</li>
					<li>Copy of Airway Bill</li>
					<li>Copy of Duly Signed Invoice of Import under kp</li>
				</ul>
			</div>-->
			...
			<div class="col-12 form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="star">2. Copy of Duly Signed Invoice of Import under KP</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="star">3. Copy of Airway Bill</label>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class=" d-flex justify-content-between p-2">
						...
						<label><input name="PAYMENT_MODE_CHECK" id="PAYMENT_MODE_CHECK" type="checkbox" value="same" /> Address - Same as Above</label>
					</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input name="C_COMPANY_NAME" id="C_COMPANY_NAME" class="form-control" type="text" readonly value="<?php echo $C_COMPANY_NAME;?>" />
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-4">
				<div class="form-group">
					<label class="star">City</label>
					<input name="C_CITY" id="C_CITY" class="form-control" type="text" readonly value="<?php echo $C_CITY;?>" />
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input name="FEES_AMOUNT" id="FEES_AMOUNT" class="form-control" type="text" value="<?php if($FEES_AMOUNT!=""){echo $FEES_AMOUNT;}else{echo $APP_AMOUNT;}?>"  readonly="readonly" />
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-12">
				<input class="cta fade_anim" type="submit" value="Submit" />
...
if(document.getElementById('KP_BATCH_NO').value=="")
{
	alert("Please enter Batch no.!");
	document.getElementById('KP_BATCH_NO').focus();
	return false;
}
...
if(!(PAYMENT_MODE[0].checked || PAYMENT_MODE[1].checked)){
	alert("Please select courier option");
	document.getElementById('PAYMENT_MODE').focus();
	return false;
}
	if(PAYMENT_MODE[1].checked){
	var C_ADDRESS1=document.getElementById('C_ADDRESS1').value;
	var C_CITY=document.getElementById('C_CITY').value;
	var C_PIN=document.getElementById('C_PIN').value;
		if(C_ADDRESS1=="" || C_CITY=="" || C_PIN==""){
			alert("Please enter shipping details");
			document.getElementById('C_COMPANY_NAME').focus();
			return false;
		}
    }
}
	...
	$.ajax({ type: 'POST',
					...
					success: function(data){
						...
						var z=$.trim(data[2]);
							...
							{
								$("#FEES_AMOUNT").val("500");
								if($("#COURIER_AMOUNT").val()!='')
									var COURIER_AMOUNT=parseInt($("#COURIER_AMOUNT").val());
								else
									var COURIER_AMOUNT=0;
								var TOTAL_AMOUNT=COURIER_AMOUNT+parseInt(500);
								var SERVICE_TAX=TOTAL_AMOUNT*18/100;
								$("#TOTAL_AMOUNT").val(Math.round(TOTAL_AMOUNT+SERVICE_TAX));
							}
							else
							{
								...
								if($("#COURIER_AMOUNT").val()!='')
									...
									var COURIER_AMOUNT=0;
								var TOTAL_AMOUNT=COURIER_AMOUNT+parseInt(1500);
								var SERVICE_TAX=TOTAL_AMOUNT*18/100;
								$("#TOTAL_AMOUNT").val(Math.round(TOTAL_AMOUNT+SERVICE_TAX));
							}
						}
