...
<div class="search_app_div">
    <strong>Application for issuance of Kimberley process certificate for Export of rough    diamonds from India</strong>
    <div class="clear"> </div>
</div>

<?php if(isset($AGENT_ID) && $AGENT_ID!=""){
	$sql="select MEMBER_ID,NON_MEMBER_ID from  kp_agent_member_link where AGENT_ID='".$AGENT_ID."' order by MEMBER_ID asc";
?>
<tr>
	<td class="content_txt">Member: <span class="star">*</span></td>
<td>
<select  class="input_txt" name="Member" id="Member">
<option selected="selected" value="">--Select--</option>
<?php 
	   $sql="select MEMBER_ID,NON_MEMBER_ID from  kp_agent_member_link where AGENT_ID='".$AGENT_ID."' order by MEMBER_ID,NON_MEMBER_ID asc";
...
<tr>
<td class="content_txt">Address. <span class="star">*</span></td>
<td>
...
<tr>
<td class="content_txt">Company:</td>
...
<td><input name="M_ADDRESS" id="M_ADDRESS" class="input_txt" type="text" value="<?php if($M_ADDRESS!=""){echo $M_ADDRESS;}else{echo $ADDRESS1;}?>" readonly /></td>

</tr>

<tr>
<td class="content_txt">State: <span class="star">*</span></td>
<td>
...
<tr>
    ...
    <td>
    <input name="M_CITY" class="input_txt" id="M_CITY" type="text" value="<?php echo $M_CITY;?>" autocomplete="off" />
    </td>
</tr>
...
<tr>
    <td class="content_txt">Exporter Name 
(First 3 Letters):</td>
    <td>
    <input name="Exporter_Name" id="Exporter_Name"  class="input_txt" type="text" value="<?php echo $LONGNAME; ?>" />
	<input type="hidden" name="PARTY_ID" id="PARTY_ID" value="<?php echo $PARTY_ID; ?>" />
    </td>
</tr>

<tr>
<td class="content_txt">Importers Name</td>
<td><input name="IE_PARTY_NAME" id="IE_PARTY_NAME" class="input_txt" type="text" readonly value="<?php echo $IE_PARTY_NAME;?>"/></td>
</tr>

<tr>
<td class="content_txt">Address1</td>
<td><input name="IE_ADDRESS1" id="IE_ADDRESS1" class="input_txt" type="text" readonly value="<?php echo $IE_ADDRESS1;?>"/></td>
</tr>

<tr>
<td class="content_txt">Telephone No.</td>
<td><input name="IE_TEL1" id="IE_TEL1" class="input_txt" type="text" readonly value="<?php echo $IE_TEL1;?>" /></td>
</tr>

<tr>
<td class="content_txt">Address2</td>
<td><input name="IE_ADDRESS2" id="IE_ADDRESS2" class="input_txt" type="text" readonly value="<?php echo $IE_ADDRESS2;?>"/></td>
</tr>

<tr>
<td class="content_txt">Telephone 2</td>
<td><input name="IE_TEL2" id="IE_TEL2" class="input_txt" type="text" readonly value="<?php echo $IE_TEL2;?>" /></td>
</tr>

<tr>
<td class="content_txt">Address3:</td>
<td><input name="IE_ADDRESS3" id="IE_ADDRESS3" class="input_txt" type="text" readonly value="<?php echo $IE_ADDRESS3;?>"/></td>
</tr>
<tr>
<td class="content_txt">Fax:</td>
<td><input name="IE_FAX" id="IE_FAX" class="input_txt" type="text" readonly value="<?php echo $IE_FAX;?>"/></td>
</tr>

<tr>
<td class="content_txt">City:</td>
<td>
	<input name="IE_CITY" class="input_txt" id="IE_CITY" type="text" value="" autocomplete="off" />
</td>
</tr>

<tr>
<td class="content_txt">Pincode:</td>
<td><input name="IE_PIN" id="IE_PIN" class="input_txt" type="text" readonly/></td>
</tr>
...
<td><input name="KP_CERT_ISSUE_DATE" id="popupDatepicker" class="search_app_bg_text" type="text" value="<?php echo $DATE_OF_ISSUE;?>" />
</td>
</tr>

<tr>
<td class="content_txt">Certificate Expiry Date:</td>
<td><input name="KP_CERT_EXPIRY_DATE" id="popupDatepicker1" class="input_txt" type="text" value="<?php echo $DATE_OF_EXPIRY;?>" /></td>
</tr>

<tr>
    <td class="content_txt">Invoice No:</td>
    <td><input name="INVOICE_NO" id="INVOICE_NO" class="input_txt" type="text" value="<?php echo $INVOICE_NO;?>" /></td>
</tr>
    
<tr>
    <td class="content_txt">Invoice Date:</td>
    <td><input name="INVOICE_DATE" id="popupDatepicker2" class="input_txt" type="text" value="<?php echo $INVOICE_DATE;?>" /></td>
</tr>

<?php if(!isset($_REQUEST['action'])){?>

<tr>
<td class="content_txt">H S Code No:</td>
<td>
...
<tr>
    <td class="content_txt">Carat Weight / Mass:</td>
    <td><input name="WEIGHT" id="WEIGHT" class="input_txt" type="text" /></td>
</tr>

<tr>
    <td class="content_txt">Country of Origin</td>
    <td><select  class="input_txt" name="COUNTRY_ID" id="COUNTRY_ID">
<option value="">--Select--</option>
<?php 
	$sql="select * from  kp_country_master order by country_name asc";
	$result=mysql_query($sql);
...
<?php 
$query=mysql_query("select * from kp_expimp_temp_tran_detail where EXPORT_APP_ID='$EXPORT_APP_ID'");
$i=0;	
while($result=mysql_fetch_array($query)){
?>
...
<tr>
<td class="content_txt">Processing Location:</td>
<td>
...
<input name="PAYMENT_MODE" id="PAYMENT_MODE" type="radio" value="Self" <?php if($PICKUP_TYPE=="Self"){?>checked="checked"<?php }?> />
Self
<input name="PAYMENT_MODE" id="PAYMENT_MODE" type="radio" value="Courier" <?php if($PICKUP_TYPE=="Courier"){?>checked="checked"<?php }?> />Courier
<input name="PAYMENT_MODE_CHECK" id="PAYMENT_MODE_CHECK" type="checkbox" value="same" disabled="disabled" />
</td>
</tr>
...
<td>
<input name="C_COMPANY_NAME" id="C_COMPANY_NAME" class="input_txt" type="text" readonly value="<?php echo $C_ADDRESS1;?>" />
</td>
</tr>
...
<tr>
<td class="content_txt">Address1:</td>
<td><input name="C_ADDRESS1" id="C_ADDRESS1" class="input_txt" type="text" readonly value="<?php echo $C_ADDRESS1;?>" /></td>
</tr>


<tr>
<td class="content_txt">Telephone No.:</td>
<td><input name="C_TELEPHONE1" id="C_TELEPHONE1" class="input_txt" type="text" readonlyvalue="<?php echo $C_TELEPHONE1;?>" /></td>
</tr>

<tr>
<td class="content_txt">Address2:</td>
<td><input name="C_ADDRESS2" id="C_ADDRESS2" class="input_txt" type="text" readonly value="<?php echo $C_ADDRESS2;?>" /></td>
</tr>

<tr>
<td class="content_txt">Telephone 2:</td>
<td><input name="C_TELEPHONE2" id="C_TELEPHONE2" class="input_txt" type="text" readonly value="<?php echo $C_TELEPHONE2;?>"/></td>
</tr>

<tr>
<td class="content_txt">Address3:</td>
<td><input name="C_ADDRESS3" id="C_ADDRESS3" class="input_txt" type="text" readonly value="<?php echo $C_ADDRESS3;?>" /></td>
</tr>

<tr>
<td class="content_txt">Fax:</td>
<td><input name="C_FAX" id="C_FAX" class="input_txt" type="text" readonly value="<?php echo $C_FAX;?>" /></td>
</tr>

<tr>
<td class="content_txt">City:</td>
<td><input name="C_CITY" id="C_CITY" class="input_txt" type="text" readonly value="<?php echo $C_CITY;?>" /></td>
</tr>

<tr>
<td class="content_txt">Pincode:</td>
<td><input name="C_PIN" id="C_PIN" class="input_txt" type="text" readonly value="<?php echo $C_PIN;?>"/></td>
</tr>

<tr>
<td class="content_txt">Country:</td>
<td>
<select  class="input_txt" name="C_COUNTRY" id="C_COUNTRY">
<option selected="selected" value="">--Select--</option>
		<?php 
	$sql="select * from  kp_country_master order by country_name asc";
	$result=mysql_query($sql);
...
<tr>
<td class="content_txt">App Fees:</td>
...
<tr>
<td class="content_txt">Courier Charge:</td>
<td><input name="COURIER_AMOUNT" id="COURIER_AMOUNT" class="input_txt" type="text" readonly value="<?php echo $COURIER_AMOUNT;?>" onKeyUp="return calculate()" /></td>
</tr>
...
<td><input class="input_bg" type="submit" value="Submit" /></td>
</tr>
