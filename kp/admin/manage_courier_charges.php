...
if (($_REQUEST['action']=='del') && ($_REQUEST['LOOKUP_VALUE_ID']!=''))
{
	...
	echo"<meta http-equiv=refresh content=\"0;url=manage_courier_charges.php?action=view\">";
}
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> >Manage Courier Charges</div>
</div>

<div id="main">
	<div class="content">
    	<div class="content_head"><a href="manage_courier_charges.php?action=add"><div class="content_head_button">Add Courier Charges</div></a> <a href="manage_courier_charges.php?action=view"><div class="content_head_button">View Courier Charges</div></a> </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
    ...
    ?>  
 	<tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
        ...
        <td ><a href="manage_courier_charges.php?action=edit&LOOKUP_VALUE_ID=<?php echo $row['LOOKUP_VALUE_ID']?>"><img src="images/edit.png" title="Edit" border="0" /></a></td>
        <td ><a href="manage_courier_charges.php?action=del&LOOKUP_VALUE_ID=<?php echo $row['LOOKUP_VALUE_ID']?>" onClick="return(window.confirm('Are you sure you want to delete?'));"><img src="images/delete.png" title="Delete" border="0" /></a></td>
 	</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
  	<tr class="orange1">
    <td colspan="2"> &nbsp;Add New Courier Charges</td>
    </tr>
