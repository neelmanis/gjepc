...
if(isset($_POST['Submit'])){
	...
	if($APPLICATION_STATUS=="N") 
	    ...
	    $APPLICATION_REASON=""; 
	mysqli_query($conn,"update kp_export_application_master set PROCES_CNTR='$PROCES_CNTR',COUNTRY_DEST_ID='$COUNTRY_DEST_ID',IE_PARTY_NAME='$IE_PARTY_NAME',IE_PARTY_ID='$IE_PARTY_ID',IE_ADDRESS1='$IE_ADDRESS1',IE_ADDRESS2='$IE_ADDRESS2',IE_COUNTRY='$IE_COUNTRY',IE_CITY='$IE_CITY',IE_PIN='$IE_PIN',M_ADD_SR_NO='$M_ADD_SR_NO',M_ADDRESS='$M_ADDRESS',M_CITY='$M_CITY',M_STATE='$M_STATE',M_PIN='$M_PIN',M_COUNTRY='$M_COUNTRY',INVOICE_DATE='$INVOICE_DATE',INVOICE_NO='$INVOICE_NO',KP_CERT_ISSUE_DATE='$KP_CERT_ISSUE_DATE',KP_CERT_EXPIRY_DATE='$KP_CERT_EXPIRY_DATE',NUMBER_OF_PARCELS='$NUMBER_OF_PARCELS',APPLICATION_STATUS='$APPLICATION_STATUS',APPLICATION_REASON='$APPLICATION_REASON' where EXPORT_APP_ID='$EXPORT_APP_ID'");
}
?>
...
<td><a class="input_submit" href="../export_attachment/<?php echo $ATTACHMENT_PATH1;?>" target="_blank">VIEW</a></td>
<td bgcolor="#EAEAEA">Carat:</td>
<td><input name="EXP_Attach1_Carat" class="form-control numeric" type="text" value="<?php echo $CARATS1;?>" /></td>
</tr>
<tr>
<td bgcolor="#EAEAEA">2. Copy of Duly Signed Import Invoice with Declaration :</td>
<td><a class="input_submit" href="../export_attachment/<?php echo $ATTACHMENT_PATH2;?>" target="_blank">VIEW</a></td>
<td bgcolor="#EAEAEA">Carat:</td>
<td><input name="EXP_Attach2_Carat" class="form-control numeric" type="text" value="<?php echo $CARATS2;?>" /></td>
</tr>
<tr>
<td bgcolor="#EAEAEA">3. Copy of Local Purchase Invoice :</td>
<td><a class="input_submit" href="../export_attachment/<?php echo $ATTACHMENT_PATH3;?>" target="_blank">VIEW</a></td>
<td bgcolor="#EAEAEA">Carat:</td>
