...
{ 
	...
	//$soapUrl ="https://webdisp.gjepcindia.com:44303/XISOAPAdapter/MessageServlet?channel=:BC_KP_BATCH_CREATION:CC_KP_Batch_Sender"; Test 
...
$xml_post_string .= "			
            <COUNTRY>".$COUNTRY_DEST_ID."</COUNTRY>
