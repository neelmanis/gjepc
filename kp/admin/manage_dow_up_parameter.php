...
if (($_REQUEST['action']=='del') && ($_REQUEST['LOOKUP_VALUE_ID']!=''))
{
	...
	echo"<meta http-equiv=refresh content=\"0;url=manage_dow_up_parameter.php?action=view\">";
}
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> >Manage Download/Upload Parameter</div>
</div>

<div id="main">
	<div class="content">
    	<div class="content_head"><a href="manage_dow_up_parameter.php?action=add"><div class="content_head_button">Add Download/Upload Parameter</div></a> <a href="manage_dow_up_parameter.php?action=view"><div class="content_head_button">View Download/Upload Parameter</div></a> </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
    ...
    ?>  
 	<tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
        ...
        <td ><a href="manage_dow_up_parameter.php?action=edit&LOOKUP_VALUE_ID=<?php echo $row['LOOKUP_VALUE_ID']?>"><img src="images/edit.png" title="Edit" border="0" /></a></td>
        <td ><a href="manage_dow_up_parameter.php?action=del&LOOKUP_VALUE_ID=<?php echo $row['LOOKUP_VALUE_ID']?>" onClick="return(window.confirm('Are you sure you want to delete?'));"><img src="images/delete.png" title="Delete" border="0" /></a></td>
 	</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
  	<tr class="orange1">
    <td colspan="2"> &nbsp;Add New Download/Upload Parameter</td>
    </tr>
