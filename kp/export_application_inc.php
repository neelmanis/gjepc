...
$NUMBER_OF_PARCELS = trim($_POST['NUMBER_OF_PARCELS']); 
...
$fans=mysqli_query($conn,$sql_exp);
		...
		{			
			if(($_FILES["EXP_Attach1"]["type"] == "image/jpeg") || ($_FILES["EXP_Attach1"]["type"] == "image/png") || ($_FILES["EXP_Attach1"]["type"] == "image/jpg") || ($_FILES["EXP_Attach1"]["type"] == "image/JPG") || ($_FILES["EXP_Attach1"]["type"] == "image/JPEG") || ($_FILES["EXP_Attach1"]["type"] == "image/PNG"))
			{
				...
				{
				echo "<script langauge=\"javascript\">alert(\"Sorry you can not upload this  file.\");location.href='export_application.php?EXPORT_APP_ID=$EXPORT_APP_ID&action=update';</script>";
				return;
				}
			} else
			{
			 echo "<script langauge=\"javascript\">alert(\"Sorry you have select Invalid file.\");location.href='export_application.php?EXPORT_APP_ID=$EXPORT_APP_ID&action=update';</script>";
			}		
		}
...
$sql_exp1="INSERT INTO `kp_export_application_master` (`PROCES_CNTR`, `TRAN_NO`, `EXP_APP_DATE`, `COUNTRY_DEST_ID`, `AGENT_ID`, `MEMBER_ID`, `SEZ_MEMBER_ID`, `NON_MEMBER_ID`, `MEMBER_TYPE_ID`, `INVOICE_DATE`, `INVOICE_NO`, `NUMBER_OF_PARCELS`, `TOTAL_WGHT`, `Declaration`, `FEES_AMOUNT`, `KP_OTH_CHG`, `COURIER_AMOUNT`, `TOTAL_AMOUNT`, `PAYMENT_MODE`, `IE_PARTY_NAME`, `IE_PARTY_ID`, `IE_ADDRESS1`, `IE_ADDRESS2`, `IE_COUNTRY`, `IE_CITY`, `IE_PIN`, `IE_TEL1`, `IE_TEL2`, `IE_FAX`, `SPACE_SOFT_EXP_ID`, `M_ADD_SR_NO`, `M_DATE`, `M_COMPANY_NAME`, `M_ADDRESS`, `M_CITY`, `M_STATE`, `M_PIN`, `M_COUNTRY`, `C_COMPANY_NAME`, `C_ADDRESS1`, `C_ADDRESS2`, `C_COUNTRY`, `C_CITY`, `C_PIN`, `C_TELEPHONE1`, `C_TELEPHONE2`, `C_FAX`,`ENTERED_BY`, `ENTERED_ON`, `MODIFIED_ON`, `MODIFIED_BY`, `ORDER_STATUS`, `FORM_TYPE`, `PICKUP_TYPE`, `DELIVERY_STATUS`, `KP_ISSUE_DATE`, `KP_VALID_DAYS`, `KP_EXP_DATE`, `KP_IMP_EXP_CD`, `KP_CANCEL_DATE`, `KP_HS_CODE1`, `KP_HS_CODE2`, `KP_HS_CODE3`, `KP_PAYMENT_ID`, `KP_REMARKS`, `KP_ADV_NOTIFY`, `KP_ADV_NOTIFY_DATE`, `KP_TECH_DATE`, `MEMBER_ADD_ID`, `USD_AMOUNT`, `LOC_PICKUP_ID`, `IE_COUNTRY_ID`, `IE_CITY_ID`, `M_COUNTRY_ID`, `M_STATE_ID`, `M_CITY_ID`, `C_COUNTRY_ID`, `C_CITY_ID`, `IE_ADDRESS3`, `IE_ADDRESS4`, `C_ADDRESS3`, `C_ADDRESS4`, `AGENT_MEM_LINK_ID`, `COUNTRY_PROV_ID`, `DOWNLOAD_MAIN`, `DOWNLOAD_DETAIL`, `DOWNLOAD_RECEIPTS`, `DOWNLOAD_ACOLL`, `DOWNLOAD_ATTACH`)VALUES ('$PROCES_CNTR', NULL, '$EXP_APP_DATE', '$COUNTRY_DEST_ID', '$AGENT_ID', '$MEMBER_ID', NULL, '$NON_MEMBER_ID', '$MEMBER_VAL', '$INVOICE_DATE', '$INVOICE_NO', '$NUMBER_OF_PARCELS', '$TOTAL_WGHT', '$Declaration', '$FEES_AMOUNT', NULL, '$COURIER_AMOUNT', '$TOTAL_AMOUNT', '', '$IE_PARTY_NAME', '$IE_PARTY_ID', '$IE_ADDRESS1', '$IE_ADDRESS2', '$IE_COUNTRY', '$IE_CITY', '$IE_PIN', '$IE_TEL1', '$IE_TEL2', '$IE_FAX', NULL, '$M_ADD_SR_NO', '$M_DATE','$M_COMPANY_NAME', '$M_ADDRESS', '$M_CITY', '$M_STATE', '$M_PIN', '$M_COUNTRY', '$C_COMPANY_NAME', '$C_ADDRESS1', '$C_ADDRESS2', '$C_COUNTRY', '$C_CITY', '$C_PIN', '$C_TELEPHONE1', '$C_TELEPHONE2', '$C_FAX','$ENTERED_BY', '$ENTERED_ON', '$ENTERED_ON', '$ENTERED_BY', NULL, 'E', '$PICKUP_TYPE', NULL,NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '$USD_AMOUNT', '$LOC_PICKUP_ID', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', '$IE_ADDRESS3', NULL, NULL, NULL, '$AGENT_MEM_LINK_ID', '$COUNTRY_PROV_ID', NULL, NULL, NULL, NULL, NULL)";

$sql_exp1_query = mysqli_query($conn,$sql_exp1);
	...
	//---------------------------------------- uplaod  newsletter pdf  -----------------------------------------------
		...
		{				
			if(($_FILES["EXP_Attach1"]["type"] == "image/jpeg") || ($_FILES["EXP_Attach1"]["type"] == "image/png") || ($_FILES["EXP_Attach1"]["type"] == "image/jpg") || ($_FILES["EXP_Attach1"]["type"] == "image/JPG") || ($_FILES["EXP_Attach1"]["type"] == "image/JPEG") || ($_FILES["EXP_Attach1"]["type"] == "image/PNG"))
			{
				...
				{
				echo "<script langauge=\"javascript\">alert(\"Sorry you can not upload this  file.\");location.href='export_application.php';</script>";
				return;
				}
			} else
			{
			echo "<script langauge=\"javascript\">alert(\"Sorry you have select Invalid file.\");location.href='export_application.php';</script>";
			}		
		}
