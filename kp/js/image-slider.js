            ...
            return this.each(function() {
                ...
                function initialize() {
                    ...
                    $('.outer', slidercontents).each(function(index) {
                        $(this).prepend($('</>').attr('src', '').addClass('zoom')
                                                   .css({ cursor: 'pointer', 'position': 'relative', 'float': 'right', marginRight: -10, top: -14, }));
...
$('.outer a').click(function(e){
                    ...
                    $('.outer').hover(function() { $(this).addClass('active'); }, function() { $(this).removeClass('active'); }).click(
                                                     function(e) {
                                                         ...
                                                         var text = p.find('').html();
                                                         preview.find('').attr('src', img).addClass(cls);
                                                         preview.find('.').html(text);
                                                         preview.fadeIn("");
