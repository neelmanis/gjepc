			...
			<?php } ?>
			   ...
			   <div class="col-sm-6 col-md-4">
				...
				<?php } ?>
					...
					<a href="payment_cart_i.php"><b>Click Here</b></a>					
					</div>
					<?php } ?>
					<?php 
					if(isset($_SESSION['AGENT_ID'])){
					...
					<a href="payment_cart_e.php" ><b>Click Here</b></a>					
					</div>
					<?php }?>
				</div>
...
<table class="tableinfo table table-bordered mt-5">
	...
	if(isset($_SESSION['MEMBERTYPE']) && $_SESSION['MEMBERTYPE']=="Agent")
		...
		$sql="SELECT a.*,c.Response_Code,c.STATUS FROM `kp_export_application_master` a , kp_payment_details b, kp_payment_master c  WHERE 1 and  a.`MEMBER_ID`='".$_SESSION['MEMBER_ID']."' and c.advol_exchange_rate!=''";
