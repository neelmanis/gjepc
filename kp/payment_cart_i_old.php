...
$FORM_TYPE="I";
	...
	foreach($export_app_id1 as $val)
    {
		 ...
		 mysql_query("insert into kp_payment_details set EXPORT_APP_ID='$val',PAYMENT_MST_ID='$PAYMENT_MST_ID',RECIEPT_NO='$RECIEPT_NO',APPLICANT_ID 	='$APPLICANT_ID',MEMBER_TYPE_ID='$MEMBER_TYPE_ID',MEMBER_ID='$MEMBER_ID',FORM_TYPE='I',TRAN_ID='$TRAN_ID'");
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-color:#ccc; " >
  ...
  <tr align="center">
    ...
    <td><a href="import_application.php?EXPORT_APP_ID=<?php echo $result_import_pending['EXPORT_APP_ID'];?>&action=update">Edit</a></td>
  </tr>
...
<div style="float:left;  margin-bottom:4px;"><input class="input_bg" type="button" value="Cancel" name="cancel" id="cancel" /></div>
