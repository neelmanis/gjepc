...
include 'functions.php';
		...
		if($_REQUEST['Reset']=="Reset")
		{
		  ...
		  header("Location: region-wise-all-countries.php");
		} else {
            ...
            <div class="col-12">
                        <div class="row py-3"  style="border-top: 1px solid #ccc">
                            ...
                            <div class="col-12">
                                ...
                                <button onclick="exportToExcel('tblexportData', 'region-wise-all-countries')" class="btn btn-success">Export</button>
                                </div> 
                            </div>
                                ...
                                <table class="table table-bordered tableInfo">
									...
									while($row = $resultx->fetch_assoc())
									{
										...
										if($currency!="")
										{
											...
											$getPreviousFinancialYearData = getPreviousFinancialYearCRegionINR($last_finyr,$row['country_id'],$conn);
										...
										//	$newTotal_Paisa  = $row['total_usd'];
											...
											$currencySign = "";
											$getPreviousFinancialYearData = round(getPreviousFinancialYearCRegionUSD($last_finyr,$row['country_id'],$conn)/1000000);
											$lastYearTotal_Paisa   = str_replace(',','',$getPreviousFinancialYearData);
											$sub_lastYear_Paisa = round($sub_lastYear_Paisa + $lastYearTotal_Paisa);
						...
						<td style="padding:10px; background-color:#EAEAEA; text-align:right;"><?php echo moneyFormatIndia($sub_lastYear_Paisa); ?></td>
						<td style="padding:10px; background-color:#EAEAEA; text-align:right;"><?php echo moneyFormatIndia($sub_total_Paisa); ?></td>
						<td></td>
						<td></td>
