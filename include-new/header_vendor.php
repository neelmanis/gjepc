...
<meta property="og:image" content="https://gjepc.org/assets/images/sharelogo.png" />
...
<div id="preloader">
    ...
    <div id="status" class="align-self-center"> <img src="assets/images/logo.png"></div>
    </div>
</div> <!-- preloader wrp -->
                    ...
                    <div class="head_right ">     
                    	...
                    	<div class="d-flex h-100"> 
                    	    ...
                    	    <div class="my-auto">  
        						...
        						<div class="d-flex justify-content-end position-relative log_reg_btn mb-3">
                                    <div><a href="/hindi">हिन्दी</a></div>
                              		<div><a href="vendor_login.php">Log in </a></div>
                                    <div><a href="vendor_registration.php" class="reg_btn"> Registration </a></div>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="igja-gallery.php"> India Gem & Jewellery Awards</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>                  
