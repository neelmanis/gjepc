<footer class="black_bg py-5">
    ...
    <div class="container">  
        ...
        <ul class="row justify-content-center mb-2 foot_list">
            ...
            <li class="col-auto"><a href="pdf/Membership-Payment-Terms-condition.pdf">Terms & Condition</a></li>
            <li class="col-auto"><a href="privacy-policy.php">Privacy Policy</a></li>
		</ul>         
        <p class="text-center" style="font-size:12px;">Copyright © 2021 GJEPC</p>  
        
        <p class="text-center" style="font-size:12px;"> <a href="http://kwebmaker.com/" target="_blank" style="color:#666;"> Kwebmaker™ </a> </p>            
    </div>    
...
<script src="assets-new/js/slick.min.js" defer></script>
...
<script src="assets-new/js/general.js?v=1.5" defer></script> 
