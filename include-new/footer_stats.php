<footer class="black_bg py-5">
    ...
    <div class="container">  
        ...
        <p class="text-center" style="font-size:12px;">Copyright &copy; 2020 GJEPC</p>  
        
        <p class="text-center" style="font-size:12px;"> <a href="http://kwebmaker.com/" target="_blank" style="color:#666;"> kwebmaker&trade; </a> </p>            
...
<script src="assets-new/js/aos.js"></script><!-- Neel un-comment -->
