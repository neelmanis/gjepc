...
<!-- Event snippet for GJEPC_Google_PageView conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-679056788/N1zUCJPKxLsBEJSr5sMC'});
</script>

<!-- Global site tag (gtag.js) - Google Ads: 679056788 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-679056788"></script>
<script>
			...
			<div class="container-fluid p-0">
                ...
                <div class="container collapse navbar-collapse" id="navbar-menu">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="dropdown">
                                             ...
                                             <li class="dropdown">
												...
												<ul class="dropdown-menu ">
													  <li><a href="#" target="_blank">Membership/Micro-membership</a></li>
                                             		  <li><a href="parichay.php">Parichay Card</a></li>
                                                      <li><a href="swasthya-kosh.php" target="_blank">Swasthya Kosh/Swasthya Ratna</a></li>
                                                      <li><a href="pdf/MSME/Jewellery-Park.pdf" target="_blank">Jewellery park</a></li>
                                                      <li><a href="pdf/MSME/Common-Facility-Center.pdf" target="_blank">Common Facility Center</a></li>
                                                      ...
                                                      <li><a href="#" target="_blank">Helpdesk/Call center</a></li>
                                                      <li><a href="#" target="_blank">Skill development & training for Artisans</a></li>
                                                </ul>
											</li>
                                            
                                             <li><a href="pdf/MSME/Udhyog-Aadhar-Registration.php" target="_blank">Udhyog Aadhar Registration</a></li>
                   ...
                   <div class="social_contact_wrp">
                    ...
                    <a href="http://survey.jamoutsourcing.com/gjepc_new/index.php/complaint/complaint" target="_blank" class="helpdesk"> <span><img src="assets/images/24.png"></span> Helpdesk </a>                
                   </div>                
                </div><!-- /.navbar-collapse -->
                ...
                <div class="container sina-nav-header social-on">
                    ...
                    <div class="head_right">                    
                    	<div class="d-flex mb-4 justify-content-end wl_wrp">                        	
                            <div class="mr-3">
                            	<a href="pdf/GJEPC-Communication-during-Lockdown.pdf" target="_blank" class="whats_new" data-toggle="tooltip" data-placement="left" title="GJEPC Communication During Lockdown"><i class="mr-2 fa fa-bolt" aria-hidden="true"></i> Whats New</a>
                            </div>                            
                            <div>
