...
?>
	...
	<div>
		<ul class="manageBox">
			<li class="has-submenu">MANAGE VENDOR <button class="hidden-lg hidden-md hidden-sm btn regMenuBtn closebtn text-right"><i class="text-right fa fa-times-circle-o" aria-hidden="true"></i></button>
				<ul class="sub-menu">
				
				
					<li> <a href="pdf/Minimum Pre qualification  2019-2021.pdf"  target="_blank" > Minimum Pre qualification  2019-2021 </a> </li>
