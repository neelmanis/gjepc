...
$parichay_status = getParichay_status($registration_id,$conn);
...
{ 
	...
	{
		$upload_image = '';
	//	$target_folder = 'images/parichay_card/person/'.$_SESSION['USERID'].'/'.$attach.'/'; 
		$target_folder = 'images/parichay_card/person/'.$attach.'/'; 
		$registration_id = $_SESSION['USERID'];
		$target_path = "";
		$file_name = str_replace(" ","_",$file_name);
...
if(!empty($email_id)){
$sqlx1="SELECT email FROM parichay_person_details WHERE email='$email_id'";
$resultsqlx1 = $conn->query($sqlx1);
$mysqlrow = $resultsqlx1->fetch_array();
if($mysqlrow[0] == $email_id)
{ 
	echo '<script language="javascript">';	echo 'alert("Email Id Already Exist")';	echo '</script>'; 
	echo"<meta http-equiv=refresh content=\"0;url=add-person-details.php\">";
	exit;
} 
}
...
$mysqlrow = $resultsqlx1->fetch_array();
if($mysqlrow[0] == $email_id)
{ $signup_error = "Email Id Already Exist";  } else { echo 'ok';}
} */
                        ...
                        <div class="row"> 
                         <div class="col-12 mb-3">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label for="gender" generated="true" class="error d-none">This is required.</label>
							</div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label for="education" generated="true" class="error d-none">This is required.</label>
							</div>
                            ...
                            <div class="form-group col-12">
                                	...
                                	<div class="d-block"><label for="address">Current Address<span>*</span></label></div>
                                	<div class="row">
                                	<div class="col-6">
                                    <label for="Yes" style="font-size:13px; font-style:italic;">
                                     <input type="radio" name="address" value="YES" <?php if($billing_address_same=="YES"){ echo "checked=checked";}?> onclick="data_copy()";> Please tick if current and permanent address is same</label>		
									</div>
									<div class="col-6">
                                    <label for="Yes" style="font-size:13px; font-style:italic;">
                                 <input type="hidden" name="address" value="NO" <?php if($billing_address_same=="NO"){ echo "checked=checked";}?> onclick="data_copy()";></label>		
									</div>
									<div class="col-12">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control numeric" id="account_no" name="account_no" minlength="10" maxlength="20" autocomplete="off">		
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                            	...
                            	<input type="file" id="upload_bank_documents" name="upload_bank_documents" class="form-control" autocomplete="off"><i>Upload bank details (Front page of passbook / ATM slip / Screenshot of net banking)</i>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label for="employment_status" generated="true" class="error d-none">This is required</label>
							</div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label for="applicable_industry" generated="true" class="error d-none">This is required</label>
							</div>
