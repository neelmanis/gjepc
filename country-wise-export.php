<?php 
$pageTitle = "Gems And Jewellery Industry In India | Country Wise Export - GJEPC India";
...
include 'functions.php';
		...
		if($_REQUEST['Reset']=="Reset")
		{
		  ...
		  header("Location: country-wise-export.php");
		} else {
    ...
    <div class="row justify-content-center">
			...
			<input type="hidden" name="search_type" id="search_type" value="SEARCH"/>
                ...
                <div class="form-group col-12 mb-4">
                    <p class="blue text-center">EXPORTS - COUNTRY-WISE</p>
                </div>   
                ...
                <div class="col-md-11">
                    <div class="row">
						...
						<div class="row">
                        <div class="col-3 d-flex align-items-center"><label> Select Country</label></div>
                        <div class="col-1 d-flex align-items-center"><span>:</span></div>
                        <div class="col-8">
		...
		?>
            ...
            <div class="col-12">
                        <div class="row py-3" style="border-top: 1px solid #ccc">
                            <div class="col-12"><h2 class="title text-center mb-1"><span class="d-table mx-auto mb-3" style="width:35px;"><img src="assets/images/black_star.png" class="img-fluid d-block"></span>Exports - Country-wise</h2></div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-start"> 
								   <button onclick="exportToExcel('tblexportData', 'country-wise-export')" class="cta gold_btn" title="Export To Excel"><i class="fa fa-file-excel-o" style="font-size: 40px;"></i></button>
                                </div>
                            </div>
					...
					/* Same */		if(getFinancialYear($conn)==$financial_year){ $sameYear = "YES"; } else { $sameYear = "NO"; }
									...
									{					
										...
										if($currency!="")
										{
											...
											$getPreviousYearData = getcountrywiseINR($last_finyr,$row['country_id'],$sameYear,$currentMonth,$conn);
										...
										//	$newTotal_Paisa  = round($row['total_usd']/$_POST['currency_usd'],2);
											...
											$getPreviousYearData = getcountrywiseUSD($last_finyr,$row['country_id'],$sameYear,$currentMonth,$conn);
