                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="performance_award_category[]" id="performance_award_category" value="Cut & Polished Diamonds (Large)" <?php if( in_array("Cut & Polished Diamonds (Large)", $_POST['performance_award_category']) ){ echo "checked";}?>>01 Awards <br /> Cut & Polished Diamonds (Large)
                                    </label>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Corporate Social Responsibility (CSR) Award" <?php if( in_array("Woman Entrepreneur of the Year", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Most Socially Responsible Company (CSR)
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" class="innovation_in_marketing_award" value="Innovation in Manufacturing Award" <?php if( in_array("Innovation in Manufacturing Award", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Award for Innovation in Manufacturing
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Highest Gems and Jewellery Sales (Importer)" <?php if( in_array("Most Socially Responsible Company (Part C)", $_POST['theme_based_award_category']) ){ echo "checked";}?>>03 Awards <br> Highest Gems & Jewellery Sales (Importer)
                                    </label>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="new_business_award" value="New Business Award" <?php if( in_array("New Business Award /  Upcoming exporter of the year", $_POST['other_award_category']) ){ echo "checked";}?> >01 Awards <br /> Upcoming Exporter of the year
                                    </label>
                                </div>
                            
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="global_retailer_year" value="Global Retailer of the year"  <?php if( in_array("Global Retailer of the year", $_POST['other_award_category']) ){ echo "checked";}?>>01 Awards  <br />Global Retailer of the year 
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="best_in_gems_jewellery" value="Best in Gems and Jewellery E- Commerce Platform"  <?php if( in_array("Best in Gems and Jewellery E- Commerce Platform", $_POST['other_award_category']) ){ echo "checked";}?>>01 Awards  <br />Best in Gems and Jewellery E- Commerce Platform
                                    </label>
                                </div>
...
<button type="button" class="addBtn">Add+</button>
                    ...
                    <div class="row business_details_and_explanat" style="display:none;">
        ...
        <div id="collapse-D" class="collapse" data-parent="#content" role="tabpanel" aria-labelledby="heading-D">
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" name="qualitative_information" id="qualitative_information"  method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row strategic_export_initiative" style="display:none;">
        ...
        <div id="collapse-F" class="collapse" data-parent="#content" role="tabpanel" aria-labelledby="heading-F">
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" method="POST" name="innovative_company" id="innovative_company" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row details_r_n_d_activities" display="style:none">
...
var innovation_in_marketing_award =false;best_innovation_digital_marketing_award=false;
...
$.each(theme_based_award_category, function(key,val) { 
    if(val == "Best Innovation in Digital & Marketing Award"){
...
if (global_Retailer_of == true || woman_entrepreneur == true || best_in_gems_jewellery == true ) 
{
    ...
    || cut_polished_coloured_gemstones == true || costume_fashion_jewellery == true || cut_polished_synthetic_stones == true){
