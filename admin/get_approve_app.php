...
$report_name = 'DOWNLOAD APPROVE APPLICATION';
...
<?php
 function cleanData(&$str)
  ...
  $filename = "TradeApproved_" . date('Ymd') . ".csv";
  ...
  $flag = false;
  $result = $conn ->query("SELECT * FROM `trade_general_info` WHERE `application_status`='Y'");
