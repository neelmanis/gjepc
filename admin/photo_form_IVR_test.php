...
{	
	...
	$old_photo=$rows1['old_photo'];
	$face_photo=$rows1['face_photo'];
	$name = $rows1['first_name'];
...
$old_photo=$rows['old_photo'];
$face_isApplied = $rows['face_isApplied'];
$face_photo=$rows['face_photo'];
...
<tr>
    ...
    <div class="field bottomSpace">
        ...
        <div class="clear"></div>
        <?php $photo = intlVisitorPhoto($id,$conn);?>
        <?php $photo_ext =  pathinfo($photo, PATHINFO_EXTENSION); ?>
        <?php if($photo_ext == "pdf" ||  $photo_ext == "PDF"){ ?>
		    <a href="https://registration.gjepc.org/images/ivr_image/photograph/<?php echo $photo; ?>" target="_blank">
		    ...
		    <div class="row">
  			...
  			<div class="row">
		    	<div class="col-6">
		    		...
		    		<div class="blah">
		    			<a data-fancybox="gallery" href="https://registration.gjepc.org/images/ivr_image/photograph/<?php echo $photo; ?>"> 
		    			<img class="img_e" id="blah_photo" src="https://registration.gjepc.org/images/ivr_image/photograph/<?php echo $photo; ?>" title="<?php echo $name;?>" style="max-width: 150px;"/></a> 
		    		</div>	
		    	</div>
		    </div>
    	<?php } ?>
        <table style="width: 100%; " border="0" cellspacing="2" cellpadding="2">
	      	...
	      	<tbody>
	      		<tr>
		      		<?php if(isset($old_photo) ){?> 
			      	<td>
				      <div class="blah">
			      	    	<img class="img-fluid blah_photo " src="https://registration.gjepc.org/images/ivr_image/photograph/<?php echo $old_photo; ?>" alt="your image" style="display: block;max-width: 150px"/>
					  </div>
			      	</td>
			      	<?php }else{ ?> 
					<td>
				      	<div class="blah">
					    	<img class="img-fluid blah_photo " src="https://registration.gjepc.org/images/ivr_image/photograph/<?php echo $photo; ?>" alt="your image" style="display: block;max-width: 150px"/>
			      	...
			      	<td>  
			      	<div class="blah">
				    	<img class="img-fluid blah_photo " src="https://registration.gjepc.org/images/ivr_image/photograph/<?php echo $face_photo; ?>" alt="your image" style="display: block;max-width: 150px"/>
					  </div>
					</td>
			      	<?php } ?>
	      		</tr>
