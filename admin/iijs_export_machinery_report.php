...
where oh.payment_status='Y' and oh.status = '1' AND oh.show = gb.event and gb.participant_Type='IGJME' ";
$result = $conn ->query($sql);
...
if($row['payment_made_for']=="igjme22"){ $payment_made_for = 'MACHINERY'; }
$amount = $row['Amount'];
/*
