...
{ //echo "><pre>"; print_r($_POST);exit;
	...
	*/
	...
	$passUrl = "http://gjepcsoad.com";
	} else { 
	$admission_fees = '';
	$passUrl = "https://gjepcinterfaces.com";
	}
	...
	<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:gjep="'.$passUrl.'">
	<soapenv:Header/>
	<soapenv:Body>
	<gjep:MT_SOAD_IN>
	<SOAD_Header>
