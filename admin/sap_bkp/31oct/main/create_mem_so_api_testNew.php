...
{ 	//echo "><pre>"; print_r($_POST);exit;
	...
	$p_bp_number = "6000000";
	$registration_id = "600721223";
	$renew_check ="R"; //pass R or N
	
	if($renew_check=='N') // New Member 
	{
		$soapSalesUrl = "https://webdisp.gjepcindia.com:44303/XISOAPAdapter/MessageServlet?channel=:BC_SOAD_PRD:CC_SOAD_Sender"; // Live
	...
	$Date = date('Ymd');
	/*	Developmennt <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:gjep="https://gjepcinterfaces.com"> */
...
while ($i < mysql_num_fields($result)) {
	...
	$xml_sales_order_string .= "
		<renew_header>
            ...
            <Avg_export>0</Avg_export>
            <Avg_import>0</Avg_import>
            <Renew_date>$Date</Renew_date>
        </renew_header>";	
		}
		...
		<SOAD_Header>
         ...
         <SOAD_Advance>
			...
			<Sp_gl_indicator>A</Sp_gl_indicator>
			<Doc_text>SK</Doc_text>
			<Bank_Acc_No>'.$gjepc_gl_account_no.'</Bank_Acc_No>
			<Bus_area>1000</Bus_area>
			<Amount>'.$total_payable.'</Amount>
			<Profit_centre>'.$region.'</Profit_centre>
			<Assignment></Assignment>
