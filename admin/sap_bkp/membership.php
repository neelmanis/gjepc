...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  $sql="select a.id,b.company_name,b.iec_no,b.region_id,b.member_type_id,c.challan_scanned_copy,c.signature_slip_copy,d.gcode,d.merchant_certificate_no,d.manufacturer_certificate_no,d.membership_id,d.information_approve,d.document_approve,d.payment_approve,d.sap_sale_order_create_status,d.sap_bp_create_status from registration_master a,information_master b,challan_master c,approval_master d where a.id=b.registration_id and a.id=c.registration_id and a.id=d.registration_id and c.challan_financial_year='2018' ";
  ...
  <tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
	...
	if(getBPNO($rows['id'])=="") { ?>
	<td class="sap" data-url="<?php echo $rows['id'];?>"><img src="images/reply.png" title="PUSH" border="0" style=""/></td>
	<?php } else { ?>
