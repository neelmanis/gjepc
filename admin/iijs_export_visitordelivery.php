...
$category = 'VISITOR';
$report_name = 'VISITOR COMBO+SIGNATURE 23+TRITIYA 23';
...
inner join globalExhibition gb on gb.visitor_id=vd.visitor_id 
where oh.payment_status='Y' and oh.status = '1' AND oh.show = gb.event and (oh.show='signature23' || oh.show='iijstritiya23' || oh.show='combo23') and gb.participant_Type='VIS' ";
$result = $conn ->query($sql);
...
$amount = $row['Amount'];
/*
if($amount=="4000" || $amount=="5200" || $amount=="2000" || $amount=="2500" || $amount=="0"){ $phase = 'PHASE 1'; } 
