...
$querys =  $conn ->query("select * from challan_master where challan_financial_year='2022' and registration_id='$registration_id' and (Response_Code is null || Response_Code!='E000')");
