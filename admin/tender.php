...
if(($_REQUEST['action']=='del') && ($_REQUEST['id']!=''))
{
	...
	if($stmt->execute()){
	echo"<meta http-equiv=refresh content=\"0;url=tender.php?action=view\">";
	}
}
...
if($_REQUEST['action']=='save')
{
	...
	//---------------------------------------- upload Tender pdf  -----------------------------------------------
		...
		if(preg_match("/.php/i", $file_name)) {
    		 echo "<script langauge=\"javascript\">alert(\"Sorry you have select Invalid file.\");location.href='tender.php?action=add';</script>";
			exit;
		}
		else if($file_name != '')
		{
			if(($_FILES["upload_tender"]["type"] == "application/PDF") || ($_FILES["upload_tender"]["type"] == "application/pdf"))
			{
				...
				{
				echo "<script langauge=\"javascript\">alert(\"Sorry you can not upload this  file.\");location.href='tender.php?action=add';</script>";
				return;
				}
			 } else
			 {
		  ...
		  //Unlink the previuos image		  
		   ...
		   unlink($filename);
			...
			if (($_FILES["upload_tender"]["type"] == "application/PDF") || ($_FILES["upload_tender"]["type"] == "application/pdf"))
			{
				...
				{
					echo "<script langauge=\"javascript\">alert(\"Sorry you can not upload this file.\");location.href='tender.php?action=edit&id=$id';</script>";
					return;
				}
			} else
			 {
			 echo "<script langauge=\"javascript\">alert(\"Sorry you have select Invalid file.\");location.href='tender.php?action=edit&id=$id';</script>";
			 }	
		}	
...
<div class="breadcome"><a href="admin.php">Home</a> > Manage Tender</div>
</div>

<div id="main">
<div class="content">
<div class="content_head"><a href="tender.php?action=add"><div class="content_head_button">Add Tender</div></a> <a href="tender.php?action=view">
<div class="content_head_button">View Tender</div></a> </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt">
    ...
    ?>  
 	<tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
        ...
        <td><?php if($row['status'] == 1) { ?> <a style="text-decoration:none;" href="tender.php?id=<?php echo $row['id']; ?>&status=0&action=active" onClick="return(window.confirm('Are you sure you want to Deactivate.'));"><img src="images/active.png" border="0" title="Inactive"/></a><?php } else { ?><a style="text-decoration:none;" href="tender.php?id=<?php echo $row['id']; ?>&status=1&action=active" onClick="return(window.confirm('Are you sure you want to Activate.'));"><img src="images/inactive.png" border="0" title="Active"/></a><?php } ?></td>
        
        <td><a href="tender.php?action=edit&id=<?php echo $row['id']?>"><img src="images/edit.png" title="Edit" border="0" /></a></td>
        <td><a href="tender.php?action=del&id=<?php echo $row['id']?>" onClick="return(window.confirm('Are you sure you want to delete?'));"><img src="images/delete.png" title="Delete" border="0" /></td>
 	</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
  	<tr class="orange1">
    <td colspan="2"> &nbsp;Add New Tender</td>
    </tr>  	
    <tr>
    <td class="content_txt">Tender Name <span class="star">*</span></td>
    <td><input type="text" name="name" id="name" class="input_txt" value="<?php echo $name;?>" autocomplete="off"/></td>
    </tr>    
    <tr>
    <td class="content_txt">Upload Tender <span class="star">*</span></td>
