...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: iijs_ivr_test.php?action=view");
...
<div id="main">
	<div class="content">    
		...
		<a href="iijs_ivr_test.php?action=view"><div class="content_head_button">Manage IIJS IVR</div></a> 
 ...
 /* $sql="SELECT count(vd.uid) as total_persons,rm.id,vh.payment_made_for,vh.create_date, rm.company_name, rm.email_id, rm.mobile_no,rm.approval_status,vd.uid,rm.country,vd.eid,vd.application_approved,vh.show FROM registration_master rm inner join ivr_registration_details vd on rm.id=vd.uid inner join ivr_registration_history vh on rm.id=vh.registration_id where rm.country!='IN'  "; Join table for show details*/
  ...
  { 
    if($_SESSION['visitor_approval']=="P"){
        $sql.=" and vd.application_approved='".$_SESSION['visitor_approval']."' or vd.personal_info_approval = '".$_SESSION['visitor_approval']."' or vd.photo_approval = '".$_SESSION['visitor_approval']."'
      or vd.valid_passport_copy_approval = '".$_SESSION['visitor_approval']."' or vd.visiting_card_approval = '".$_SESSION['visitor_approval']."' or vd.nri_photo_approval = '".$_SESSION['visitor_approval']."' ";
        ...
        $sql.=" and vd.application_approved='".$_SESSION['visitor_approval']."' and vd.personal_info_approval = '".$_SESSION['visitor_approval']."' and vd.photo_approval = '".$_SESSION['visitor_approval']."'
...
if($rCount>0)
  ...
  <tr>
    ...
    <td> <a href="iijs_ivr_test.php?action=employeesList&registration_id=<?php echo $rows['uid'];?>">View directory  </a> / <a href="iijs_ivr_test.php?action=ordersList&registration_id=<?php echo $rows['uid'];?>"> order history  </a></td>
...
<?php echo pagination(20,$page,'iijs_ivr_test.php?action=view&page=',$rCount); //call function to show pagination?>
</div> 
</form>
...
<div class="content_details1">
	...
	?>
	Company Name: <?php echo $company_name; ?><div class="content_head_button" style="float:right; padding-right:10px; font-size:12px;"><a href="iijs_ivr_test.php?action=view">Back</a></div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  <tr class="orange1">
    <td width="7%" height="10">#</td>
