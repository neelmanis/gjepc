...
{		
	...
	$photo_approval=filter($_REQUEST['photo_approval']);
		if($photo_approval=='Y')
		{
		$photo_reason="";	
		}else
		{
		$photo_reason=filter($_REQUEST['photo_reason']);
		}
	
	$valid_passport_copy_approval=filter($_REQUEST['valid_passport_copy_approval']);
		if($valid_passport_copy_approval=='Y')
		{
		$valid_passport_copy_reason="";	
		}else
		{
		$valid_passport_copy_reason=filter($_REQUEST['valid_passport_copy_reason']);
		}
	
	$visiting_card_approval=filter($_REQUEST['visiting_card_approval']);
		if($visiting_card_approval=='Y')
		{
		$visiting_card_reason="";	
		}else
		{
		$visiting_card_reason=filter($_REQUEST['visiting_card_reason']);
		}
	$nri_photo_approval=filter($_REQUEST['nri_photo_approval']);
		if($nri_photo_approval=='Y')
		{
		$nri_photo_reason="";	
		}else
		{
		$nri_photo_reason=filter($_REQUEST['nri_photo_reason']);
		}
...
//		$target_folder = 'C:/xampp/htdocs_vhosts/iijs/images/ivr_image/photograph/';
                $target_folder = '/var/www/html/iijs.org/images/ivr_image/photograph/'; 
		$path_parts = "";
		$ext="";
		$target_path = "";
		$filetoupload="";
		...
		if($_FILES['photograph_fid']['name'] != '')
		{
		  //Unlink the previuos image
		   ...
		   $filename="https://iijs.org/images/ivr_image/photograph/".$rpreviousimg['photograph_fid'];
		   unlink($filename);
		...
		//------------------------------------  Update passport ----------------------------------------------------
		$passport_fid = '';
		$target_folder = '/var/www/html/iijs.org/images/ivr_image/passport/';
		$path_parts = "";
		$ext="";
		$target_path = "";
		$filetoupload="";
		...
		if($_FILES['passport_fid']['name'] != '')
		{
		  //Unlink the previuos image
		   ...
		   $rpreviousimg=mysql_fetch_array($qpreviousimg);
		   $filename="https://iijs.org/images/ivr_image/passport/".$rpreviousimg['passport_fid'];
		   unlink($filename);
		...
		$visit_card_fid = '';
		$target_folder = '/var/www/html/iijs.org/images/ivr_image/visiting_card/';
		$path_parts = "";
		$ext="";
		$target_path = "";
		$filetoupload="";
		...
		if($_FILES['visit_card_fid']['name'] != '')
		{
		  //Unlink the previuos image
		   ...
		   $rpreviousimg=mysql_fetch_array($qpreviousimg);
		   $filename="https://iijs.org/images/ivr_image/visiting_card/".$rpreviousimg['visit_card_fid'];
		   unlink($filename);
		...
		//------------------------------------  Update nri ----------------------------------------------------
		$nri_fid = '';
		$target_folder = '/var/www/html/iijs.org/images/ivr_image/nri/';
		$path_parts = "";
		$ext="";
		$target_path = "";
		$filetoupload="";
		...
		if($_FILES['nri_fid']['name'] != '')
		{
		  //Unlink the previuos image
		   ...
		   $rpreviousimg=mysql_fetch_array($qpreviousimg);
		   $filename="https://iijs.org/images/ivr_image/nri/".$rpreviousimg['nri_fid'];
		   unlink($filename);
	...
	<tr>
		<td align="left"><img id="li" src="https://gjepc.org/images/gjepc_logon.png"></td>
        <td align="left"><img src="http://registration.gjepc.org/images/mailer/logo.png" /></td>
	...
	<p>Your Application for the International Visitor Registration for IIJS PREMIERE 2019 has been approved by IIJS Team.<p>
	...
	<p>You can also check the status of your application at <a href= "https://iijs.org/ivr.php">https://iijs.org/ivr.php</a>. </p>
...
//	$to =$rows1['email'].',overseas@gjepcindia.com';
    $to=$rows1['email'];	
	$subject = "IIJS PREMIERE 2019 : Your Information for International Visitor Registration has been approved by the Administrator"; 
	$headers  = 'MIME-Version: 1.0' . "\n"; 
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\n"; 
	$headers .= 'From: IIJS PREMIERE 2019 <admin@gjepc.org>';			
...
<td style="padding:30px;">
	...
	<tr>
		<td align="left"><img id="li" src="https://gjepc.org/images/gjepc_logon.png"></td>
        <td align="center"> <img id="mi" src="https://iijs.org/images/IIJS2018Logo.png"> </td>
<!--		<td align="right"> <img src="https://gjepc.org/igjme/images/iigme_logo.png" width="190px"> </td>-->
		</tr>
...
<p>The below details of your International Visitor Registration form have been disapproved for IIJS PREMIERE 2019 by the IIJS admin team.</p>
...
<p>In case, If  you have forgotten your password, <a href="https://iijs.org/forgot_password.php" style="color:#751b53; text-decoration:none; font-weight:bold;">click here</a>.</p>
...
<tr>
    ...
    <div class="field bottomSpace">
         ...
         <div class="leftFile">
             ...
             <input name="photograph_fid" id="photograph_fid" type="file" class="input_txt" readonly style="margin-bottom:10px; background:#fff;" />
         </div>
...
<tr>
    ...
    <div class="leftFile">
		<div class="midTitle">Please browse to attach your passport copy: <sup>*</sup> </div>
   		<p><strong>Filename</strong></p>
        <input name="passport_fid" type="file" class="input_txt" readonly style="margin-bottom:10px; background:#fff;" id="passport_fid" />
        </div>
...
<tr>
    ...
    <?php 
		 ...
		 {
		 ?>
		 <div class="fancyDemo"><a rel="group" href="<?php echo $purl; ?>images/ivr_image/visiting_card/<?php echo $visit_card_fid;?>"><a rel="group" href="https://iijs.org/images/ivr_image/visiting_card/<?php echo $visit_card_fid;?>"><img src='<?php echo $purl; ?>images/ivr_image/visiting_card/<?php echo $visit_card_fid;?>' width='100' height='100' /></a></div>
		 <?php
		 }
	?>
    </div>
    <div class="leftFile">
        ...
        <p><strong>Filename</strong></p>
         <input name="visit_card_fid" id="visit_card_fid" type="file" readonly class="input_txt" style="margin-bottom:10px; background:#fff;" />
	</div>
...
<tr>
    ...
    <div class="field bottomSpace">
        ...
        <div class="leftFile">
             ...
             <p><strong>Filename</strong></p>
             <input name="nri_fid" id="nri_fid" type="file" class="input_txt" readonly style="margin-bottom:10px; background:#fff;" />
        </div>
