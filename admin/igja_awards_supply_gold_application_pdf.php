...
if(isset($_REQUEST['registration_id']) && $_REQUEST['registration_id']!='')
{
	...
	$fetch_general_info="select * from igja_gold_supply_awards where id='$registration_id' ";
	...
	$gold_supp_details = unserialize($rows_general_info['gold_supp_details']);
...
//	print_r($finance_details);exit;
	...
	<tr>
    <td colspan="2">4. Details on Supply of Gold </td>
    </tr>
    <tr>
	    <td colspan="2"> 
		...
		<table width="100%" border="1px" cellpadding="5px">
			...
			<td>'.$gold_supp_details['particular'][0].'</td>
			<td>'.$gold_supp_details['FY20'][0].'</td>
			<td>'.$gold_supp_details['FY19'][0].'</td>
			<td>'.$gold_supp_details['FY18'][0].'</td>
			
			</tr>
			<tr>
			<td>'.$gold_supp_details['particular'][1].'</td>
			<td>'.$gold_supp_details['FY20'][1].'</td>
			<td>'.$gold_supp_details['FY19'][1].'</td>
			<td>'.$gold_supp_details['FY18'][1].'</td>
		
			</tr>
			<tr>
			<td>'.$gold_supp_details['particular'][2].'</td>
			<td>'.$gold_supp_details['FY20'][2].'</td>
			<td>'.$gold_supp_details['FY19'][2].'</td>
			<td>'.$gold_supp_details['FY18'][2].'</td>
			
			</tr>
			<tr>
			<td>'.$gold_supp_details['particular'][3].'</td>
			<td>'.$gold_supp_details['FY20'][3].'</td>
			<td>'.$gold_supp_details['FY19'][3].'</td>
			<td>'.$gold_supp_details['FY18'][3].'</td>
...
$pdf->Output('IGJA-bank-agencies-supply-gold-'.$registration_id.'.pdf', 'D');
