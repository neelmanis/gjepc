<?php
    ...
    class Erptoweb {
        ...
        {	
			/* DB Connection Start*/
			$hostname = "localhost";
			$uname = "digitalk_gjepcsa";
			$pwd = "(_+&.63iH;p7";
			$database = "digitalk_gjepc_db";
			...
			$registration_id = getRegid($pan_no);
    ...
    $server = new SOAPServer('http://kwebmakerdigitalagency.com/gjepc/soapcreate/create1/erptoweb.wsdl', array(
