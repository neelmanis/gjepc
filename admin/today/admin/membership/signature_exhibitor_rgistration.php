...
{ 
	...
	if($search_type=='SEARCH')
	{
		if($_SESSION['first_name']=="" && $_SESSION['company_name']=="" && $_SESSION['from_date']=="Form" && $_SESSION['to_date']=="To" && $_SESSION['country']=="" && $_SESSION['status']=="" && $_SESSION['last_yr_participant']=="" && $_SESSION['section']=="" && $_SESSION['selected_area']=="" && $_SESSION['selected_premium_type']=="")
		{
...
<title>IIJS Signature Exhibitor List</title>
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> >IIJS-Signature IVR</div>
</div>
...
<div id="main">
	<div class="content">
    	...
    	<div class="content_head_button">IIJS-Signature Exhibitor List</div></a><div style="float:right; padding-right:10px; font-size:12px;"><a href="export_approve_signature_exhibitor_rgistration.php">&nbsp;Download Data</a></div></div>
...
b.section,b.selected_area,b.selected_premium_type,c.payment_status,c.document_status,c.application_status 
from exh_reg_general_info a inner join exh_registration b on a.id=b.gid inner join exh_reg_payment_details c on a.id=c.gid
where a.event_for='$show' and  a.region='".$_SESSION["curruser_region_id"]."' ";
}
...
if($_SESSION['curruser_role']=="Super Admin")
{
	$sql="select a.id,a.uid,a.company_name,a.contact_person,a.region,c.created_date,b.last_yr_participant,b.options,
b.section,b.selected_area,b.selected_premium_type,c.payment_status,c.document_status,c.application_status 
from exh_reg_general_info a inner join exh_registration b on a.id=b.gid inner join exh_reg_payment_details c on a.id=c.gid
where a.event_for='$show'";
}
...
where a.event_for='$show' and  a.region='".$_SESSION["curruser_region_id"]."'";
  ...
  <tr >
    ...
    <td align="left" valign="middle"><a href="signature_exh_registration_step1.php?id=<?php echo $rows['id'];?>&registration_id=<?php echo $rows['uid'];?>"><img src="images/edit1.png" border="0" /></a> <a href="signature_exh_registration_step4.php?gid=<?php echo $rows['id'];?>&registration_id=<?php echo $rows['uid'];?>">A/D</a>    </td>
	<?php 
	if($rows['application_status']=="approved")
	{ ?>
	<td class="sap" data-id="<?php echo $rows['uid'];?>">PUSH to SAP</td>
	<?php }?>
  </tr>
...
$(".sap").click(function() {
	...
	if (confirm("Are you sure you want to PUSH this record")) {
		...
		success:function(data)
		{
			alert(data);
			/*if(data == 0){
			alert('No BP Found. Created New BP Data');
			} else {
			alert('Call Update API');
			} */
		},
		});
	}	  
