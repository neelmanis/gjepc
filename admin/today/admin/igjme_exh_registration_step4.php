	...
	if($action=='UPDATE')
	{
		...
		if($country == "INDIA" || $country == "IND" || $country == "IN")
		{
				...
				else
				{
					...
					$cheque_dd_date = mysql_real_escape_string(date("Y-m-d", strtotime($_POST["cheque_dd_date"])));
				...
				$update_query = "update igjme_exh_reg_payment_details set payment_mode='$payment_mode', cheque_dd_no='$cheque_dd_no', cheque_dd_date='$cheque_dd_date', cheque_drawn_bank_name='$cheque_drawn_bank_name', cheque_drawn_branch_name='$cheque_drawn_branch_name', bank_acc_no='$bank_acc_no', name_bank='$name_bank', name_bank_branch='$name_bank_branch', ifsc_code='$ifsc_code', int_acc_type='$int_acc_type', modified_date='$modified_date', payment_status='$approval', document_status='$doc_approval',payment_dissapprove_reason='$payment_dissapprove_reason',document_dissapprove_reason='$document_dissapprove_reason' where payment_id='$payment_id' and gid='$gid' and uid='$registration_id' and `show`='$show'";				
		}
		else
		{
				$int_acc_type = mysql_real_escape_string($_POST["int_acc_type"]);
...
<table width="100%" border="0" background="#fbfbfb" cellpadding="0" cellspacing="0">
     <tr>
    	<td align="left" valign="top"><a href="http://www.igjme.org"><img src="https://gjepc.org/igjme/images/iigme_logo.png" width="174" height="105" /></a></td>
    	<td align="right"><a href="http://www.gjepc.org"><img src="http://gjepc.org/igjme/images/newgjepc_logo.png" /></a></td>
    </tr>    
    <tr>
...
<tr>
    ...
    <strong>Premium :</strong>&nbsp; <?php echo getPremiumName($result['selected_premium_type']);?><br /><br /><br />
