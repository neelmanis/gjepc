...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: iijs_ivr_old_registration.php");
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> > IVR Old Registration</div>
</div>

<div id="main">
	<div class="content">
    
    	<div class="content_head"><a href="iijs_ivr.php"><div class="content_head_button">Manage IVR</div></a>  <a href="iijs_ivr_old_registration.php?action=view"><div class="content_head_button">IVR Old Registration</div> </a></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <?php
	...
	$start=($page-1)*$limit;
  	...
  	$sql="SELECT * FROM  `ivr_registration_details` WHERE 1 AND  `trade_show` = 'IIJS 2021'";
...
<?php echo pagination($limit,$page,'iijs_ivr_old_registration.php?action=view&page=',$rCount); //call function to show pagination?>
</div>        
