...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: iijs_ivr_new.php?action=view");
...
<div id="main">
	<div class="content">    
		...
		<a href="iijs_ivr_new.php?action=view"><div class="content_head_button">Manage IIJS IVR</div></a> 
		<?php if(!empty($adminID)){?>
		<!--<a href="iijs_ivr_new_old_registration.php"><div class="content_head_button">IIJS IVR Old Registration</div> </a>-->
		<a href="iijs_ivr_new_old_step.php?action=view"><div class="content_head_button">IIJS IVR Old Process Registration</div> </a>
		<div style="float:right; padding-right:10px; font-size:12px;"><a href="export_approve_iijs_ivr_new.php">&nbsp;Download Approved Data</a></div>
		<div style="float:right; padding-right:10px; font-size:12px;"><a href="export_disapprove_iijs_ivr_new.php">&nbsp;Download DisApproved Data</a></div>
		<div style="float:right; padding-right:10px; font-size:12px;"><a href="export_iijs_ivr_new_vc.php">&nbsp;Download All Data with VC</a></div>
		<div style="float:right; padding-right:10px; font-size:12px;"><a href="export_iijs_ivr_new.php">&nbsp;Download All Data without VC</a></div>
		<?php } ?>
		</div>
...
<?php 
	$sql5="SELECT * FROM  `ivr_registration_details` WHERE 1 AND `trade_show` = 'IIJS SIGNATURE 2022'";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="detail_txt" >
  <tr class="orange1">
    <td colspan="11">IIJS SIGNATURE 2022 Summary</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  <tr class="orange1">
    ...
    <td width="20%">Directory Status</td>
  ...
  $sql="SELECT count(vd.uid) as total_persons,rm.id, rm.company_name, rm.email_id, rm.mobile_no,rm.approval_status,vd.uid,rm.country,vd.eid,vd.application_approved FROM registration_master rm inner join ivr_registration_details vd on rm.id=vd.uid where rm.country!='IN' ";
  ...
  $sql.=" and vd.application_approved='".$_SESSION['visitor_approval']."'";
 	...
 	$sql.=" GROUP BY rm.id ORDER BY vd.time_stamp desc "; 
...
if($rCount>0)
  ...
  <tr>
    ...
    <td> <a href="iijs_ivr_new.php?action=employeesList&registration_id=<?php echo $rows['uid'];?>">View directory  </a> / <a href="iijs_ivr_new.php?action=ordersList&registration_id=<?php echo $rows['uid'];?>"> order history  </a></td>
    <td><?php if($rows['application_approved'] =="P"){echo "Pending"; }else if($rows['application_approved'] =="Y"){ echo "Approved"; }else if($rows['application_approved'] =="N"){ echo "Disapproved"; } ?></td>
...
<?php echo pagination(20,$page,'iijs_ivr_new.php?action=view&page=',$rCount); //call function to show pagination?>
</div> 
</form>
...
<div class="content_details1">
	...
	?>
	Company Name: <?php echo $company_name; ?><div class="content_head_button" style="float:right; padding-right:10px; font-size:12px;"><a href="iijs_ivr_new.php?action=view">Back</a></div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  <tr class="orange1">
    <td width="7%" height="10">#</td>
...
<div class="content_details1">
  ...
  <?php
   ...
   $sql_order="SELECT * FROM  `ivr_registration_history` WHERE 1 AND  `registration_id` = '$registration_id' order by create_date desc ";
