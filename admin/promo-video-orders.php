...
<tr >
  ...
  <td>
      ...
      <option <?php if($_SESSION['response']=="E00328"){echo "selected";}?> value="E00328">Cheque</option>
 	...
 	<tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
	  ...
	  <!--   <td><?php echo $row['person_email']; ?></td> -->
        ...
        <td><?php if($row['Response_Code']=="E00335"){
        	...
        	echo "NEFT ";
        }else if($row['Response_Code']=="E00328"){
          echo "cheque ";
        }else{
        	echo "Aborted ";
        } ?>
        ...
        <td> 
          ...
          if($row['Response_Code']=="E000" || $row['Response_Code']=="E00329" || $row['Response_Code']=="E00328"){
