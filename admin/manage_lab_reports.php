...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: manage_lab_reports.php?action=view");
} else {
...
$fn = "visitors_lab_reports_".$pRegion. date('Ymd');
...
<td>Status</td>
	...
	$sql="SELECT v.visitor_id,l.create_date, l.pan_no,r.id,r.company_name,l.mobile_no,l.lab_name,l.location,l.status,v.name
	from visitor_lab_info l 
	left join registration_master r on l.registration_id=r.id 
	left join visitor_directory v on l.visitor_id=v.visitor_id where l.status='1' AND via='lab'";
...
<div id="main">
    ...
    <div style="float:right; padding-right:10px; font-size:12px;"><a href="manage_lab_reports.php?action=view">Back to Visitor</a></div>
    <?php } ?>
    </div>-->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
    ...
    <td><?php echo filter($rows['location']);?></td>
...
<?php echo pagination($limit,$page,'manage_lab_reports.php?action=view&page=',$rCount); //call function to show pagination?>
</div>
</div>
</div>
