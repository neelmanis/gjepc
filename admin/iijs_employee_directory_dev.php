...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="detail_txt" >
  ...
  <tr>
    ...
    <td><input type="text" name="mobile" id="mobile" class="input_txt" value="<?php echo $mobile; ?>" maxlength="10"/> <label><input type="checkbox" id="is_mobile_change" name="is_mobile_change" value="Y"> Change Mobile</label></td>
