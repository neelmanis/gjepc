...
inner join globalExhibition gb on gb.visitor_id=vd.visitor_id 
where oh.payment_status='Y' and oh.status = '1' AND oh.show = gb.event and (oh.show='signature23' || oh.show='iijstritiya23' || oh.show='combo23' || oh.show='stcombo23') and gb.participant_Type='VIS'";
$result = $conn ->query($sql);
