...
<title>IIJS <?php echo date("Y");?> Privilege Visitor Registration</title>
...
<div id="main">
	<div class="content">
    	...
    	<div class="content_head">IIJS 2018 Privilege Visitor Registration<div style="float:right; padding-right:10px; font-size:12px;"><a href="iijs_export_approve_pvr.php">&nbsp;Download Approved Data</a></div><div style="float:right; padding-right:10px; font-size:12px;"><a href="iijs_export_disapprove_pvr.php">&nbsp;Download DisApproved Data</a></div><div style="float:right; padding-right:10px; font-size:12px;"><a href="iijs_export_pvr.php">&nbsp;Download All Data</a></div></div>
    	
<div class="content_details1">
<?php 
	$sql5="SELECT * FROM  `pvr_registration_details` WHERE 1 AND  `participate_for_show` = 'IIJS' and participation_year='2018' and (application_status='1')";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="detail_txt" >
  ...
  <tr >
    ...
    <td><select name="payment_mode" id="payment_mode" class="input_txt">
		...
		<option value="1" <?php if($_SESSION['payment_mode']=='1'){echo "selected='selected'";}?>>Credit Card</option>
		<option value="2" <?php if($_SESSION['payment_mode']=='2'){echo "selected='selected'";}?>>Debit Card</option>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <?php  
	...
	$sql="SELECT * FROM `pvr_registration_details` WHERE `participate_for_show`='IIJS' and `participation_year`='2018'  and (application_status='1' || payment_mode=3)";
  ...
  <tr >
    ...
    <td>
	<?php $payment_mode=trim($rows['payment_mode']);
	if($payment_mode=='Cheque or DD') echo 'Cheque or DD';
	if($payment_mode=='Cash') echo 'Cash';
	if($payment_mode=='1') echo 'Credit Card';
	if($payment_mode=='2') echo 'Debit Card';
	...
	{
	echo "<img src='images/yes.gif' border='0' />    <a href='https://iijs.org/print_acknowledge/pvr_ack_admin.php?uid=$rows[uid]' target='_blank'>Print</a>";	
