...
if($action=='UPDATE')
{
	...
	//------------------------------------  Update Photo Image ----------------------------------------------------
		$photo_image = '';
		$target_folder = '/var/www/html/iijs.org/images/pvr_image/photo/';
		$path_parts = "";
		$ext="";
		$target_path = "";
		$filetoupload="";
		...
		if($_FILES['photo_image']['name'] != '')
		{
		  //Unlink the previuos image
		   ...
		   $filename="/var/www/html/iijs.org/images/pvr_image/photo/".$rpreviousimg['photo_image'];
		   unlink($filename);
		...
		//------------------------------------  Update ID proof ----------------------------------------------------
		$id_proof = '';
		$target_folder = '/var/www/html/iijs.org/images/pvr_image/passport/';
		$path_parts = "";
		$ext="";
		$target_path = "";
		$filetoupload="";
		...
		if($_FILES['id_proof']['name'] != '')
		{
		  //Unlink the previuos image
		   ...
		   $rpreviousimg=mysql_fetch_array($qpreviousimg);
		   $filename="/var/www/html/iijs.org/images/pvr_image/passport/".$rpreviousimg['id_proof'];
		   unlink($filename);
	...
	<tr>
	<td align="left"> <img src="https://gjepc.org/images/logo/iijs.png" width="190px"> </td>
		<td align="center"> <img src="https://gjepc.org/images/logo/iijs_signature.png" width=""> </td>
		<td align="right"> <img src="https://gjepc.org/images/logo/igje.png" width="190px"> </td>
	</tr>
	...
	<p>Your Application for the Privilege Visitor Registration for IIJS 2018 has been approved by IIJS Team.<p>
	
	<p>Request you to kindly login to our website to download the acknowledgement receipt for future reference.Click here to login <a href= "https://iijs.org/pvr.php" target="_blank">https://iijs.org/pvr.php</a></p>
	
	<p>You can also check the status of your application at <a href="https://iijs.org/pvr.php" target="_blank">https://iijs.org/pvr.php</a>. </p>
	...
	<p>Your Badge will be couriered to you by India Post. In-case, if you don\'t receive your badge by courier, then you can write to us at <a data-cke-saved-href="visitors@gjepcindia.com" href="mailto:visitors@gjepcindia.com">visitors@gjepcindia.com</a> or you can collect it from the venue by submitting the copy of the confirmation e-mail.</p>
	...
	<tr>
		<td colspan="3"><img src="https://www.gjepc.org/emailer_gjepc/Mailer/logos/foot.jpg"></td>
	</tr>
	</table>
	</td>
	</tr>
	...
	$to =$rows1['email'];
	$subject = "IIJS 2018 : Your Information for Privilege Visitor Registration has been approved by the Administrator"; 
	$headers  = 'MIME-Version: 1.0' . "\n"; 
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\n"; 
	$headers .= 'From: IIJS 2018 <admin@gjepc.org>';			
...
<p>The below details of your Privilege Visitor Registration form have been disapproved for IIJS 2018 by the IIJS team.</p>
...
<p>Request you to kindly login to our website and update your disapproved details. </p>
	...
	<p><strong>Name : </strong>'.$rows1['contact_person'].'</p>
	<p><strong>Email ID : </strong>'.getUserEmail($registration_id).'</p>
<p>Please <a href="https://iijs.org/login.php" style="color:#751b53; text-decoration:none; font-weight:bold;" target="_blank">click here</a> to login to iijs.org.</p>

<p>In case, If  you have forgotten your password, <a href="https://iijs.org/forgot_password.php" style="color:#751b53; text-decoration:none; font-weight:bold;" target="_blank">click here</a>.</p>

<!--<p>To avail exclusive hotel packages <a href="https://iijs.org/official_hotels.php" style="color:#751b53; text-decoration:none; font-weight:bold;" target="_blank">click here</a>.</p>-->
<p>Warm Regards,<br />
IIJS Team</p>
    </td>
    </tr>
	...
	<tr>
		<td colspan="3"><img src="https://www.gjepc.org/emailer_gjepc/Mailer/logos/foot.jpg"></td>
         ...
         $to =$rows1['email'];
	 $subject = "Your Privilege Visitor Registration Application Status"; 
	 $headers  = 'MIME-Version: 1.0' . "\n"; 
	 $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\n"; 
	 $headers .= 'From: IIJS 2018 <admin@gjepc.org>';			
	mail($to, $subject, $message, $headers);
