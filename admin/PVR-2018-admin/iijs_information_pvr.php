...
$id=mysql_real_escape_string($_REQUEST['id']);
$registration_id=mysql_real_escape_string($_REQUEST['registration_id']);
$sql="SELECT * FROM `pvr_registration_details` WHERE 1 and id='$id' and uid='$registration_id' and participate_for_show='IIJS' and participation_year='2018'";
$result=mysql_query($sql);
$rows=mysql_fetch_array($result);
$getContact_person = preg_replace('/\s+/', ' ', $rows['contact_person']); ;
$contact_person = explode(" ",$getContact_person);
...
<input name="gst" id="gst" type="text"  class="textField" value="<?php echo $gst; ?>" />
<div class="clear"></div>
</div>
