...
{	//echo "><pre>"; print_r($_POST);exit;
	...
	/*................................Get Country Code.....................................*/
	$q=mysql_query("select * from registration_master where `id` = '$registration_id'");
	...
	if($country_code=="IN"){
		...
		$bank_acnt_no="0255351";
	}
	
	/* UTR Data */
	$getUTR = "SELECT * FROM `utr_history` where registration_id='$registration_id' AND utr_approved='Y' order by `utr_date` desc limit 1";
