...
//$sql="SELECT * FROM visitor_lab_info WHERE 1 AND category_for='VIS'";
$sql="SELECT * FROM visitor_lab_info WHERE 1 AND category_for='VIS' AND visitor_id IN (SELECT o.visitor_id FROM visitor_order_history o, visitor_lab_info l where o.visitor_id=l.visitor_id AND (o.`show`='iijs22' || o.`show`='signature23' || o.`show`='iijstritiya23' || o.`show`='combo23'))";
$result = $conn ->query($sql);
