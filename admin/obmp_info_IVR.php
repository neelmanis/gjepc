...
if($action=='UPDATE')
{
	...
	header("Location: photo_form_IVR.php?id=$id&registration_id=$registration_id");
}
?>
...
<div id="main">
	<div class="content">
    	...
    	<div class="content_head">IVR >> OBMP Info
...
<tr>
    <td><table border="0" cellspacing="0" cellpadding="0" class="bottomSpace">
      <tr>
        ...
        <td><input name="pd_jewellery[]" type="checkbox" value="Precious Stone Jewellery" <?php if(preg_match('/Precious Stone Jewellery/',$pd_jewellery)){ echo 'checked="checked"'; } ?>/>Precious Stone Jewellery</td>
...
<tr>
  <td><table border="0" cellspacing="0" cellpadding="0" class="bottomSpace">
    <tr>
      <td colspan="4" class="maroon"><strong>Objective of visiting IIJS 2019 :</strong></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="obj_of_visit[]" type="checkbox" value="Technology" <?php if(preg_match('/Technology/',$obj_of_visit)){ echo "checked"; }?>/>
            Technology</td>
...
<tr>
  ...
  <table border="0" cellspacing="0" cellpadding="0" class="bottomSpace">
    <tr>
      <td colspan="4" class="maroon"><strong>How did you first learn about IIJS 2019 :</strong></td>
    </tr>
    <tr>
