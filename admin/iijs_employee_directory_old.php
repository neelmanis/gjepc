...
} else
{
	...
	$_SESSION['face_isApplied'] = $_REQUEST['face_isApplied'];
	}
}
?>
...
<div id="main">
	<div class="content">
        ...
        <div style="float:right; padding-right:10px; font-size:12px;">
        <a href="iijs_export_visitordelivery.php">&nbsp;Download Order Report </a>
        </div>
...
<tr>
<td><strong>Visitor Face Photo Status</strong></td>        
    <td>
        <select name="face_isApplied" class="input_txt-select">
        <option value="">Select Status</option>
        <option value="Y" <?php if($_SESSION['face_isApplied']=='Y'){echo "selected='selected'";}?>>Show FR Applied Visitors</option>
...
AND vd.isApplied='Y' AND vd.visitor_approval!='O' AND vo.payment_type='online'"; */
  ...
  <tr>
    ...
    <td align="left" valign="middle"><?php echo checkFaceApproval_status($rows['id'],$conn);?></td>
  </tr>
  <?php
   $i++;
   } 
