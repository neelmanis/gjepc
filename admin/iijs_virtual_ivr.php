...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: iijs_virtual_ivr.php?action=view");
...
<div id="main">
	<div class="content">    
		...
		<a href="iijs_virtual_ivr.php"><div class="content_head_button">Manage IIJS Virtual IVR</div></a> 
		<?php if(!empty($adminID)){?>
		<div style="float:right; padding-right:10px; font-size:12px;"><a href="export_iijs_virtual_ivr.php">&nbsp;Download IVR Data</a></div>
		<?php } ?>
		</div>
...
<?php echo pagination(10,$page,'iijs_virtual_ivr.php?action=view&page=',$rCount); //call function to show pagination?>
</div>        
</div>
</div>
