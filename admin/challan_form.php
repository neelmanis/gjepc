...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
	...
	<tr>
	<td colspan="3"><strong>Imitation Jewellery : <span class="star">*</span></strong></td>
	<td colspan="2"><input type="text" class="input_txt1" name="export_imitation_jewellery" id="export_imitation_jewellery" value="<?php echo $export_imitation_jewellery; ?>" onKeyUp="getexportdata()" onFocus="if(this.value=='0')value='';" onBlur="if(this.value=='')value='0';"/></td>
	</tr>
	...
	<tr>
	<td colspan="3"><strong>Imitation Jewellery: <span class="star">*</span></strong></td>
	<td colspan="2"><input type="text" class="input_txt1" name="import_imitation_jewellery" id="import_imitation_jewellery" value="<?php echo $import_imitation_jewellery; ?>" onKeyUp="getimportdata()" onFocus="if(this.value=='0')value='';" onBlur="if(this.value=='')value='0';"/></td>
	</tr>
