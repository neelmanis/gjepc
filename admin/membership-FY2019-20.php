...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: membership-FY2019-20.php");
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="membership-FY2019-20.php">Home</a> > Membership</div>
</div>
...
<?php echo pagination($limit,$page,'membership-FY2019-20.php?action=view&page=',$rCount); //call function to show pagination?>
</div>        
	...
	if (confirm("Are you sure you want to De-Register Company")) {
		...
		success:function(data)
		{
			...
			if($.trim(data)==1){
				...
				window.location.href = "membership-FY2019-20.php?action=view";
			} else {
