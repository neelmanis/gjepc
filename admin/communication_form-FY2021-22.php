...
header("Location: challan_form-FY2020-21.php?registration_id=$_REQUEST[registration_id]");
}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  <tr class="orange1">
    ...
    <td width="46%"><span class="text6 ">Lab Grown Diamond</span></td>
        ...
        <a href="challan_form-FY2021-22.php?registration_id=<?php echo $_REQUEST['registration_id'];?>"><div class="button">Next</div></a>
		</div>	
       </form> 
   </div>
  </div>
	...
	if (confirm("Are you sure you want to update this address with Delta API")) {
		...
		success:function(data)
		{
			...
			if($.trim(data)==1){
				...
				window.location.href = "communication_form-FY2020-21.php?registration_id="+registration_id;
			}else{
				alert("Sorry There is some problem with SAP response"); 
				window.location.href = "communication_form-FY2020-21.php?registration_id="+registration_id;
