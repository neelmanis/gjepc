...
if(!empty($_POST))
{
	...
	$commAddress = "SELECT * FROM `communication_address_master` WHERE `registration_id` = '$registration_id' and type_of_address='2' and address_identity='CTC' ORDER BY `type_of_address_sap` ASC";
