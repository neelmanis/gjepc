...
if($_REQUEST['company_action']=='save_document')
{
  ...
  { 
    ...
    foreach($person_id as $i => $person_id){
      ...
      if($parichay_type=="association"){ $class= "parichayCard_White"; } else { $class= "goldParichay_card"; }
...
<head>
	...
	body {font-family: 'Open Sans', sans-serif;}
			...
			.parichayCard_White {border: 2px solid #606060;background: #ffffff; margin: auto; width: 600px;margin: 0 auto; border-radius: 15px 15px 15px 15px;padding: 10px;font-size: 14px;}
			.parichayCard_White .title{color:#b8ad6f;}
			...
			.parichayCard_White .cardHead_2 {color: #b8ad6f;text-transform: uppercase;font-size: 14px;line-height: 20px;}
	</style>
</head>
<body>

	<table cellpadding='5'  class='".$class."'>
