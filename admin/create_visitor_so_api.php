...
{	//echo "<pre>"; print_r($_POST);exit;
	...
	$ho_bp_number 	 = intval($_POST['bpno']);
	...
	$query="SELECT * FROM `visitor_order_detail` WHERE regId='".$registration_id."' AND orderId='".$order_id."' AND payment_status='Y'";
