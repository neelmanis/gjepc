...
//print_r($users); exit;
fputcsv($output, array('UID', 'Title','FIRST NAME','LAST NAME', 'DESIGNATION','Company Name', 'OFFICE ADD','COUNTRY NAME','STATE','CITY','POSTAL CODE','TEL NO','FAX NO','MOBILE NO','PHOTO ID','EMAIL','HOTEL NAME','HOTEL ADD','STAY FROM','STAY TO','PERSON NAME','FAMILY ADD','FAMILY CONTACT','FAMILY RELATION','FAMILY STAY FROM','FAMILY STAY TO','APPLICATION STATUS','PENDING REASON','APPLICATION DATE','COMPANY PROFILE','PRODUCT DEALING','OBJECT OF VISITING','HOW TO KNOW ABOUT THE SHOW'));
