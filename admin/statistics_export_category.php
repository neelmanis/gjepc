...
{
	$sql="delete from statistics_export_category where id='$_REQUEST[id]'";
	
	if (!mysql_query($sql,$dbconn))
	{
		die('Error: ' . mysql_error());
	}
	echo"<meta http-equiv=refresh content=\"0;url=statistics_export_category.php?action=view\">";
}
...
if (($_REQUEST['action']=='active') && ($_REQUEST['id']!=''))
{
		...
		$id=$_REQUEST['id'];
		$sql="update statistics_export_category set status='$status' where id='$id'";
		if (!mysql_query($sql,$dbconn))
		{
			die('Error: ' . mysql_error());
		}
...
if ($_REQUEST['action']=='save')
{
	...
	$sql="INSERT INTO statistics_export_category (cat_name,order_no,status) VALUES ('$cat_name', '$order_no','1')";	
	if (!mysql_query($sql,$dbconn))
	{
		die('Error: ' . mysql_error());
	}
...
if (($_REQUEST['action']=='update')&&($_REQUEST['id']!=''))
{
	...
	$sql="update statistics_export_category set cat_name='$cat_name',order_no='$order_no' where id='$id'";
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> > Manage Statistics Export Category</div>
</div>

<div id="main">
	<div class="content">
    	<div class="content_head"><a href="statistics_export_category.php?action=add"><div class="content_head_button">Add Statistics Export Category</div></a>  <a href="statistics_export_category.php?action=view"><div class="content_head_button">Manage Statistics Export Category</div> </a></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
    ...
    $i=1;
	$result = mysql_query("SELECT * FROM statistics_export_category where 1".$attach." ");
    $rCount=0;
...
if(($_REQUEST['action']=='add') || ($_REQUEST['action']=='edit'))
{
  ...
  {
		$action='update';
		$result2 = mysql_query("SELECT *  FROM statistics_export_category  where id='$_REQUEST[id]'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
  	<tr class="orange1">
    <td colspan="2"> &nbsp;Add Statistics Export Category</td>
    </tr>
