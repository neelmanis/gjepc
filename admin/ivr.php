...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> > IVR</div>
</div>

<div id="main">
	<div class="content">
    
    	<div class="content_head"><a href="ivr.php"><div class="content_head_button">Manage IVR</div></a>  <a href="ivr_old_registration.php?action=view"><div class="content_head_button">IVR Old Registration</div> </a><div style="float:right; padding-right:10px; font-size:12px;"><a href="export_approve_ivr.php">&nbsp;Download Approved Data</a></div><div style="float:right; padding-right:10px; font-size:12px;"><a href="export_disapprove_ivr.php">&nbsp;Download DisApproved Data</a></div><div style="float:right; padding-right:10px; font-size:12px;"><a href="export_ivr.php">&nbsp;Download All Data</a></div></div>
<div class="content_details1">
	<?php 
	$sql5="SELECT * FROM `ivr_registration_details` WHERE 1 AND `trade_show` = 'Signature 2020'";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="detail_txt" >
  ...
  <tr>
    ...
    <td>
	<input type="text" name="from_date" id="popupDatepicker" value="<?php if($_SESSION['from_date']==""){echo "Form";}else{echo $_SESSION['from_date'];}?>"  class="input_date"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  <tr class="orange1">
	...
	$start=($page-1)*$limit;  
	$sql="SELECT * FROM  `ivr_registration_details` WHERE 1 AND  `trade_show` = 'Signature 2020'";
  ...
  <tr >
    ...
    <td><?php echo filter($rows['email']);?></td>
    ...
    <td align="left" valign="middle"><a href="personal_information_IVR.php?id=<?php echo $rows['eid'];?>&registration_id=<?php echo $rows['uid'];?>"><img src="images/edit1.png" border="0" /></a> </td>
  </tr>
...
<?php echo pagination($limit,$page,'ivr.php?action=view&page=',$rCount); //call function to show pagination?>
</div>        
</div>
</div>
