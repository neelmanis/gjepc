...
if($action=='UPDATE')
{
	...
	//if (!$conn ->query($updatesql)){die('Error: ' . mysqli_error());}
	$_SESSION['succ_msg']="Information updated successfully";
	header("Location: iijs_virtual_obmp_info_IVR.php?id=$id&registration_id=$registration_id");
	}
...
<title>IIJS VIRTUAL &gt; IVR &gt;&gt; Personal Information</title>
...
<div id="main">
	<div class="content">
    	...
    	<div class="content_head">IIJS VIRTUAL &gt; IVR >> Personal Information
...
<tr>
     <td>Please confirm your India stay during Signature IIJS 2018 : <sup>*</sup></td>        	
     <td>
		<span>Hotel</span>
