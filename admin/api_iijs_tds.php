...
{	
	...
	/* Start Sales Order */
	$query="select a.id,a.uid,a.bp_number,a.billing_address_id,a.company_name,a.contact_person,a.region,a.city,a.created_date,a.get_billing_bp_number,b.gid,b.last_yr_participant,
