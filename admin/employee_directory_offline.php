...
padding: .35em;">
    ...
    <a href="https://www.iijs-signature.org/employee_directory_offline.php" target="_blank">https://www.iijs-signature.org/employee_directory_offline.php</a></p>
	</td>
	</tr>
    <tr>
	<td colspan="2"><br/>
...
/***  Emailer End **/
echo"<meta http-equiv=refresh content=\"0;url=employee_directory_offline.php?action=viewReg&regid=$registration_id\">";
}
}
?>
...
{	
	...
	echo"<meta http-equiv=refresh content=\"0;url=employee_directory_offline.php?action=view\">";exit;
	}
	
	$sqlreg = "UPDATE `registration_master` SET company_pan_no='$company_pan_no', company_gstn='$company_gstn',`approval_status`='$approval_status', `disapprove`='$disapprove' WHERE id='$registration_id'";
...
/***  Emailer End **/
echo"<meta http-equiv=refresh content=\"0;url=employee_directory_offline.php?action=view\">";
}
}
?>
...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: employee_directory_offline.php?action=view");
} else
{
...
<title>OnSpot IIJS Signature 2019</title>
...
<div id="main">
	<div class="content">
        ...
        Order Details <div class="content_head_button" style="float:right; padding-right:10px; font-size:12px;"><a href="employee_directory_offline.php?action=view">Back</a></div>
        ...
        <a href="employee_directory_offline.php?action=orderDetails&regid=<?php echo $registration_id; ?>">Back</a></div>
        Payment Details
        <?php } elseif($_REQUEST['action']=='viewReg'){ ?>Employee Directory 
        <div class="content_head_button" style="float:right; padding-right:10px; font-size:12px;"><a href="employee_directory_offline.php?action=view">Employee Directory</a></div>
        <div class="content_head_button" style="float:right; padding-right:10px; font-size:12px;"><a href="employee_directory_offline.php?action=view">Back</a></div> 
        ...
        <a href="employee_directory_offline.php?action=viewReg&regid=<?php echo $registration_id; ?>">Back</a></div>
        ...
        <a href="employee_directory_offline.php?action=view">Back</a></div> 
        <?php } else { ?>	Offline Employee Directory
       <div style="float:right; padding-right:10px; font-size:12px;">
	   <div style="float:right; padding-right:10px; font-size:12px;">
        <a href="export_onspot_visitor_order_history.php">Download Order History</a></div>
        ...
        <a href="export_pending_emp_dir.php">&nbsp;Download Pending Data</a></div><div style="float:right; padding-right:10px; font-size:12px;">
        <a href="export_emp_directory.php">&nbsp;Download All Data</a></div><div style="float:right; padding-right:10px; font-size:12px;">
        <a href="export_visitor_order_history.php">&nbsp;Download Order History</a></div><div style="float:right; padding-right:10px; font-size:12px;">
        <a href="export_visitordelivery.php">&nbsp;Download OrderID with Delivery</a></div></div>-->
		<div class="clear"></div>
        <?php } ?>
        </div>
<?php if($_REQUEST['action']=='view') { ?>
...
<?php 
	...
	$sql5="SELECT a.* , b.* FROM registration_master a INNER JOIN visitor_order_detail b ON a.id = b.regId
	WHERE b.payment_type='offline' AND b.payment_status = 'Y'";
...
AND vd.isApplied='Y' AND vd.visitor_approval!='O' AND vo.payment_type='offline' AND vo.payment_status='Y'";
  ...
  <tr>
    ...
    <td align="center" valign="middle"><a href="employee_directory_offline.php?actions=companyedit&regid=<?php echo $rows['id'];?>">
    ...
    <td align="left" valign="middle"><a href="employee_directory_offline.php?action=orderDetails&regid=<?php echo $rows['id'];?>">Order Details</a> /  
    <a href="employee_directory_offline.php?action=viewReg&regid=<?php echo $rows['id'];?>">Employee Details</a></td>
...
<?php echo pagination($limit,$page,'employee_directory_offline.php?action=view&page=',$rCount); //call function to show pagination?>
</div>  
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <tr>
    ...
    <td align="left" valign="middle"><a href="employee_directory_offline.php?action=edit&id=<?php echo $rows['visitor_id'];?>&regid=<?php echo $rows['registration_id'];?>">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <tr >
	...
	<td align="left" valign="middle"><a href="employee_directory_offline.php?action=orderHistory&orderId=<?php echo $rows['orderId'];?>&regid=<?php echo $rows['regId'];?>" style="color:#000000">VIEW</a></td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="detail_txt" >
  ...
  <tr >
    ...
    <td>  
    <a data-fancybox="gallery" href="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/photo/<?php echo $photo; ?>"> 
    <img class="blah" src="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/photo/<?php echo $photo; ?>" alt="your image" /></a> 
    </td>
  </tr>
  <tr >
    <td ><strong>Pan Card Copy</strong></td>
    <td>
	<a data-fancybox="gallery" href="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/pan_copy/<?php echo $pan_copy; ?>">
    <img class="blah" src="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/pan_copy/<?php echo $pan_copy; ?>" alt="your image"/>
    </a> 
    </td>
  </tr>
  ...
  <tr >
    ...
    <td>
    <a data-fancybox="gallery" href="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/salary/<?php echo $salary_slip_copy; ?>">
    <img class="blah" src="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/salary/<?php echo $salary_slip_copy; ?>" alt="your image"  /></a> 
    </td>
  </tr>
  <?php } else { ?>
  <tr >
    ...
    <td >
    <a data-fancybox="gallery" href="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/partner/<?php echo $partner; ?>">
    <img class="blah" src="https://iijs-signature.org/images/employee_directory_offline/<?php echo $registration_id; ?>/partner/<?php echo $partner; ?>" alt="your image" />
    </a> 
    </td>
  </tr>
  <?php } ?>
...
$(".so").click(function() {
	...
	if (confirm("Are you sure you want to create sales order")) {
		$.ajax({
		url: "create_onspot_visitor_so_api.php",
		method:"POST",
