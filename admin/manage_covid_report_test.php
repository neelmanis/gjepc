...
function ExhbitorName($visitor_id){
        ...
        $query_sel = "SELECT Badge_Name FROM manual_signature.iijs_badge_items where Badge_Item_ID='$visitor_id'";
...
{ //	echo '<pre>'; print_r($_POST); exit;
	if($_POST['from_date']=="From" && $_POST['to_date']=="To")
	{
		$_SESSION['error_msg']="Please select Any Status";
	} else {
		
		$table = $display = "";	
$fn = "vaccine_certificate_". date('Ymd');
...
<tr>
	...
	$sql="SELECT * FROM visitor_lab_info WHERE `status` ='1'";
	if($_SESSION['pan_no']!="")
    {
	...
	{
	$sql.=" and create_date between '".date("Y-m-d",strtotime($_SESSION['from_date']))." 00:00:00' and '".date("Y-m-d",strtotime($_SESSION['to_date']))." 23:59:59'";
	}
	...
	$visitor_id = $rows['visitor_id'];
	$date = date("d-m-Y", strtotime($rows['create_date']));
...
$(function() {
	...
	$("#popupDatepicker").datepicker({ dateFormat: "yy-mm-dd",maxDate: 0 }).val()
//	$('#inlineDatepicker').datepick({onSelect: showDate});
//	$('#popupDatepicker1').datepicker();
	$("#popupDatepicker1").datepicker({ dateFormat: "yy-mm-dd",maxDate: 0 }).val()
...
<td><strong>Vaccine Dose</strong></td>        
    <td>
        ...
        <option value="booster_dose" <?php if($_SESSION['certificate']=='dose2'){echo "selected='selected'";}?>>Booster Dose</option>
        </select>
    </td>
</tr>
<tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  <tr class="orange1">
    ...
    <td>View Report</td>
    <td>Status</td>
    <?php if($_SESSION['curruser_login_id']=='1' || $_SESSION['curruser_login_id']=='28' || $_SESSION['curruser_login_id']=='37' || $_SESSION['curruser_login_id']=='176' || $_SESSION['curruser_login_id']=='55'){ ?><td>Delete</td><?php } ?>
  </tr>
    <?php  
    $page=1;//Default page
  ...
  <tr>
    ...
    <?php if($_SESSION['curruser_login_id']=='1' || $_SESSION['curruser_login_id']=='28' || $_SESSION['curruser_login_id']=='37' || $_SESSION['curruser_login_id']=='44' || $_SESSION['curruser_login_id']=='176' || $_SESSION['curruser_login_id']=='123' || $_SESSION['curruser_login_id']=='55'){ ?>
