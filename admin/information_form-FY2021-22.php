...
$cin_no	= filter($_REQUEST['cin_no']);
$pan_no	= str_replace(' ','',strtoupper(filter($_REQUEST['pan_no'])));
$tan_no	= filter($_REQUEST['tan_no']);
...
{
	if($msme_ssi_status!="Yes"){
	if($_REQUEST['ssi_registration_no']=="" || $_REQUEST['ssi_issue_date']=="" || $_REQUEST['ssi_pin_code']=="")
	{
		$_SESSION['error_msg']="Please Enter MSME/SSI Registration data";
		header('location:information_form.php?registration_id='.$registration_id);exit;
	}
	} /*else if($msme_ssi_status=="Yes"){
		$_SESSION['error_msg']="Please Enter UAN Registration No";
		header('location:information_form.php?registration_id='.$registration_id);exit;
	} */
}
...
$co_profile = strip_tags($_REQUEST['co_profile']);
$co_profile = str_replace("'",'',$_REQUEST['co_profile']);
...
$status=$rows['status'];
$e_sanchit_status=$rows['e_sanchit_status'];
?>
...
$(function() {
	...
	$('#year_of_starting_bussiness').datepick();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
    ...
    <tr>
	  ...
	  <td><input type="text" name="iec_no" id="iec_no" class="input_txt_new" value="<?php echo $iec_no;?>" maxlength="10" /></td>
	</tr>
...
<option value="SSTH" <?php if($eh_th_certification_no=="SSTH") echo 'selected="selected"'; ?>>SSTH</option>
   ...
   <tbody style="display:none;" id="memberttypedisplay">
	...
	<input type="radio" id="msmeNo" value="No" name="msme_ssi_status" <?php echo ($msme_ssi_status=='No')? 'checked':'' ?>/>  No</td>
		...
		<tr class="msme_main" <?php if($msme_ssi_status!='Yes'){?> style="display: none" <?php }?>>
		<td><strong>UAM/MSME/UDHYAM REGISTRATION No <span class="star"> * </span> </strong></td>
		...
		<tr class="msme_main" <?php if($msme_ssi_status!='Yes'){?> style="display: none" <?php }?>>
		<td><strong>DATE OF ISSUE of UAM/MSME/UDYAM<span class="star"> * </span> </strong></td>
		<td><input type="text" name="ssi_issue_date" id="ssi_issue_date" class="input_txt_new" value="<?php echo $ssi_issue_date;?>" readonly/></td>
		</tr>
		<tr class="msme_main" <?php if($msme_ssi_status!='Yes'){?> style="display: none" <?php }?>>
		<td><strong>UAM/MSME/UDHYAM Pin Code<span class="star"> * </span></strong></td>
		<td><input type="text" name="ssi_pin_code" id="ssi_pin_code" class="input_txt_new" value="<?php echo $ssi_pin_code;?>" maxlength="6"/></td>
		</tr>
	
	
    <tr>
	<td><strong>ISSUING INDUSTRIAL LINCENCES/IEM </strong></td>
    ...
    <tr>
	  <td><strong>Date of Issue </strong></td>
	  <td><input type="text" name="eh_th_issue_date" id="eh_th_issue_date" class="input_txt_new" value="<?php echo $eh_th_issue_date;?>" readonly/></td>
	</tr>
    <tr>
	...
	<tr>
	<td><strong>E-Sanchit Registered</strong></td>
	<td>
	Yes <input type="radio" name="e_sanchit_status" value="Yes"<?php if($e_sanchit_status=='Yes'){ echo 'checked="checked"';}?> />
	No <input type="radio" name="e_sanchit_status" value="No" <?php if($e_sanchit_status=='No'){ echo 'checked="checked"';}?> />
	</td>
	</tr>
	...
	<td><input type="text" name="year_of_starting_bussiness" id="year_of_starting_bussiness" class="input_txt_new" value="<?php echo $year_of_starting_bussiness;?>" readonly/></td>
	</tr>
...
<a href="communication_form-FY2021-22.php?registration_id=<?php echo $registration_id;?>"><div class="button">Next</div></a>
</div>	
</form>
</div>
