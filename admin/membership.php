...
<form name="form1" action="" method="POST">
  ...
  <tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
	...
	<td><?php echo $rows['e_rcmc_certificate_no'];?></td>
