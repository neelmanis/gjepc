...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: iijs_signature_ivr.php?action=view");
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> >IIJS VIRTUAL IVR</div>
</div>

<div id="main">
	<div class="content">    
    	<div class="content_head">
		<a href="iijs_signature_ivr.php"><div class="content_head_button">Manage IIJS Virtual IVR</div></a> 
		<?php if(!empty($adminID)){?>
		<div style="float:right; padding-right:10px; font-size:12px;"><a href="export_iijs_signature_ivr.php">&nbsp;Download IVR Data</a></div>
		<?php } ?>
		</div>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="detail_txt" >
  ...
  <tr >
	...
	{
	if($_SESSION['country']==$rows2['country_code'])
	{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  {
    $sql.=" and modified_date between '".date("Y-m-d",strtotime($_SESSION['from_date']))."' and '".date("Y-m-d",strtotime($_SESSION['to_date']))."'";
  }
  ...
  <tr >
    ...
    <td align="left" valign="middle"><a href="iijs_virtual_personal_information_IVR.php?id=<?php echo $rows['eid'];?>&registration_id=<?php echo $rows['uid'];?>"><img src="images/edit1.png" border="0" /></a> </td>
  </tr>
...
<?php echo pagination(10,$page,'iijs_signature_ivr.php?action=view&page=',$rCount); //call function to show pagination?>
</div>        
</div>
</div>
