...
if($action=='UPDATE')
{
	...
	header("Location: iijs_exh_registration_step3.php?gid=$gid&registration_id=$uid");
...
<a href="iijs_exh_registration_step1.php?gid=<?php echo $gid;?>&registration_id=<?php echo $registration_id;?>">
<div class="button">Previous</div></a>
<a href="iijs_exh_registration_step3.php?gid=<?php echo $gid;?>&registration_id=<?php echo $registration_id;?>">
