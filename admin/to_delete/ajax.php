...
<tr>
 <td bgcolor="#CCCCCC" colspan="3"><strong>Address Details</strong></td>
  ...
  <tr >
	...
	<td><input type="text" class="input_txt1" id="pan_no" name="pan_no" value="<?php echo $cresult['pan_no'];?>" /></td>
	</tr> 
...
// current challan yr calculation
	...
	$service_tax=round(($total_amnt*15)/100);
