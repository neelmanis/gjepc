...
<?php 
	$sql5="SELECT * FROM  `pvr_registration_details` WHERE 1 AND  `participate_for_show` = 'IIJS' and participation_year='2017' and (application_status='1' || payment_mode=3)";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  $sql="SELECT * FROM `pvr_registration_details` WHERE `participate_for_show`='IIJS' and `participation_year`='2017'  and (application_status='1' || payment_mode=3)";
