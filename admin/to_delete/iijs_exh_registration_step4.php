...
<table width="100%" border="0" background="#fbfbfb" cellpadding="0" cellspacing="0">
    <tr>
    	<td align="left" valign="top"><a href="http://www.iijs.org"><img src="http://iijs.org/images/IIJS logo-01.png" width="174" height="105" /></a></td>
    	<td align="right"><a href="http://www.gjepc.org"><img src="http://iijs.org/images/gjepc_logo.png" width="174" height="105"  /></a></td>
    </tr>    
    <tr>
...
<a href="#" style="text-decoration:none; color:#14b3da;">Registration Status</a> | <a href="#" style="text-decoration:none; color:#14b3da;">Travel & Hotel</a> | <a href="#" style="text-decoration:none; color:#14b3da;">Show Updates</a> | <a href="#" style="text-decoration:none; color:#14b3da;">Helpdesk</a> | <a href="#" style="text-decoration:none; color:#14b3da;">FAQs</a> | <a href="#" style="text-decoration:none; color:#14b3da;">OBMP</a>
	...
	$subject = "IIJS Exhibitor Registration Approval Status/dated".date('Y-m-d').")";
	$headers  = 'MIME-Version: 1.0' . "\r\n";
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";	
	$headers .='From: IIJS 2017 <admin@gjepc.org>';	
...
<title>IIJS &gt; Exhibitor Registration &gt; Step2</title>
...
<tr>
    ...
    <strong>Govt. Tax (14.5% on Sub Total) <?php echo $currency;?> :</strong>&nbsp; <?php echo $result['govt_service_tax'];?><br />
    <strong>Grand Total <?php echo $currency;?> :</strong>&nbsp; <?php echo $result['grand_total'];?><br/>
    <strong>Mcb Charges <?php echo $currency;?> :</strong>&nbsp; <?php echo $result['mcb_charges'];?> 
    </td>
</tr>
...
All the applicants will have to send the print acknowledgement receipt along with the RTGS Details (With UTR / Reference no.) The same has to be compulsorily signed ONLY by the Director / Partner / Proprietor on all the pages (including the terms & conditions section) including company seal within 4 working days from the date of successful online submission.
        ...
        <div id="chequeordd">
            <div class="field_box">
                ...
                <div class="field_input"><input name="cheque_dd_no" id="cheque_dd_no" type="text" class="bgcolor" value="<?php if($cheque_dd_no=="0")
																																	echo "";
																																else
