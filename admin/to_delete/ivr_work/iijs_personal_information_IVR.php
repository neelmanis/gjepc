...
<tr >
  ...
  &nbsp;&nbsp;<?php if($passport_fid!=""){?><a href="https://iijs.org/images/ivr_image/passport/<?php echo $passport_fid;?>" target="_blank">View Passport</a><?php }?></td>
 </tr>
...
<tr >
  ...
  <td><input name="company_name" type="text"  class="input_txt" id="company_name" value="<?php echo $company_name;?>"/>&nbsp;&nbsp;<?php if($visit_card_fid!=""){?><a href="https://iijs.org/images/ivr_image/visiting_card/<?php echo $visit_card_fid;?>" target="_blank">View Visiting Card</a><?php }?></td>
</tr>
<tr >
