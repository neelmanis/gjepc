...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="admin.php">Home</a> >IIJS Hotel Registration</div>
</div>

<div id="main">
	<div class="content">
    
    	<div class="content_head">IIJS Hotel Registration
    	  <!-- <div style="float:right; padding-right:10px; font-size:12px;"><a href="iijs_export_hotel_exh.php">Download Excel Manual</a></div> --><div style="float:right; padding-right:10px; font-size:12px;"><a href="iijs_export_hotel_web.php">&nbsp;Download Excel Website</a></div></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
  ...
  <tr >
    ...
    <td><?php echo $rows['applicant_company_name'];?></td>
    <td><?php echo $rows['applicant_email_id'];?></td>
    <td><?php echo $rows['applicant_mobile_no'];?></td>
    <td><?php echo getHotelName($rows['hotel_id']);?></td>
