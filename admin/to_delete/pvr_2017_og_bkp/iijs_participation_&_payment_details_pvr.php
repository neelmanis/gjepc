...
<option value="COMBO" <?php if($payment_made_for=="COMBO") echo "selected"; ?>>Combo (IIJS 2016 + Signature IIJS 2017)</option>
		 <option value="iijs_machinary" <?php if($payment_made_for=="iijs_machinary") echo "selected"; ?>>IIJS 2016 Machinery Section Only (Complementary)</option>
         <option value="iijs" <?php if($payment_made_for=="iijs") echo "selected"; ?>>IIJS 2016 including Machinary Section</option>
  <option value="iijs_signature_igjme" <?php if($payment_made_for=="iijs_signature_igjme") echo "selected"; ?>>(Signature IIJS 2017 + IGJME 2017) </option>

<option value="iijs_igjme" <?php if($payment_made_for=="iijs_igjme") echo "selected"; ?>>Only IGJME 2017 (Complementary)</option>
          </select>
       <!--<input name="payment_made_for" type="text" class="textField" value="<?php echo $payment_made_for; ?>" />-->
    </div>
      <div class="clear" style="margin-bottom:8px;"></div>
    <div>
