...
$report_name = 'DOWNLOAD DISAPPROVE APPLICATION';
...
<?PHP
  ...
  $filename = "TradeDisApproved_" . date('Ymd') . ".csv";
  ...
  $flag = false;
  $result = $conn ->query("SELECT * FROM `trade_general_info` WHERE `application_status`='N'") or die('Query failed!');
