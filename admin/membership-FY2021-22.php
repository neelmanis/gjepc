...
if($_REQUEST['Reset']=="Reset")
{
  ...
  header("Location: membership-FY2021-22.php");
...
<div class="breadcome_wrap">
	<div class="breadcome"><a href="membership-FY2021-22.php">Home</a> > Membership</div>
</div>
...
<div class="content_head">
 ...
 <a href="member_payment_export_data-FY21-22.php">&nbsp; &nbsp;Export Payment List 21-22</a>
 </div>
</div>
...
<form name="form1" action="" method="post" >
  ...
  <tr <?php if($i%2==0){ echo "bgcolor='#CCCCCC'";} ?>>
    ...
    <td valign="middle"><a href="information_form-FY2021-22.php?registration_id=<?php echo $rows['id'];?>"><img src="images/edit1.png" border="0" /></a></td>
	<?php
	if($_SESSION['status']=='Issue_membership_certificate')
	{
	echo "<td align='left'><input name='issue_mem_cer[]' type='checkbox' value='$rows[id]' /> /<a href='../rcmc/membership-FY2021-22.php?registration_id=$rows[id]' target='_blank'> View Certificate</a></td>";
	}
	?>	
...
<?php echo pagination($limit,$page,'membership-FY2021-22.php?action=view&page=',$rCount); //call function to show pagination?>
</div>        
	...
	if (confirm("Are you sure you want to De-Register Company")) {
		...
		success:function(data)
		{
			...
			if($.trim(data)==1){
				...
				window.location.href = "membership-FY2021-22.php?action=view";
			} else {
