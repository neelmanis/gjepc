		...
		<div class="row justify-content-center grey_title_bg">           	
            ...
            <div class="container">		
             ...
             <div class="col-12">
                			...
                			<div><button onclick="location.href = 'association_registration.php';" class="lang ">English</button></div>
                			<div><button onclick="location.href = 'association_registration-hindi.php';" class="lang active">Hindi</button></div>
            			</div>
                        </div>
			...
			<!-- 	<div class="row mb-5 ab_none justify-content-between align-items-center">
                    ...
                    <div class="row mb-4">                    
                        ...
                        <div class="form-group col-12 mb-4">
                            <p class="blue tr" key="enroll">एसोसिएशन रजिस्ट्रेशन प्रक्रिया &nbsp;&nbsp;<span id="chkregisuser"></span><br><span id="chkpanuser"></span></p>
                        </div>     
                           
                          <div class="col-12 mb-3">
                          	<ul class="inner_under_listing">Note:
                          	<li>(अलाउड फ़ाइल का प्रकार:jpeg,png,pdf और फ़ाइल अपलोड करने की अधिकतम साइज 2 mb)</li>
                          	<li><a href="http://gjepc.org/pdf/Request-Letter-Format-Associaiton-Parichay-Card.pdf" target="_blank" style="color: blue">रिक्वेस्ट लेटर  का फॉर्मेट डाउनलोड करें<i class="fa fa-arrow"></i></a></li>
                          </ul> 
                          </div>   
                          <hr>
                            ...
                            <div class="form-group col-sm-6">
							<label for="company_name">एसोसिएशन का पूरा नाम<span>*</span></label>
							<input type="text" class="form-control mt-4" id="company_name" name="company_name" value="<?php echo $company_name;?>" autocomplete="off" maxlength="100">
							</div>                    
                        
							<div class="form-group col-sm-6">
							<label for="association_registration_no">एसोसिएशन का रजिस्ट्रेशन नंबर <span>*</span></label>
							<p id="chkRegisNo"></p>						
							...
							<div class="form-group col-sm-6">
								<p></p>
                            <label for="association_registration_certificate">एसोसिएशन के रजिस्ट्रेशन सर्टिफिरेट की स्कैन कॉपी अपलोड करें<span>*</span></label>
							...
							<div class="form-group col-sm-6">
							<label for="association_head_name">एसोसिएशन हेड का पूरा नाम<span>*</span></label>
							...
							<div class="form-group col-sm-6">
                            <label for="association_head_visiting_card">एसोसिएशन हेड की विजिटिंग कार्ड की स्कैन कॉपी अपलोड करें</label>
							...
							<div class="form-group col-sm-6">
							<label for="association_head_designation">एसोसिएशन हेड का डेज़िग्नेशन<span>*</span></label>
							<p></p>
							...
							<div class="form-group col-sm-6">
							<label for="association_head_mobile_no1">एसोसिएशन हेड मोबाइल नंबर 1 <span>*</span></label>
							...
							<div class="form-group col-sm-6">
								<p></p>
							<label for="association_head_mobile_no2">एसोसिएशन हेड मोबाइल नंबर 2</label>
							...
							<div class="form-group col-sm-6">
							<label for="head_email_id">एसोसिएशन हेड की ईमेल आयडी<span>*</span></label>
							...
							<label for="total_member">आज तक एसोसिएशन में सदस्यों की कुल संख्या </label>
							...
							<div class="form-group col-md-6">
                            <div class="d-block"><label for="nature_of_business" class="tr" key="Business">आपके संघ में सदस्यों की प्रोफाइल (सभी लागू विक्लपों पर टिक करें)- </label></div>
							<div class="mt-2">
                                    <label for="Exporters" class="mr-3">
                                    <input type="checkbox" name="nature_of_buisness[]" id="Exporters" class="mr-2" value="Exporters">निर्यातक 
                                    </label>
                                    <label for="Manufacturer" class="mr-3">
                                    <input type="checkbox" name="nature_of_buisness[]" id="Manufacturer"  class="mr-2" value="Manufacturer">निर्माता
                                    </label>
                                    <label for="Retailers" class="mr-3">
                                    <input type="checkbox" name="nature_of_buisness[]" id="Retailers"  class="mr-2" value="Retailers">खुदरा विक्रेता
                                    </label>
                                    <label for="Brokers" class="mr-3">
                                    <input type="checkbox" name="nature_of_buisness[]" id="Brokers"  class="mr-2" value="Brokers">ब्रोकर
                                    </label>                          
                                    <label for="Karigars">
                                    <input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness"  class="mr-2" value="Karigars">कारीगर
                                    </label>
                                    <label for="other">
                                    <input type="checkbox" name="nature_of_buisness[]" id="other"  class="mr-2" value="other">अन्य
                                    </label>
                                    <div id="nature_of_buisness_other"><label>अन्य, कृपया निर्दिष्ट करें</label>
									<input type="text" class="form-control" name="nature_of_buisness[]" id="other" autocomplete="off">
                                    </div>
						...
						<div class="form-group col-sm-6">
                        <label for="association_office_address">कृपया एसोसिएशन कार्यालय के पते का स्कैन किया हुआ प्रमाण अपलोड करें (बिजली बिल, फोन बिल आदि 3 महीने से अधिक पुराना नहीं।)</label>
                        <input type="file" id="association_office_address" name="association_office_address" class="form-control" autocomplete="off">
                        </div>
						
						<div class="form-group col-md-6">
                        <label for="no_of_parichay_card">आपके संघ के लिए आवश्यक परिचय कार्डों की संख्या।</label>
						...
						<div class="form-group col-12 mb-4">
                        <p class="blue">	एसोसिएशन कोऑर्डिनेटर) एसोसिएशन के प्राधिकृत व्यक्ति का जानकारी के समन्वय और सत्यापन के लिए नीचे विवरण भरें:</p> </div> 
