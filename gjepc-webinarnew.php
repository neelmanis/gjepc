...
<section>
    ...
    <div class="container">
        ...
        ?>
        <h1 class="title">upcoming webinar</h1>
        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="webinar_slider">
                    <?php if($count_webinars>0){
                     ...
                     <div>
                    <div class=" webinarBox p-3">
                    <div class="row align-items-center">
                            <div class="col-md-5"><div class="pic goldenBorder"><img src="assets/images/webinar/new/<?php echo $row_webinars['banner']; ?>" class="img-fluid d-block " /></div></div>		
                            ...
                            <div class=" p-4 webinarBrief">
                                ...
                                <div class="row ab_none justify-content-between mb-4">
                                    ...
                                    <div class="col pl-5">
                                        <div class=" d-flex h-100">
                                        <div class="align-self-center">
                                        <div class="d-block webinarDay mb-2 goldBg"><?php echo date("l j M, Y ", strtotime($row_webinars['post_date']));?></div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col"><a href="gjepc-webinar-details.php?page=<?php echo $row_webinars['id'];?>" class="mt-4 news_read_more long_arw" style="text-decoration:none;">Read more <span></span></a></div>
                                </div>
                            </div>
                            </div>
                    </div>
         ...
         <h1 class="title">upcoming workshop</h1>
         <?php 
                ...
                <div class="workshop_slider">
                   ...
                   <?php if($count_workshop>0){
                    ...
                    <div class="webinarBox goldenBorder">
                    	<div class="row">
                            <div class="col-md-6 pic"><img src="assets/images/webinar/new/<?php echo $row_workshop['banner']; ?>" class="img-fluid d-block mb-3" /></div>
                            <div class="p-4 webinarBrief">
