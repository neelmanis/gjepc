...
<section>
    ...
    <div class="container">
        ...
        $sql_webinars = "SELECT * FROM webinar_master WHERE type='webinar' AND status='0' AND post_date >= CURDATE() ORDER BY post_date ASC";
                    ...
                    <div class="webinarBox goldenBorder">
                            ...
                            <div class="p-4 webinarBrief">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"><a href="gjepc-webinar-details.php?page=<?php echo $row_webinars['id'];?>">Read more</a></div>
                                </div>
                            </div>
                    </div>
                    </div>
        ...
        $sql_workshop = "SELECT * FROM webinar_master WHERE type='workshop' AND status='0' AND post_date >= CURDATE() ORDER BY post_date ASC";
