...
?>
<?php 
$querys = $conn ->query("select * from trade_general_info where app_id=$app_id and registration_id='$registraton_id'");
...
<table cellpadding="1" width="95%" align="center" id="print_div" style="font-size:13px;">
	...
	<tbody>
        ...
        <!--<tr>
         <td align="left"></td>
          <td align="right"><img src="http://www.gjepc.org/images/logo_gjepc.png" width="150" height="91" /></td>
        </tr>
        <tr>
		...
		<tr><td colspan="2" >Kindly refer to your letter dated <?php echo $application_date;?> on the above subject seeking permission for Export Promotion Tour as Per details given below:</td></tr>
		<tr><td colspan="2"><b>Description for item to be taken:</b></td></tr>
		<?php if($item1!=""){?>
		<tr>
		...
		<tr>
			<td colspan="2">
				<table width="100%" border="1" cellpadding="0" cellspacing="0" style="font-size:11px;">
					...
					<tr>
						<td><?php echo getCountryName($visiting_country3,$conn);?></td><td><?php echo strtoupper($city3);?></td><?php echo $from_date;?></td><td><?php echo $to_date;?></td>
					</tr>
                    <?php }?>
                    <?php if($visiting_country4!=''){?>
					<tr>
						<td><?php echo getCountryName($visiting_country4,$conn);?></td><td><?php echo strtoupper($city4);?></td><?php echo $from_date;?></td><td><?php echo $to_date;?></td>
					</tr>
                    <?php }?>
                    <?php if($visiting_country5!=''){?>
					<tr>
						<td><?php echo getCountryName($visiting_country5,$conn);?></td><td><?php echo strtoupper($city5);?></td><?php echo $from_date;?></td><td><?php echo $to_date;?></td>
					</tr>
                    <?php }?>
                    <?php if($visiting_country6!=''){?>
					<tr>
						<td><?php echo getCountryName($visiting_country6,$conn);?></td><td><?php echo strtoupper($city6);?></td><?php echo $from_date;?></td><td><?php echo $to_date;?></td>
					</tr>
                    <?php }?>
		...
		<tr>
			<td colspan="2"><i><b>1). If under any circumstance, you fail to import the unsold goods back on or before the time period defined as per Para 4.80 of HBoP, your goods may be liable to be imported after payment of applicable import duty as a penalty, if such delay is not duty condoned by DGFT.</b></i></td>
		</tr>	
		<tr>
			<td colspan="2"><i><b>2). For any changes of conditionality as mentioned above in this approval, for any reason thereof, you are requested to apply to Council with valid reason before the date of completion of the exhibition/export promotion tour thereof as mentioned above.</b></i></td>
		</tr>	
		<tr>
			<td colspan="2">This is for your kind information.</td>
		</tr>
      ...
      <!--  <tr><td colspan="2" align="center" height="80px;"><h2>The Gem & Jewellery Export Promotion Council</h2></td></tr>-->
          <?php 
