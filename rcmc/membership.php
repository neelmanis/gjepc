...
if(isset($_REQUEST['registration_id']) && $_REQUEST['registration_id']!='')
{
    ...
    <table width="100%" border="0px">
     ...
     <tr>
    <td>Ref. No.: GJC/P/RNW/2022-2023</td>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Renewal as an '.$membership_certificate_type.' Member for the year 2022-2023 </td>
    </tr>
...
<p>We acknowledge the receipt of your application dated '.$print_date.' for renewal of your membership for the year 2022-2023.

We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year 2022-2023.</p>
...
elseif((strtoupper($membership_certificate_type)=='ASSOCIATE' || strtoupper($membership_certificate_type)=='ZASSOC') && $membership_type!='Y' && $gmember=='')
{
		$content.='
		<br>
		<br>
...
<td>
    ...
    <table width="100%" border="0px" >
     <tr>
    <td>Ref. No.: GJC/P/FRM/2022-2023</td>
    <td align="right">Date : '.$date.'</td>
    </tr>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Enrollment as an '.$membership_certificate_type.' Member for the year 2022-2023</td>
    </tr>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Enrollment as an '.$membership_certificate_type.' Member for the year 2022-2023.</p>

<p>We have pleasure to inform you that your membership has been enrolled as an '.$membership_certificate_type.' Member of the Council for the year 2022-2023.</p>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Renewal as an '.$membership_certificate_type.' Member for the year 2022-2023.</p>
<p>We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year 2022-2023.</p>
...
} elseif((strtoupper($membership_certificate_type)=='ASSOCIATE' || strtoupper($membership_certificate_type)=='ZASSOC') && $membership_type!='Y' && $gmember=="MICRO")
{
		$content.='
		<br>
		<br>
...
<td>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;"> '.$gmember.' ASSOCIATE MEMBERSHIP CERTIFICATE</td>
    </tr>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Enrollment as an '.$gmember.' '.$membership_certificate_type.' Member for the year 2022-2023</td>
    </tr>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Enrollment as an '.$gmember.' '.$membership_certificate_type.' Member for the year 2022-2023.</p>

<p>We have pleasure to inform you that your membership has been enrolled as an '.$gmember.' '.$membership_certificate_type.' Member of the Council for the year 2022-2023.</p>

<p>Your '.$gmember.' '.$membership_certificate_type.' Membership Number is <b>'.$membership_id.'.</b></p>
