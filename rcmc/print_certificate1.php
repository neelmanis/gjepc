...
$ext_branch_office_result = mysql_query("SELECT * FROM  communication_address_master WHERE registration_id = '$registration_id'  and type_of_address='3' limit 2,35");
...
$ext_factor_office = mysql_query("SELECT * FROM  communication_address_master WHERE registration_id = '$registration_id'  and type_of_address='4' limit 5,20");/* 01June 2018*/
