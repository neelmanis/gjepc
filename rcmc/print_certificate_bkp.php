...
$company_name = str_replace('&AMP;', '&', $company_name);
...
$ext_branch_office_result = $conn ->query("SELECT * FROM  communication_address_master WHERE registration_id = '$registration_id'  and type_of_address='3' limit 2,35");
