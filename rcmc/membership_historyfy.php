...
if(isset($_REQUEST['registration_id']) && $_REQUEST['registration_id']!='')
{
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Renewal as an '.$membership_certificate_type.' Member for the year '.$year.' </td>
    </tr>
...
<p>We acknowledge the receipt of your application dated '.$print_date.' for renewal of your membership for the year '.$year.'.

We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year '.$year.'.</p>
...
<td>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Enrollment as an '.$membership_certificate_type.' Member for the year '.$year.'</td>
    </tr>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Enrollment as an '.$membership_certificate_type.' Member for the year '.$year.'.</p>

<p>We have pleasure to inform you that your membership has been enrolled as an '.$membership_certificate_type.' Member of the Council for the year '.$year.'.</p>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Renewal as an '.$membership_certificate_type.' Member for the year '.$year.'.</p>
<p>We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year '.$year.'.</p>
