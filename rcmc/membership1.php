...
if(isset($_REQUEST['registration_id']) && $_REQUEST['registration_id']!='')
{
    ...
    <table width="100%" border="0px">
     ...
     <tr>
    <td>Ref. No.: GJC/P/RNW/2021-2022</td>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Renewal as an '.$membership_certificate_type.' Member for the year 2021-2022.</p>
<p>We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year 2021-2022.</p>
...
<td>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Enrollment as an '.$gmember.' '.$membership_certificate_type.' Member for the year 2021-2022</td>
    </tr>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Enrollment as an '.$gmember.' '.$membership_certificate_type.' Member for the year 2021-2022.</p>

<p>We have pleasure to inform you that your membership has been enrolled as an '.$gmember.' '.$membership_certificate_type.' Member of the Council for the year 2021-2022.</p>
