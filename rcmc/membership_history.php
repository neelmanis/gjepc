...
if(isset($_REQUEST['registration_id']) && $_REQUEST['registration_id']!='')
{
	...
	$year=2020;
	$fetch_data="select * from membership_certificate_history where registration_id='$registration_id' ";
    ...
    <table width="100%" border="0px">
     ...
     <tr>
    <td>Ref. No.: GJC/P/RNW/2020-2021</td>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Renewal as an '.$membership_certificate_type.' Member for the year 2020-2021 </td>
    </tr>
...
<p>We acknowledge the receipt of your application dated '.$print_date.' for renewal of your membership for the year 2020-2021.

We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year 2020-2021.</p>
...
<td>
    ...
    <table width="100%" border="0px" >
     <tr>
    <td>Ref. No.: GJC/P/FRM/2020-2021</td>
    <td align="right">Date : '.$date.'</td>
    </tr>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Enrollment as an '.$membership_certificate_type.' Member for the year 2020-2021</td>
    </tr>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Enrollment as an '.$membership_certificate_type.' Member for the year 2020-2021.</p>

<p>We have pleasure to inform you that your membership has been enrolled as an '.$membership_certificate_type.' Member of the Council for the year 2020-2021.</p>
...
<p>We acknowledge receipt of your application dated '.$print_date.' for Renewal as an '.$membership_certificate_type.' Member for the year 2020-2021.</p>
<p>We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year 2020-2021.</p>
...
$pdf->Output('Membership-certificate.pdf', 'D');
