...
class MYPDF extends TCPDF {
	...
	public function Footer() {
		...
		// Position at 15 mm from bottom
			...
			$this->SetFont('times', 'b', 8);
    		// Page number
    		$this->Cell(180, 5, 'Tel: '. $this->tel_no .' E-mail: '. $this->email .' ' , 0, 1, 'C', 0, '', 0, false, 'T', 'M');
			...
			if($this->email != "gjepc@vsnl.com"){
				...
				$this->Cell(180, 5, 'Tel: +91-22-26544600/42263600 Fax +91-22-26524764, Email: ho@gjepcindia.com Website: http://www.gjepc.org', 0, 1, 'C', 0, '', 0, false, 'T', 'M');
				$this->Cell(180, 5, 'Connecting with GJEPC is now a call away | Toll Free Number: 1800-103-4353 | Missed Call Number : +91-72080 48100', 0, 1, 'C', 0, '', 0, false, 'T', 'M');
			}
	}
}
/*
...
if(isset($_REQUEST['registration_id']) && $_REQUEST['registration_id']!='')
{
    ...
    <table width="100%" border="0px">
     ...
     <tr>
    <td>Ref. No.: GJC/P/FRM/2021-2022</td>
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Renewal as an '.$membership_certificate_type.' Member for the year 2021-2022 </td>
    </tr>
...
<p>We acknowledge the receipt of your application dated '.$print_date.' for renewal of your membership for the year 2021-2022.

We have pleasure to inform you that your membership has been renewed as an '.$membership_certificate_type.' Member of the Council for the year 2021-2022.</p>
...
elseif((strtoupper($membership_certificate_type)=='ASSOCIATE' || strtoupper($membership_certificate_type)=='ZASSOC'))
{
		$content.='
		<br>
		<br>
...
<tr>
 <td colspan="3" id="content">
    ...
    <tr>
    <td align="center" colspan="2" style="text-align:center; font-size:13px; font-weight:bold;">Sub: Enrollment as an '.$membership_certificate_type.' Member for the year 2021-2022</td>
    </tr>
    ...
    <p>Dear Sir,</p>
<p>We welcome you in GJEPC family & our best wishes for your future association with Council.</p>
<p>We acknowledge receipt of your application dated '.$print_date.' for Enrollment as an '.$membership_certificate_type.' Member for the year 2021-2022.</p>

<p>We have pleasure to inform you that your membership has been enrolled as an '.$membership_certificate_type.' Member of the Council for the year 2021-2022.</p>
...
With reference to the provisions of Article 5.3 of Memorandum & Article of Association of the Council, this membership certificate and RCMC thereof are being issued provisionally, subject to approval of your membership by Committee of Administration or its assigned Committee / authority of the Council. (subject to submission of all documents ) If you do not receive any further communication within 3 (three) months from the date of your application for membership with the Council, this membership and RCMC will be deemed to have been accepted by the Council and you will be inducted as an associate member of the Council from the date of issue of certificate.</p>
<p style="text-align:justify">You are requested to ensure submission of all the online forms along with the relevant supporting documents (duly signed by Proprietor/Partner/Director as the case may be) in the manner as prescribed by GJEPC, vide email membership@gjepcindia.com Or upload on GJEPC portal.</p>
<p style="text-align:justify">Members are also requested to ensure dispatch of bank attested signature slip through post/courier to respective Council/s offices within 15 days.</p>
<p style="text-align:justify">FOLLOWING DOCUMENTS TO BE SUBMITTED TO HEAD OFFICE OR RESPECTIVE REGIONAL OFFICE OF GJEPC : </p>

<p style="text-align:justify">Application form for Associate Membership, Application form for (RCMC) and challan form duly signed by Proprietor/Partner/Director as the case may be.</p>
<ul>
...
<p style="text-align:justify">In addition to the submission of above-mentioned documents completion of MYKYC is mandatory , within a maximum period of three months from the date of this certificate, for issuance of Registration-cum-Membership Certificate (RCMC)</p>
<p>In case of non- receipt of the original signed documents within the above-mentioned period, the Membership will stand as cancelled.</p>  
<p>Yours truly,</p>  
