<?php 
$pageTitle = "Gems And Jewellery Industry In India | Commodity Wise Import - GJEPC India";
...
include 'functions.php';
	...
	if($_REQUEST['Reset']=="Reset")
	{
		  ...
		  header("Location: commodity-wise-import.php");
	} else {
    ...
    <div class="row justify-content-center">	
		...
		<input type="hidden" name="search_type" id="search_type" value="SEARCH"/>     
            ...
            <div class="form-group col-12 mb-4">
                <p class="blue text-center">IMPORTS - COMMODITY-WISE</p>
            </div> 
	...
	/*	if($cur_month > 4) { */
		...
		<div class="col-12">
                <div class="row py-3" style="border-top: 1px solid #ccc">
                            <div class="col-12"><h2 class="title text-center mb-1"><span class="d-table mx-auto mb-3" style="width:35px;"><img src="assets/images/black_star.png" class="img-fluid d-block"></span>Imports - Commodity-wise</h2></div>
                            ...
                            <div class="col-12">
								...
								<div class="row justify-content-center mt-4">
								   ...
								   <button onclick="exportToExcel('tblexportData', 'commodity-wise-import')" class="cta gold_btn" title="Export To Excel"><i class="fa fa-file-excel-o" style="font-size: 40px;"></i></button>
                                   </div>
                            </div>
						<div class="col-12">
				...
				/* Same */		if(getFinancialYear($conn)==$financial_year){ $sameYear = "YES"; } else { $sameYear = "NO"; }			
									...
									{	//print_r($row);								
										...
										if($currency=="INR")
										{
											...
											$getCurrentYearData  = getCurrentcommoditywiseINR_i($_REQUEST['financial_year'],$row['hs_code'],$conn);
											...
											$getPreviousYearData = getPreviouscommoditywiseINR_i($last_finyr,$row['hs_code'],$sameYear,$currentMonth,$conn);
											...
											$getCurrentYearData = getCurrentcommoditywiseUSD_i($_REQUEST['financial_year'],$row['hs_code'],$conn);
										//	$newTotal_Paisa  = round($getCurrentYearData/$_POST['currency_usd'],2);	
											...
											$getPreviousYearData = getPreviouscommoditywiseUSD_i($last_finyr,$row['hs_code'],$sameYear,$currentMonth,$conn);
				...
				/* Same */		if(getFinancialYear($conn)==$financial_year){ $sameYear = "YES"; } else { $sameYear = "NO"; }			
									...
									{	//echo '<pre>'; print_r($row);								
										...
										if($currency=="INR")
										{
											...
											$getPreviousYearData = getPreviousSpecificcommoditywiseINR_i($last_finyr,$row['commodity_category'],$sameYear,$currentMonth,$conn);
											$getPreviousData	 = round($getPreviousYearData/$_POST['currency_inr'],2);
											$sub_lastYear_Paisa  = round($sub_lastYear_Paisa + $getPreviousYearData/$_POST['currency_inr'],2);											
										...
										//	$newTotal_Paisa  = round($row['total_usd']/$_POST['currency_usd'],2);	
											...
											$getPreviousYearData = getPreviousSpecificcommoditywiseUSD_i($last_finyr,$row['commodity_category'],$sameYear,$currentMonth,$conn);
											$sub_lastYear_Paisa  = round($sub_lastYear_Paisa + $getPreviousYearData/$_POST['currency_usd'],2);
										//	$getPreviousData	 = round($getPreviousYearData/$_POST['currency_usd'],2);
											$number  = $getPreviousYearData/$_POST['currency_usd'];
											$getPreviousDataNOround  = number_format($number, 12, '.', '');
