...
include 'functions.php';
		...
		$sql="SELECT * from statistics_integration_hscode_master where 1 AND hs_code LIKE '%$hs_code%' AND level='6' order by hs_code asc";	
                                ...
                                <table class="table table-bordered tableInfo">
									...
									{ ?>
										 <tr>
											...
											if($row['level']=="6"){ ?>
											<a target="_blank" href="hs_code_list8.php?hs=<?php echo $row['hs_code'];?>"><u>8</u></a><?php } 
											} 
