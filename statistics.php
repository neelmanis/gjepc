...
June 2022</a>
                                                        ...
                                                        <li class="col-md-6 px-2">
                                                            ...
                                                            Index Of Industrial Production And Use-based Index April 2022</a>
                                                        </li>
                            ...
                            <div class="row justify-content-center">                    
                                <ul class="download_pdf row market">
                                    ...
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India-Malaysia-Collaboration-Possibilities-2.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                        <img src="assets/images/market_reports/India-Malaysia-Collaboration-Possibilities-2.jpg" class="img-fluid d-block mb-3">India – Malaysia Collaboration possibilities #2</i></a> 
                                    </li>
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India-Malaysia-Global-Connect-Report.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                        <img src="assets/images/market_reports/India-Malaysia-Global-Connect-Report.jpg" class="img-fluid d-block mb-3">India – Malaysia Collaboration possibilities #1</i></a> 
                                    </li>

								    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India-Egypt-Global-Connect-Report.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                            <img src="assets/images/market_reports/global-connect.png" class="img-fluid d-block mb-3">India Egypt Collaboration possibilities</i>
                                        </a> 
                                    </li>
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India–Lebanon-IGC-Report.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                            <img src="assets/images/market_reports/India–Lebanon-IGC-Report.jpg" class="img-fluid d-block mb-3"> India - Lebanon Collaboration possibilities</i>
                                        </a> 
                                    </li>
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India-Global-Connect-Business-Networking-Meet-India-Thailand.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                            <img src="assets/images/market_reports/India-Global-Connect-Business-Networking-Meet-India-Thailand.jpg" class="img-fluid d-block mb-3"> India - Thailand Collaboration Possibilities</i>
                                        </a> 
                                    </li>
                                    ...
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India-Global-Connect-Business-Networking-Meet-India-Qatar.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                            <img src="assets/images/market_reports/India-Global-Connect-Business-Networking-Meet-India-Qatar.jpg" class="img-fluid d-block mb-3"> India - Qatar Collaboration Possibilities </i>
                                        </a> 
                                    </li>
                                    ...
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India-Global-Connect-Business-Networking-Meet-India-Hong-Kong.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                            <img src="assets/images/market_reports/India-Global-Connect-Business-Networking-Meet-India-Hong-Kong.jpg" class="img-fluid d-block mb-3"> India - Hong Kong Collaboration Possibilities</i>
                                        </a> 
                                    </li>
                                    ...
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/India-Global-Connect-Business-Networking-Meet-India-Saudi-Arabia.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                            <img src="assets/images/market_reports/India-Global-Connect-Business-Networking-Meet–India-Saudi-Arabia.jpg" class="img-fluid d-block mb-3"> India-Saudi Arabia Collaboration Possibilities</i>
                                        </a> 
                                    </li>
                                    ...
                                    <li class="col-md-4 mb-4">
                                        <a href="pdf/market_reports/Indian-Morocco-Global-Connect-Collaboration-Possibilities-1.pdf" target="_blank" class="pdf_wrp enhancing h-100">
                                            <img src="assets/images/market_reports/Indian-Morocco-Global-Connect-Collaboration-Possibilities-1.jpg" class="img-fluid d-block mb-3"> 
                                                Indian-Morocco Collaboration Possibilities</i>
                                        </a> 
                                    </li>
                    ...
                    <div id="pane-G" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-G">
                        ...
                        <div class="card-body p-lg-0"> 
                            <ul class="row">
                                ...
                                <li class="col-md-6 px-2">
                                <a href="assets/images/statistics/sez/SEZ-Interactive-meet-7th-July-2022.pdf" target="_blank" class="new_pdf_wrp">SEZ Interactive Meet- 7th July 2022 <span class="blink" style="color:#f00; font-size:11px;"> New </span> </a>
                                </li>
                                <li class="col-md-6 px-2">
                            ...
                            <div class="row">
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg1"> 
                                        ...
                                        <h1 class="glance_no" id="totalExportUSDMillion-remove">3699.88</h1> 
                                    </div>
                                </div>
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg2">
                                        <p class="text-center">Total Imports US$ <span>Million</span></p>
                                        <h1 class="glance_no" id="totalImportUSDMillion-remove">2886.92</h1> 
                                    </div>
                                </div>
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg3">
                                        <p class="text-center">YOY % Growth Export</p>
                                        <h1 class="glance_no" id="growthMothExportPer-remove">90.23</h1>
                                    </div>
                                </div>
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg4">
                                        <p class="text-center">YOY % Growth Import</p>
                                        <h1 class="glance_no" id="growthMotImportPer-remove">112.12</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="tabs-2" role="tabpanel">
                            <div class="row">
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg1">
                                        <p class="text-center">Total Exports US$ <span>Million</span></p>
                                        <h1 class="glance_no" id="totalExportFYUSDMillion-remove">39452.38</h1>                                        
                                    </div>
                                </div>
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg2">
                                        <p class="text-center">Total Imports US$ <span>Million</span></p>
                                        <h1 class="glance_no" id="totalImportFYUSDMillion-remove">26648.99</h1>                                        
                                    </div>
                                </div>
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg3">
                                        <p class="text-center">YOY % Growth Export</p>
                                        <h1 class="glance_no" id="growthFYExportPer-remove">54.68</h1>                                      
                                    </div>
                                </div>
                                <div class="col-6 col-md mb-4 mb-md-0">
                                    <div class="glance_box bg4">
                                        <p class="text-center">YOY % Growth Import</p>
                                        <h1 class="glance_no" id="growthFYImportPer-remove">61.58</h1>                                      
                                    </div>
                                </div>
                            </div>
                        </div>                  
        ...
        <div class="mb-5" data-aos="fade-up">
            ...
            <h1 class="bold_font text-center" style="color:#000;"> <img src="assets/images/gold_star.png" class="d-block mx-auto mb-3"> Key Gem & Jewellery Exports <br /> World & India's Position (2019 - 2021)</h1>
            ...
            <div class="position_slider py-4 position_bg">
                ...
                <div class="px-3">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-10 position_slider_title">
                            <h3>India's Gem & Jewellery Sector - 2019 - 2021 <span>A Leading Exporter in Global Market</span></h3>
                        </div>                    
                    </div> 

                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_1" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab1" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="pr_tab_2021_1" role="tabpanel">
                                ...
                                <div class="col-lg-6">   
                                    ...
                                    <div id="skills">                                
                                        <div class="row mb-3 align-items-center progress1">
                                            ...
                                            <div class="col px-2">
                                                <progress value="13.10" max="15"></progress><span>13.10%</span> 
                                            </div>
                                        </div>   
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>USA</h4></div>
                                            <div class="col px-2">
                                                <progress value="10.10" max="15"></progress><span>10.10%</span>
                                            </div>
                                        </div>          
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>Hong Kong</h4></div>
                                            <div class="col px-2">
                                                <progress value="8.80" max="15"></progress><span>8.80%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>UK</h4></div>
                                            <div class="col px-2">
                                                <progress value="8.10" max="15"></progress><span>8.10%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress1">
                                            ...
                                            <div class="col px-2">
                                                <progress value="5.70" max="15"></progress><span>5.70%</span>
                                            </div>
                                        </div>  
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="4.70" max="15"></progress><span>4.70%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>South Africa</h4></div>
                                            <div class="col px-2">
                                                <progress value="4.30" max="15"></progress><span>4.30%</span>
                                            </div>
                                        </div>            
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="3.90" max="15"></progress><span>3.90%</span>
                                            </div>
                                        </div>                                
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="3.20" max="15"></progress><span>3.20%</span>
                                            </div>
                                        </div>                                
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="3.10" max="15"></progress><span>3.10%</span>
                                            </div>
                                        </div>                                
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="3" max="15"></progress><span>3%</span>
                                            </div>
                                        </div>                                
                                    </div> 
                                </div>
                        ...
                        <div class="tab-pane" id="pr_tab1" role="tabpanel">
                ...
                <div class="px-3">  
                    ...
                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_2" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab3" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="pr_tab_2021_2" role="tabpanel">
                            ...
                            <table class="responsive_table">
                                ...
                                <tbody>                         
                                     <tr style="background:none;">
                                        ...
                                        <td data-column="World Exports" class="text-lg-center">87.8</td>
                                        <td data-column="India's Exports" class="text-lg-center">8.43</td>
                                        <td data-column="India's Share(%)" class="text-lg-center">9.60</td>
                                     ...
                                     <tr>
                                        ...
                                        <td data-column="World Exports" class="text-lg-center">72.53</td>
                                        <td data-column="India's Exports" class="text-lg-center">23.84</td>
                                        <td data-column="India's Share (%)" class="text-lg-center">32.90</td>
                                     ...
                                     <tr style="background:none;">
                                        ...
                                        <td data-column="World Exports" class="text-lg-center">10.35</td>
                                        <td data-column="India's Exports" class="text-lg-center">2.12</td>
                                        <td data-column="India's Share (%)" class="text-lg-center">20.50</td>
                                     ...
                                     <tr>
                                        ...
                                        <td data-column="World Exports" class="text-lg-center">9.44</td>
                                        <td data-column="India's Exports" class="text-lg-center">0.759</td>
                                        <td data-column="India's Share (%)" class="text-lg-center">8</td>
                                        <td data-column="India's Ranking" class="text-lg-center">3rd</td>
                                     </tr>                             
                                     <tr style="background:none;">
                                        ...
                                        <td data-column="World Exports" class="text-lg-center">7.78</td>
                                        <td data-column="India's Exports" class="text-lg-center">0.165</td>
                                        <td data-column="India's Share (%)" class="text-lg-center">2.10</td>
                                        <td data-column="India's Ranking" class="text-lg-center">8th</td>
                                     </tr>                           
                                     <tr>
                                        ...
                                        <td data-column="World Exports (US$ billion)" class="text-lg-center">4.41</td>
                                        <td data-column="India's Exports (US$ billion)" class="text-lg-center">1.25</td>
                                        <td data-column="India's Share (%)" class="text-lg-center">28.40</td>
                                        <td data-column="India's Ranking" class="text-lg-center">1st</td>
                                     </tr>                             
                                </tbody> 
                            </table> 
                        </div> 
                        <div class="tab-pane" id="pr_tab3" role="tabpanel">
                ...
                <div class="px-3 gold"> 
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-10 position_slider_title">
                            <h3>India's Diamond Sector - 2019 - 2021 <span>A Leading Exporter in Global Market</span></h3>
                        </div>
                    </div>
                    
                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_3" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab5" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="pr_tab_2021_3" role="tabpanel">                            
                            <div class="row align-items-center"> 
                                <div class="col-lg-6">  
                                ...
                                <div class="col-lg-6">   
                                    ...
                                    <div id="skills"> 
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            <div class="col-lg-auto px-2"><h4>India</h4></div>
                                            <div class="col px-2">
                                                <progress value="32.9" max="35"></progress><span>32.9%</span> 
                                            </div>
                                        </div> 
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            <div class="col-lg-auto px-2"><h4>USA</h4></div>
                                            <div class="col px-2">
                                                <progress value="19.18" max="35"></progress><span>19.18%</span>
                                            </div>
                                        </div>  
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            <div class="col-lg-auto px-2"><h4>Hong Kong</h4></div>
                                            <div class="col px-2">
                                                <progress value="17.8" max="35"></progress><span>17.8%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="9.5" max="35"></progress><span>9.5%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="4.9" max="35"></progress><span>4.9%</span>
                                            </div>
                                        </div>  
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="2.7" max="35"></progress><span>2.7%</span>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="2.6" max="35"></progress><span>2.6%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="1.7" max="35"></progress><span>1.7%</span>
                                            </div>
                                        </div>                                  
                                        ...
                                        <div class="row mb-3 align-items-center progress2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="1.1" max="35"></progress><span>1.1%</span>
                                            </div>
                                        </div>
                                    </div> 
                                </div>
                        ...
                        <div class="tab-pane" id="pr_tab5" role="tabpanel">                            
                            <div class="row align-items-center"> 
                                <div class="col-lg-6">  
                ...
                <div class="px-3">  
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-10 position_slider_title">
                            <h3>Gold Jewellery Sector - 2019 - 2021 <span>Global Exports & India's Position</span></h3>
                        </div>
                    </div>

                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_4" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab7" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="pr_tab_2021_4" role="tabpanel">
                                ...
                                <div class="col-lg-6">   
                                    ...
                                    <div id="skills"> 
                                        <div class="row mb-3 align-items-center progress3">
                                            ...
                                            <div class="col px-2">
                                                <progress value="12.9" max="18"></progress><span>12.9%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="11.8" max="18"></progress><span>11.8%</span>
                                            </div>
                                        </div>  
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="10.1" max="18"></progress><span>10.1%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2"><h4>India</h4></div>
                                            <div class="col px-2">
                                                <progress value="9.6" max="18"></progress><span>9.6%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="9" max="18"></progress><span>9%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="7.6" max="18"></progress><span>7.6%</span>
                                            </div>
                                        </div>  
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2"><h4>USA</h4></div>
                                        ...
                                        <div class="row mb-3 align-items-center progress3">
                                            ...
                                            <div class="col px-2">
                                                <progress value="5.70" max="18"></progress><span>5.70%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2"><h4>UAE</h4></div>
                                        ...
                                        <div class="row mb-3 align-items-center progress3">
                                            <div class="col-lg-auto px-2"><h4>Singapore</h4></div>
                                            <div class="col px-2">
                                                <progress value="3.3" max="18"></progress><span>3.3%</span>
                                            </div>
                                        </div>                               
                        ...
                        <div class="tab-pane" id="pr_tab7" role="tabpanel">
                ...
                <div class="px-3">                    
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-10 position_slider_title">
                            <h3>Silver Jewellery - 2019 - 2021 <span>Global Exports & India's Position</span></h3>
                        </div>
                    </div>
                    
                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_5" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab9" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="pr_tab_2021_5" role="tabpanel">
                                ...
                                <div class="col-lg-6">   
                                    ...
                                    <div id="skills">
                                        <div class="row mb-3 align-items-center progress4">
                                            ...
                                            <div class="col px-2">
                                                <progress value="20.7" max="25"></progress><span>20.7%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="20.5" max="25"></progress><span>20.5%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="16.4" max="25"></progress><span>16.4%</span>
                                            </div>
                                        </div>  
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="9.8" max="25"></progress><span>9.8%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="8.5" max="25"></progress><span>8.5%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2"><h4>USA</h4></div>
                                            <div class="col px-2">
                                                <progress value="4.7" max="25"></progress><span>4.7%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2">
                                        ...
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2"><h4>Israel</h4></div>
                                            <div class="col px-2">
                                                <progress value="1.3" max="25"></progress><span>1.3%</span> 
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress4">
                                            <div class="col-lg-auto px-2"><h4>Turkey</h4></div>
                        ...
                        <div class="tab-pane" id="pr_tab9" role="tabpanel">
                ...
                <div class="px-3">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-10 position_slider_title">
                            <h3>Colour Gemstones - 2019 - 2021 <span>Global Exports & India's Position</span></h3>
                        </div>
                    </div>
                    
                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_6" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab11" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="pr_tab_2021_6" role="tabpanel">
                                ...
                                <div class="col-lg-6">   
                                    ...
                                    <div id="skills"> 
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            <div class="col-lg-auto px-2"><h4>Hong Kong</h4></div>
                                            <div class="col px-2">
                                                <progress value="30.53" max="35"></progress><span>30.53%</span> 
                                            </div>
                                        </div>   
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            <div class="col-lg-auto px-2"><h4>USA</h4></div>
                                            <div class="col px-2">
                                                <progress value="18.89" max="35"></progress><span>18.89%</span>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            ...
                                            <div class="col px-2">
                                                <progress value="7.46" max="35"></progress><span>7.46%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            <div class="col-lg-auto px-2"><h4>Switzerland</h4></div>
                                            <div class="col px-2">
                                                <progress value="7.08" max="35"></progress><span>7.08%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            ...
                                            <div class="col px-2">
                                                <progress value="4.16" max="35"></progress><span>4.16%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            ...
                                            <div class="col px-2">
                                                <progress value="4.02" max="35"></progress><span>4.02%</span>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            ...
                                            <div class="col px-2">
                                                <progress value="3.31" max="35"></progress><span>3.31%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            ...
                                            <div class="col px-2">
                                                <progress value="2.49" max="35"></progress><span>2.49%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            <div class="col-lg-auto px-2"><h4>UAE</h4></div>
                                            <div class="col px-2">
                                                <progress value="2.46" max="35"></progress><span>2.46%</span>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="row mb-3 align-items-center progress5">
                                            ...
                                            <div class="col px-2">
                                                <progress value="1.84" max="35"></progress><span>1.84%</span>
                                            </div>
                                        </div>  
                        ...
                        <div class="tab-pane" id="pr_tab11" role="tabpanel">
                ...
                <div class="px-3">                    
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-10 position_slider_title">
                            <h3>Imitation Jewellery - 2019 - 2021 <span>Global Exports & India's Position</span></h3>
                        </div>
                    </div>
                    
                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_7" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab13" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="pr_tab_2021_7" role="tabpanel">                            
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="row">                            
                                        <div class="col-sm-12 col-md-6 col-lg-12 mb-3 mb-lg-5 position_slider_txt">
                                ...
                                <div class="col-lg-6">   
                                    ...
                                    <div id="skills">                                
                                        <div class="row mb-3 align-items-center progress6">
                                            <div class="col-lg-auto px-2"><h4>China</h4></div>
                                            <div class="col px-2">
                                                <progress value="40.4" max="45"></progress><span>40.4%</span> 
                                            </div>
                                        </div>   
                                        <div class="row mb-3 align-items-center progress6">
                                            <div class="col-lg-auto px-2"><h4>Hong Kong</h4></div>
                                            <div class="col px-2">
                                                <progress value="9.3" max="45"></progress><span>9.3%</span>
                                            </div>
                                        </div>          
                                        <div class="row mb-3 align-items-center progress6">
                                            <div class="col-lg-auto px-2"><h4>France</h4></div>
                                            <div class="col px-2">
                                                <progress value="8.7" max="45"></progress><span>8.7%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress6">
                                            ...
                                            <div class="col px-2">
                                                <progress value="5.9" max="45"></progress><span>5.9%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress6">
                                            <div class="col-lg-auto px-2"><h4>Germany</h4></div>
                                            <div class="col px-2">
                                                <progress value="5.4" max="45"></progress><span>5.4%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center progress6">
                                            ...
                                            <div class="col px-2">
                                                <progress value="3.4" max="45"></progress><span>3.4%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress6">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="2.1" max="45"></progress><span>2.1%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress6">
                                            <div class="col-lg-auto px-2">
                                        ...
                                        <div class="row mb-3 align-items-center progress6">
                                            <div class="col-lg-auto px-2"><h4>Austria</h4></div>
                                            <div class="col px-2">
                                                <progress value="1.8" max="45"></progress><span>1.8%</span>
                                            </div>
                                        </div>            
                        ...
                        <div class="tab-pane" id="pr_tab13" role="tabpanel">                            
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="row">                            
                                        <div class="col-sm-12 col-md-6 col-lg-12 mb-3 mb-lg-5 position_slider_txt">
                ...
                <div class="px-3">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-10 position_slider_title">
                            <h3>Lab Grown Diamonds & Synthetic Stones - 2019 - 2021 <span>Global Exports & India's Position</span></h3>
                        </div>
                    </div>
                    
                    <ul class="nav nav-tabs d-flex pr_tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active" data-toggle="tab" href="#pr_tab_2021_8" role="tab">2021</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link" data-toggle="tab" href="#pr_tab15" role="tab">2020</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-lg-6">   
                                    ...
                                    <div id="skills">                                
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>India </h4></div>
                                            <div class="col px-2">
                                                <progress value="43.3" max="45"></progress><span>43.3%</span> 
                                            </div>
                                        </div>   
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>China</h4></div>
                                            <div class="col px-2">
                                                <progress value="17" max="45"></progress><span>17%</span>
                                            </div>
                                        </div>          
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>Hong Kong</h4></div>
                                            <div class="col px-2">
                                                <progress value="11.4" max="45"></progress><span>11.4%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>USA</h4></div>
                                            <div class="col px-2">
                                                <progress value="8.2" max="45"></progress><span>8.2%</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="4.9" max="45"></progress><span>4.9%</span>
                                            </div>
                                        </div>  
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="3" max="45"></progress><span>3%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="2.3" max="45"></progress><span>2.3%</span>
                                            </div>
                                        </div> 
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2"><h4>Thailand</h4></div>
                                            <div class="col px-2">
                                                <progress value="2" max="45"></progress><span>2%</span>
                                            </div>
                                        </div>            
                                        ...
                                        <div class="row mb-3 align-items-center progress1">
                                            ...
                                            <div class="col px-2">
                                                <progress value="1" max="45"></progress><span>1%</span>
                                            </div>
                                        </div>                                
                                        <div class="row mb-3 align-items-center progress1">
                                            <div class="col-lg-auto px-2">
                                            ...
                                            <div class="col px-2">
                                                <progress value="0.9" max="45"></progress><span>0.9%</span>
                                            </div>
                                        </div>                                
                                    </div> 
                                </div>
                        ...
                        <div class="tab-pane" id="pr_tab15" role="tabpanel">
