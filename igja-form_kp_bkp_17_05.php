...
$sql_innovative_company = "INSERT INTO igja_theme_based_innovative_company SET reg_id='$reg_id',amount_of_r_n_d_expenditure='$amount_of_r_n_d_expenditure',details_r_n_d_activities='$details_r_n_d_activities',innovation_activities_last_3_yr='$innovation_activities_last_3_yr',how_impact_innovation='$how_impact_innovation',registered_patents_for_innovation='$registered_patents_for_innovation',
                            award_and_accolades_won_details='$award_and_accolades_won_details',attatchments='$attatchments',amount_of_csr_expenditure='$amount_of_csr_expenditure',
...
$qualitative_information = "INSERT INTO igja_industry_perfomance_qualitative_info SET reg_id='$reg_id',business_details_and_explanation='$business_details_and_explanation',
                            ...
                            sm_title='$sm_title',name_w='$name_w',designation='$designation',experience='$experience',approach='$approach',approach_file='$approach_file',la_title='$la_title',la_name='$la_name',la_designation='$la_designation',la_experience='$la_experience',attatchment_details_la='$attatchment_details_la' ";
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="mb-4">
                ...
                <p class="text-center"> <strong> Last date for submission is <span style="background:#a89c5d; color:#fff; padding:3px;"> 10th June, 2022 </span> </strong> </p>
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" method="POST" name="general_info" id="general_info" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            <label>Zipcode*</label>
                            <input type="number" name="zipcode" id="zipcode" value="<?php echo $zipcode;?>" class="form-control">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="performance_award_category[]" id="performance_award_category" value="Cut & Polished Synthetic Stones" <?php if( in_array("Cut & Polished Synthetic Stones", $_POST['performance_award_category']) ){ echo "checked";}?>>02 Awards <br /> Precious Metal Jewellery - Plain & Studded (SME)
                                    </label>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="performance_award_category[]" id="performance_award_category" value="Cut & Polished Diamonds (Small)" <?php if( in_array("Cut & Polished Diamonds (Small)", $_POST['performance_award_category']) ){ echo "checked";}?>>01 Awards <br /> Cut & Polished Diamonds (Medium)
                                    </label>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="performance_award_category[]" id="performance_award_category" value="Cut & Polished Diamonds (Small)" <?php if( in_array("Cut & Polished Diamonds (Small)", $_POST['performance_award_category']) ){ echo "checked";}?>>01 Awards <br /> Cut & Polished Diamonds (Small)
                                    </label>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="performance_award_category[]" id="performance_award_category" value="Costume/Fashion Jewellery"  <?php if( in_array("Costume/Fashion Jewellery", $_POST['performance_award_category']) ){ echo "checked";}?>>01 Awards <br /> Cut & Polished Synthetic Stones
                                    </label>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Most Innovative Company" <?php if( in_array("Most Innovative Company", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Award for Best Innovation in Digital Marketing 
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Woman Entrepreneur of the Year" <?php if( in_array("Woman Entrepreneur of the Year", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Woman Entrepreneur of the Year
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Corporate Social Responsibility (CSR) Award" <?php if( in_array("Woman Entrepreneur of the Year", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br>Most Socially Responsible Company (CSR) Award
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" class="innovation_in_marketing_award" value="Innovation in Marketing Award" <?php if( in_array("Innovation in Marketing Award", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Innovation in Manufacturing Award
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Highest Gems and Jewellery Sales (Importer)" <?php if( in_array("Most Socially Responsible Company (Part C)", $_POST['theme_based_award_category']) ){ echo "checked";}?>>03 Awards <br> Highest Gems and Jewellery Sales (Importer)
                                    </label>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Exports to highest no of International Clients and Importing countries" <?php if( in_array("Most Socially Responsible Company (Part C)", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Exports to highest no of International Clients and Importing countries
                                    </label>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="highest_employment_on_roll_company" value="Highest Employment on roll of Company" <?php if( in_array("Highest Employment on roll of Company", $_POST['other_award_category']) ){ echo "checked";}?> >01 Awards <br /> Highest Employment On The Company Rolls
                                    </label>
                                </div>
                            
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="highest_taxpayer_company" value="Highest Taxpayer Company"  <?php if( in_array("Highest Taxpayer Company", $_POST['other_award_category']) ){ echo "checked";}?>>01 Awards  <br />Highest Taxpayer Company
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="new_business_award" value="New Business Award" <?php if( in_array("Highest Employment on roll of Company", $_POST['other_award_category']) ){ echo "checked";}?> >01 Awards <br /> Upcoming Exporter Of The Year
                                    </label>
                                </div>
                            
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="global_retailer_year" value="Global Retailer of the year"  <?php if( in_array("Highest Taxpayer Company", $_POST['other_award_category']) ){ echo "checked";}?>>01 Awards  <br />Global Retailer of the year 
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="global_retailer_year" value="Global Retailer of the year"  <?php if( in_array("Highest Taxpayer Company", $_POST['other_award_category']) ){ echo "checked";}?>>01 Awards  <br />Best in Gems and Jewellery E- Commerce Platform
                                    </label>
                                </div>
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" name="award_cat_specific_info" id="award_cat_specific_info"  method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="d-flex">
                        ...
                        <!-- <?php if($_SESSION != "general_info"){ ?>
                            <a href="http://localhost/gjepc/igja-form1.php" class=" gold_btn d-table" ></a>
                        <?php } ?> -->
        ...
        <div id="collapse-C" class="collapse" data-parent="#content" role="tabpanel" aria-labelledby="heading-C">
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" name="best_growing_perfomance" id="best_growing_perfomance"  method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row category_table_hide" >
                            ...
                            <table class="responsive_table category_table validate_cust">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-column="Export Sales (in INR. crore)"><input type="number" name="export_sales_rs_FY20[0]"  class="form-control numeric"></td>
                                        <td data-column="Export Sales (in US $)"><input type="number" name="export_sales_dollar_FY20[0]"  class="form-control numeric"></td>
                                    </tr>
                                    <!-- <tr>
...
<button type="button" class="addBtn">Add+</button>
                        ...
                        <div class="form-group col-12 category_table_hide">
                            ...
                            <table class="responsive_table category_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-column="Export Sales (in INR. crore)"><input type="number" name="export_sales_rs_FY19[0]"  class="form-control numeric"></td>
                                        <td data-column="Export Sales (in US $)"><input type="number" name="export_sales_dollar_FY19[0]"  class="form-control numeric"></td>
                                    </tr>
                                    <!-- <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 business_details_and_explanat"> 
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 strategic_export_initiat"> <textarea class="form-control" name="strategic_export_initiative"></textarea>  </div>
        ...
        <div id="collapse-D" class="collapse" data-parent="#content" role="tabpanel" aria-labelledby="heading-D">
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" name="qualitative_information" id="qualitative_information"  method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            <div class="row align-items-center">
                                ...
                                <div class="form-group col-12 attatchment_details"> <textarea class="form-control" name="attatchment_details"></textarea>  </div>
                        ...
                        <div class="form-group col-12 attatchment_details"><p style="font-size:13px;">Kindly provide details of your business and the key products exported by your company? Please explain your financials with respect to reasons for major trends in parameters such as growth or decline in Turnover, growth or decline in Profits, etc. (Please be as descriptive as possible by attaching additional documents)</p></div>

                        <div class="form-group col-12 attatchment_details"> <textarea class="form-control" name="business_details_and_explanation"></textarea>  </div>

                    </div>

                    <div class="row">

                        <div class="form-group col-12 strategic_export_initiative"> <p class="pb-2 gold_clr" style="border-bottom:1px dashed #a89c5d;"> <strong>Strategic Exports Initiatives</strong></p> </div>

                        <div class="form-group col-12 strategic_export_initiative"><p style="font-size:13px;">Kindly provide details of the initiatives your company has taken for marketing or branding of the products in international market. Also provide company's vision for increasing the market reach of the product.</p></div>

                        <div class="form-group col-12 strategic_export_initiat strategic_export_initiative"> <textarea class="form-control" name="strategic_export_initiative"></textarea>  </div>
                    ...
                    <div class="row number_comp_outlets">
                        ...
                        <div class="form-group col-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 mb-2"><textarea class="form-control" name="number_comp_outlets"></textarea></div>
                    ...
                    <div class="row number_of_internation_clients">
                        ...
                        <div class="form-group col-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 mb-2"><textarea class="form-control" name="number_of_internation_clients"></textarea></div>
                    ...
                    <div class="row woman_entrepreneur">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 col-lg-3 form-group">
                                    ...
                                    <input type="text" name="name_w" class="form-control">
                                </div>
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <textarea class="form-control" name="approach"></textarea> 
                                </div>
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" method="POST" name="innovative_company" id="innovative_company" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-12">
                            ...
                            <table class="responsive_table category_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td data-column="R&D Activities (INR Crore)"><input type="text" name="r_n_d_activities[0]" class="form-control "></td>
                                    ...
                                    <tr>
                                        <td data-column="R&D Activities (INR Crore)"><input type="text" name="r_n_d_activities[1]" class="form-control  "></td>
                                    ...
                                    <tr>
                                        <td data-column="R&D Activities (INR Crore)"><input type="text" name="r_n_d_activities[2]" class="form-control  "></td>
                                    ...
                                    <tr>
                                        <td data-column="R&D Activities (INR Crore)"><input type="text" name="r_n_d_activities[3]" class="form-control  "></td>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <table class="responsive_table category_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td data-column="CSR Activities (INR Crore)"><input type="text" name="csr_activities[0]" class="form-control "></td>
                                        <td data-column="FY2020-21"><input type="text" name="csr_activities_FY20[0]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="csr_activities_FY19[0]" class="form-control numeric "></td>
                                        <td data-column="FY2018-19"><input type="text" name="csr_activities_FY18[0]" class="form-control numeric "></td>
                                    </tr>
                                    
                                    <tr>
                                        <td data-column="CSR Activities (INR Crore)"><input type="text" name="csr_activities[1]" class="form-control"></td>
                                        <td data-column="FY2020-21"><input type="text" name="csr_activities_FY20[1]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="csr_activities_FY19[1]" class="form-control numeric "></td>
                                        <td data-column="FY2018-19"><input type="text" name="csr_activities_FY18[1]" class="form-control numeric "></td>
                                    </tr>
                                    
                                    <tr>
                                        <td data-column="CSR Activities (INR Crore)"><input type="text" name="csr_activities[2]" class="form-control  "></td>
                                        <td data-column="FY2020-21"><input type="text" name="csr_activities_FY20[2]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="csr_activities_FY19[2]" class="form-control numeric "></td>
                                        <td data-column="FY2018-19"><input type="text" name="csr_activities_FY18[2]" class="form-control numeric "></td>
                                    </tr>
                                    
                                    <tr>
                                        <td data-column="CSR Activities (INR Crore)"><input type="text" name="csr_activities[3]" class="form-control  "></td>
                                        <td data-column="FY2020-21"><input type="text" name="csr_activities_FY20[3]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="csr_activities_FY19[3]" class="form-control numeric "></td>
                                        <td data-column="FY2018-19"><input type="text" name="csr_activities_FY18[3]" class="form-control numeric "></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td data-column="FY2020-21"><input type="text" name="total_csr_activities_FY20" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="total_csr_activities_FY19" class="form-control numeric "></td>
                                        <td data-column="FY2018-19"><input type="text" name="total_csr_activities_FY18" class="form-control numeric "></td>
                                    </tr>
                        ...
                        <div class="form-group col-12">
                           <textarea class="form-control" name="details_of_csr"></textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                           <textarea class="form-control" name="innovation_of_manufacturing_details"></textarea>
                        </div>
                       ...
                       <div class="form-group col-12">
                            ...
                            <table class="responsive_table category_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td data-column="Sales from E- Commerce Platform (INR Crore)"><input type="text" name="e_commerce_activities[0]" class="form-control "></td>
                                        <td data-column="FY2020-21"><input type="text" name="e_commerce_activities_FY20[0]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="e_commerce_activities_FY19[0]" class="form-control numeric "></td>
                                    </tr>
                                    
                                    <tr>
                                        <td data-column="Sales from E- Commerce Platform (INR Crore)"><input type="text" name="e_commerce_activities[1]" class="form-control  "></td>
                                        <td data-column="FY2020-21"><input type="text" name="e_commerce_activities_FY20[1]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="e_commerce_activities_FY19[1]" class="form-control numeric "></td>
                                    </tr>
                                    
                                    <tr>
                                        <td data-column="Sales from E- Commerce Platform (INR Crore)"><input type="text" name="e_commerce_activities[2]" class="form-control  "></td>
                                        <td data-column="FY2020-21"><input type="text" name="e_commerce_activities_FY20[2]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="e_commerce_activities_FY19[2]" class="form-control numeric "></td>
                                    </tr>
                                    
                                    <tr>
                                        <td data-column="Sales from E- Commerce Platform (INR Crore)"><input type="text" name="e_commerce_activities[3]" class="form-control  "></td>
                                        <td data-column="FY2020-21"><input type="text" name="e_commerce_activities_FY20[3]" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="e_commerce_activities_FY19[3]" class="form-control numeric "></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td data-column="FY2020-21"><input type="text" name="total_e_commerce_activities_FY20" class="form-control numeric "></td>
                                        <td data-column="FY2019-20"><input type="text" name="total_e_commerce_activities_FY19" class="form-control numeric "></td>
                                    </tr>
...
woman_entrepreneur = false;best_in_gems_jewellery= false;best_in_gems= false;
...
rules: {
    ...
    "export_details_FY20[]":{
        required: function(){
            if (highest_gems_and_jeweller == true || highest_gems_and_jeweller == true) 
            {
                return true;
            } else {
                return false;
...
var innovation_in_marketing_award='';global_retailer_year='';
$('.new_business_award').click(function(){
    ...
    if(new_business_award == 'New Business Award' || highest_employment_on_roll_company=='Highest Employment on roll of Company' || highest_taxpayer_company == 'Highest Taxpayer Company' || 
        innovation_in_marketing_award == 'Innovation in Marketing Award' || global_retailer_year == 'Global Retailer of the year'){
...
$('.global_retailer_year').click(function(){
    ...
    if(new_business_award == 'New Business Award' || global_retailer_year == 'Global Retailer of the year' || highest_employment_on_roll_company=='Highest Employment on roll of Company' || highest_taxpayer_company == 'Highest Taxpayer Company' || 
        innovation_in_marketing_award == 'Innovation in Marketing Award' ){
        $('.company_details').show();
    }else {
        $('.company_details').hide(); 
        global_retailer_year = '';
...
$('.addBtn').click(function(){
    $(this).parent('.addTR_wrp').children('.responsive_table').children ('tbody').append('<tr><td><input type="text" class="form-control"></td><td><input type="number" class="form-control numeric"></td><td><input  type="number"type="number" class="form-control numeric"></td></tr>')
