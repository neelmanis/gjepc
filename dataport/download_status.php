...
if (($_REQUEST['registration_id']!=''))
  {
		...
		$_SESSION['activate_msg']="Download Status Acticate Successfully";
		 header('location:download_status.php');exit;
...
<div class="clear"></div>
<div class="text_heading_new">Download Status</div>
<div class="clear"></div>
	...
	?>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
                ...
                <tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
                  ...
                  <td width="19%">
                      <a href="download_status.php?registration_id=<?php echo $registration_id; ?>&download_status=N" onclick="return(window.confirm('Are You sure to Activate Status.'));"><?php echo "Activate"; ?></a>                  </td>
                </tr>
                <?php } else {?>
                <tr class="orange1"></tr>
                <tr>
