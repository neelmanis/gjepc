...
<div class="clear"></div>
<div class="text_heading_new">Manufacturer Download Date wise</div>
<div class="clear"></div>


<div style="margin: 0px auto;  margin-bottom:25px;">
<div>
		<form action="manufacture.php" method="post" name="form1" id="form1" enctype="multipart/form-data">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
                  ...
                  <tr>
                    ...
                    From <input type="text" id="date_from" name="date_from"/> To<input type="text" id="date_to" name="date_to"/>
                    </td>
                  </tr>
                  <tr>
                    <td align="left">&nbsp;</td>
