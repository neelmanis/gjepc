<?php 
$pageTitle = "Gems & Jewellery Industry | IMPORTS OF GEM & JEWELLERY - GJEPC India";
...
<section>
	...
	<div class="container inner_container">
		...
		<div id="import_2021" class="import_hide show statistic_Box" style="margin-bottom: 3rem">                                        
			<ul class="row p-3">
				<?php
