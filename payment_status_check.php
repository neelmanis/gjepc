...
while($result = $querys->fetch_assoc())
{
	...
	/*	$result1 = $conn ->query("update challan_master set Response_Code='E000',Unique_Ref_Number='$Unique_Ref_Number',ReferenceNo='$ReferenceNo',Transaction_Date='$Transaction_Date' where registration_id='$registration_id' and challan_financial_year='2020' and ReferenceNo='$ReferenceNo'");
