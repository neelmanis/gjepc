...
$digital_marketing_branding = filter($_POST['digital_marketing_branding']);
...
$sql_innovative_company = "INSERT INTO igja_theme_based_innovative_company SET reg_id='$reg_id',amount_of_r_n_d_expenditure='$amount_of_r_n_d_expenditure',details_r_n_d_activities='$details_r_n_d_activities',innovation_activities_last_3_yr='$innovation_activities_last_3_yr',how_impact_innovation='$how_impact_innovation',registered_patents_for_innovation='$registered_patents_for_innovation',
                            ...
                            digital_marketing_branding_video='$digital_marketing_branding_video',additional_sheets='$additional_sheets',digital_marketing_branding='$digital_marketing_branding',additional_sheets_video='$additional_sheets_video',relevant_material='$relevant_material',
                            relevant_material_video='$relevant_material_video',innovation_of_manufacturing='$innovation_of_manufacturing',e_commerce='$e_commerce',amount_e_commerce_activities='$amount_e_commerce_activities' ";
...
<div class="col-12" id="nav">
    ...
    <ul id="tabs" class="nav nav-tabs justify-content-center d-flex" role="tablist">
                     <?php //$_SESSION['step'] ="qualitative_information"; ?>       
        <li class="nav-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Most Innovative Company" <?php if( in_array("Most Innovative Company", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Most Innovative Company
                                    </label>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" value="Corporate Social Responsibility (CSR) Award" <?php if( in_array("Woman Entrepreneur of the Year", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Corporate Social Responsibility (CSR) Award
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="theme_based_award_category[]" id="theme_based_award_category" class="innovation_in_marketing_award" value="Innovation in Marketing Award" <?php if( in_array("Innovation in Marketing Award", $_POST['theme_based_award_category']) ){ echo "checked";}?>>01 Awards <br> Innovation in Marketing Award
                                    </label>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row award_input_box">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="highest_employment_on_roll_company" value="Highest Employment on roll of Company" <?php if( in_array("Highest Employment on roll of Company", $_POST['other_award_category']) ){ echo "checked";}?> >03 Awards <br /> Highest Employment on role of Company
                                    </label>
                                </div>
                            
                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="highest_taxpayer_company" value="Highest Taxpayer Company"  <?php if( in_array("Highest Taxpayer Company", $_POST['other_award_category']) ){ echo "checked";}?>>03 Awards  <br />Highest Taxpayer Company
                                    </label>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="">
                                        <input type="checkbox" name="other_award_category[]" id="other_award_category" class="new_business_award" value="New Business Award" <?php if( in_array("Highest Employment on roll of Company", $_POST['other_award_category']) ){ echo "checked";}?> >01 Awards <br /> New Business Award
                                    </label>
                                </div>
                    ...
                    <div class="row company_details" style="display: none;">
                        ...
                        <div class="form-group col-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6"><input type="file" name="annual_report[]" id="annual_report" class="form-control" multiple="multiple"><label>(upload max file size 2MB. jpeg,png,jpg,doc,docx,csv,excel,pdf)</label name="annual_report"><label></label> </div>
                            </div>
                        </div>
        ...
        <div id="collapse-F" class="collapse" data-parent="#content" role="tabpanel" aria-labelledby="heading-F">
            ...
            <div class="card-body p-0">
                ...
                <form class="box-shadow" method="POST" name="innovative_company" id="innovative_company" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row digital_marketing_branding" style="display:none">
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea class="form-control" name="digital_marketing_branding"></textarea>
                    ...
                    <div class="row award_and_accolades_won_details" style="display:none">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 details_of_csr" style="display:none;">
...
var innovation_in_marketing_award =false;
...
if(innovation_in_marketing_award == true){
    $('.details_of_innovation').show();
    $('.innovation_of_manufacturing_details').show();
}
if(best_digital_initiative == true){
    $('.digital_marketing_branding').show();
}
