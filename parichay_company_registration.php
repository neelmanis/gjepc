...
<section class="py-5">	
    <div class="container-fluid inner_container">
		<div class="row justify-content-center grey_title_bg">           	
			...
			<div class="d-block"><img src="assets/images/gold_star.png"></div>Firm/Company registration </div>
        </div>
		...
		<div class="langBtn d-table mx-auto" style="position:relative; top:auto">
            <div class="d-flex justify-content-center mb-3 lang_switcher">
                <div><button onclick="location.href = 'parichay_company_registration.php';" class="lang active">English</button></div>
                <div><button onclick="location.href = 'parichay_company_registration-hindi.php';" class="lang">Hindi</button></div>
            </div>
        </div>  
            ...
            <div class="container">				
				...
				<?php if(isset($signup_aadhar)){ echo '<div class="alert alert-danger" role="alert">'.$signup_aadhar.'</div>';} ?>
                    ...
                    <div class="form-group col-12 mb-4">
			            <p class="blue tr" >Company Enrollment Process</p>
			        </div>                   
			                              
                        <div class="col-12 mb-3">
          	                <ul class="inner_under_listing">Note:
                          	    <li>(Allowed file types:jpeg,png,pdf & File upload max size 2 MB)</li>
                          	    <li><a href="https://gjepc.org/pdf/Request-Letter-Format-Company-Parichay-Card.pdf" target="_blank"  style="color: blue">Download Request Letter Format <i class="fa fa-arrow"></i></a></li>
                            </ul> 
                        </div>   
                        <hr>
                            ...
                            <label for="association_request_letter">Please upload the application request on your company letter head along with stamp and signature of the authorised signatory<span>*</span></label>
							...
							<div class="form-group col-sm-6">
                            <label for="association_registration_certificate">Please upload scanned copy of company registration details<span>*</span></label>
							...
							<div class="form-group col-sm-6">
                            <label for="association_head_visiting_card">Please upload the scanned copy of visiting card</label>
							...
							<label for="total_member">Total No. of employees in your Company as on date <span>*</span></label>
							...
							<div class="form-group col-md-6">
                            <div class="d-block"><label for="nature_of_business" class="tr" key="Business"><strong>Company Type</strong></label></div>
							<label>
							...
							Coloured Gemstone</label>
							<label class="mr-2">
							<input type="checkbox" name="nature_of_buisness[]" class="mr-2" id="nature_of_buisness" value="Retailer">		Retailer</label>
							<label>
							<input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Trader">Trader
							</label>
							<label><input type="checkbox" name="nature_of_buisness[]" id="nature_of_buisness" value="Job_work">Job Work
							</label>
							<label>
							...
							<label>
                            <input type="checkbox" name="nature_of_buisness[]" id="other" value="other">Other 
							</label>
						...
						<div class="form-group col-sm-6">
                        <label for="association_office_address">Please upload scanned proof of address of Company office (Electricity Bill, Phone Bill etc. not older than 3 months)</label>
                        <input type="file" id="association_office_address" name="association_office_address" class="form-control" autocomplete="off">
                        </div>
						
						<div class="form-group col-md-6">
                        <label for="no_of_parichay_card">No. of Parichay Cards required by your company<span>*</span></label>
                        <br>
                        <br>
						...
						<div class="form-group col-12 mb-4">
                        <p class="blue">Details of Authorized person from company for coordination and verification of information:</p> </div> 
