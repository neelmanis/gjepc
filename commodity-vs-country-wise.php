...
if($_REQUEST['Reset']=="Reset")
{
		  ...
		  header("Location: commodity-vs-country-wise.php");
} else {
    ...
    <div class="row justify-content-center">
            ...
            <div class="row">
                ...
                <div class="form-group col-12 mb-4">
                    <p class="blue text-center">EXPORTS - COMMODITY X COUNTRY-WISE</p>
                </div>
		...
		?>
            ...
            <div class="col-12">
                        <div class="row py-3"  style="border-top: 1px solid #ccc">
                            <div class="col-12"><h2 class="title text-center mb-1"><span class="d-table mx-auto mb-3" style="width:35px;"><img src="assets/images/black_star.png" class="img-fluid d-block"></span>EXPORTS - COMMODITY X COUNTRY-WISE</h2></div>
                            ...
                            <div class="col-12">
                                        	...
                                        	<ul>
                                                ...
                                                <li>
                                                	<div class="row">
                                                        ...
                                                        <div class="col-md-8 sResult"><?php echo $_POST['commodity']; ?></div>
                                                    </div>
                                                </li>
												<li>
                                                	<div class="row">
                                ...
                                <div class="d-flex justify-content-start"> 
								   <button onclick="exportToExcel('tblexportData', 'commodity-vs-country-wise-export')" class="cta gold_btn" title="Export To Excel"><i class="fa fa-file-excel-o" style="font-size: 40px;"></i></button>
                                </div>
					...
					/* Same */		if(getFinancialYear($conn)==$financial_year){ $sameYear = "YES"; } else { $sameYear = "NO"; }
									...
									{										
										if($currency!="")
										{
											...
											$getPreviousFinancialYearData = getPreviousFinancialYearCountryINR($last_finyr,$row['country_id'],$hscodes,$sameYear,$currentMonth,$conn);
										...
										//	$newTotal_Paisa  = round($row['total_usd']/$_POST['currency_usd'],2);
											...
											$getPreviousFinancialYearData =  getPreviousFinancialYearCountryUSD($last_finyr,$row['country_id'],$hscodes,$sameYear,$currentMonth,$conn);
						...
						<td class="text-center"><?php if($currency=="INR"){ echo round($grandTotalLastINR,2); } else { echo round($grandTotalLastUSD,2); }?></td>
						<td class="text-center"><?php if($currency=="USD"){ echo round($grandTotalUSD,2); } else { echo round($grandTotalINR,2); }?></td>
