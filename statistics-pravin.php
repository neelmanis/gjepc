                ...
                <div id="content" class="tab-content" role="tablist">
                            ...
                            <div class="card-body p-lg-0">                                            
                                <div class="row justify-content-center">                                        
                                    <div class="col-12 col-lg-6 mb-5 mb-lg-0">                                      
                                        ...
                                        <div style="border-bottom: 1px solid #A59459; padding: 0; display:table; margin: 10px auto 0; font-weight: bold;">
                                        <a href="exports-of-gem-&-jewellery-pravin.php" class="col-12 p-0">View Previous Years</a> 
                                        </div>
                                    ...
                                    <div class="col-12 col-lg-6">                                       
                                        ...
                                        <div style="border-bottom: 1px solid #A59459; padding: 0; display:table; margin: 10px auto 0; font-weight: bold;">
                                        <a href="imports-of-gem-&-jewellery-pravin.php" class="col-12 p-0">View Previous Years</a> 
                                        </div>                                       
                                    </div>                              
                                </div>                                                          
                            </div>
                    ...
                    <div id="pane-C" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-C">
                        ...
                        <div id="collapse-C" class="collapse" data-parent="#content" role="tabpanel" aria-labelledby="heading-C"> 
                            ...
                            <div class="row analytical-reports"> 
                                <div class="col-6 mb-3">
                                    <a href="gem-&-jewellery-trade-update-monthly-pravin.php" class="py-4 px-3 d-block" style="border: 2px solid #A89C5D;">Gem & Jewellery Trade Update - Monthly 
                                    <i class="fa fa-angle-right" aria-hidden="true"></i>
                                    </a>
                                </div>

                                <div class="col-6 mb-3">
                                    <a href="gem-&-jewellery-trade-update-report-quarterly-pravin.php" class="py-4 px-3 d-block" style="border: 2px solid #A89C5D;">
                                        Gem & Jewellery Trade Update Report (Quarterly) 
                                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                                    </a>
                                </div>

                                <div class="col-6">
                                    <a href="research-reports-pravin.php" class="py-4 px-3 d-block" style="border: 2px solid #A89C5D;">
                                        Research Reports 
                                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                                    </a>
                                </div>
                                ...
                                <div class="col-6">
                                    <a href="economy-updates-pravin.php" class="py-4 px-3 d-block" style="border: 2px solid #A89C5D;">
                                        Economy Updates
                                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                                    </a>
                                </div>
...
<script src="assets-new/js/Chart.min.js" defer></script> 
<script src="assets/js/pravin.js" ></script> 
