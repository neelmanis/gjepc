...
<link rel="stylesheet" href="assets/css/new/general2.css">
<link rel="stylesheet" href="assets/css/new/inner_page2.css">
        ...
        <nav class="sina-nav mobile-sidebar navbar-transparent navbar-fixed" data-top="40" data-md-top="40" data-xl-top="40">
			...
			<div class="container">
                ...
                <div class="container sina-nav-header social-on">
                    ...
                    <a class="sina-brand" href="index.php"><img src="assets/images/logo-new.png"></a>
                    
                    <div class="head_right">                    
                    	<div class="d-flex mb-2 justify-content-end wl_wrp">                        	
                            <div>
                    ...
                    <li><a href="" class="instagram" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                   	<li><a href="" class="linkedin" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                        ...
                        <div class="d-flex position-relative log_reg_btn">
                      		<div class="mr-3"><a href="my_account.php"> <span> <?php echo htmlentities(strip_tags($_SESSION['COMPANYNAME']));?></span> <i class="fa fa-user" aria-hidden="true"></i> </a></div>
                            <div><a href="logout.php" class="reg_btn" class="active"> <span> Logout</span> <i class="fa fa-pencil-square" aria-hidden="true"></i></a></div>
                        </div>
						<?php }else if(isset($_SESSION['vendorId'])){?>
						<div class="d-flex position-relative log_reg_btn">
                      		<div class="mr-3"><a href="vendor_profile.php"> <span> <?php echo htmlentities(strip_tags($_SESSION['company_name']));?></span> <i class="fa fa-user" aria-hidden="true"></i> </a></div>
                            <div><a href="logout.php" class="reg_btn" class="active"> <span> Logout</span> <i class="fa fa-pencil-square" aria-hidden="true"></i></a></div>
                        </div>
						<?php }else{?>
						<div class="d-flex position-relative log_reg_btn">
                      		<div class="mr-3"><a href="login.php"> <span> Login </span> <i class="fa fa-user" aria-hidden="true"></i> </a></div>
