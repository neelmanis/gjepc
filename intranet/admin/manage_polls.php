...
if ($_REQUEST['action']=='save')
{
		...
		$sql="INSERT INTO poll_master (question,opt1,opt2,opt3,opt4,c_answer,status,post_date) VALUES ('$question','$opt1','$opt2','$opt3','$opt4','$c_answer','1','$post_date')";
		if (!mysql_query($sql,$dbconn))
			{
				die('Error: ' . mysql_error());
			}
		...
		mysql_query($option_insert1);
		mysql_query($option_insert2);
		mysql_query($option_insert3);
		mysql_query($option_insert4);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
	...
	$result = mysql_query("SELECT * FROM poll_master where 1".$attach." ");
    $rCount=0;
    ...
    ?>  
 	<tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
        ...
        <td><a href="view_answer.php?action=view&id=<?php echo $row['id'];?>">View Answer Percentage</a></td>
       <td><a href="view_who_answer.php?action=view&id=<?php echo $row['id'];?>">View who all answer</a></td>
	   <td>
		<?php if($row['status'] == '1') 
        { 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
    ...
    <td><select class="input_txt" name="c_answer" id="c_answer">
