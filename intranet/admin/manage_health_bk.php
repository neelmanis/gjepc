...
if ($_REQUEST['action']=='save')
{
	//$post_date = date('Y-m-d');
	 ...
	 $h_desc=addslashes($_REQUEST['h_desc']);
						...
						$sql="INSERT INTO health_master (name,long_desc,status,post_date) VALUES ('$h_name','$h_desc','1','$post_date')";	
						if (!mysql_query($sql,$dbconn))
						{
							die('Error: ' . mysql_error());
						}
...
if ($_REQUEST['action']=='update')
{
	$id = $_REQUEST['id'];
	 ...
	 $h_desc=addslashes($_REQUEST['h_desc']);
						...
						$sql="update health_master set name='$h_name',long_desc='$h_desc',status='1',post_date='$post_date' where id='$id' ";	
						if (!mysql_query($sql,$dbconn))
						{
							die('Error: ' . mysql_error());
						}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
    ...
    <td><input type="date" name="p_date" id="p_date" class="input_txt" value="<?php echo $post_date;?>" /></td>
    </tr>
