...
{
	$sql="delete from announcement_master where id='$_REQUEST[id]'";
	
	if (!mysql_query($sql,$dbconn))
	{
		die('Error: ' . mysql_error());
	}
	echo"<meta http-equiv=refresh content=\"0;url=manage_announcement.php?action=view\">";
}
...
if (($_REQUEST['action']=='active') && ($_REQUEST['id']!=''))
{
		...
		$id=$_REQUEST['id'];
		$sql="update announcement_master set status='$status' where id='$id'";
		if (!mysql_query($sql,$dbconn))
		{
			die('Error: ' . mysql_error());
		}
...
if ($_REQUEST['action']=='save')
{
	//$post_date = date('Y-m-d');
	 ...
	 $announcement=addslashes($_REQUEST['announcement']);
	 //$dept=addslashes($_REQUEST['dept']);
				
						$sql="INSERT INTO announcement_master (announcement,status,post_date) VALUES ('$announcement','1','$post_date')";	
						if (!mysql_query($sql,$dbconn))
						{
							die('Error: ' . mysql_error());
						}
...
<div id="main">
	<div class="content">
    	<div class="content_head"><a href="manage_announcement.php?action=add"><div class="content_head_button">Add Announcements</div></a> <a href="manage_announcement.php?action=view"><div class="content_head_button">View Announcements</div></a> </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail_txt" >
	...
	$result = mysql_query("SELECT * FROM announcement_master where 1".$attach." ");
    $rCount=0;
    ...
    ?>  
 	<tr <?php if($i%2==0){echo "bgcolor='#CCCCCC'";}?>>
        <td><?php echo $i;?></td>
        <td><?php echo stripslashes($row['announcement']); ?></td>
        ...
        <td><a href="manage_announcement.php?action=del&id=<?php echo $row['id']; ?>" onClick="return(window.confirm('Are you sure you want to delete?'));"><img src="images/delete.png" title="Delete" border="0" /></a></td>
 	</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
    ...
    <tr>
    <td class="content_txt">Announcement <span class="star">*</span></td>
    <td><textarea id="announcement" name="announcement"></textarea>  </td>
    </tr>
