...
<div class="gallery_main_div">
		...
		/*echo '<video width="800" height="500" controls>
  <source src="//kwms/Gjepc_intranet/gallary_videos/'.$row['img_name'].'" type="video/mp4">
  <track src="//kwms/Gjepc_intranet/gallary_videos/'.$row['img_name'].'" kind="subtitles" srclang="en" label="English">
  <source src="//kwms/Gjepc_intranet/gallary_videos/'.$row['img_name'].'" type="video/ogg">
Your browser does not support the video tag.
        ...
        <span> <img src="images/download.jpg"  /> <!--<embed src="//kwms/Gjepc_intranet/gallary_videos/<?php echo $row['img_name'];?>"
 autostart="false" width="185" height="150" />--><!-- <video id="video1" width="420">
    <source src="//kwms/Gjepc_intranet/gallary_videos/<?php echo $row['img_name'];?>" type="video/mp4">
    <source src="mov_bbb.ogg" type="video/ogg">
    Your browser does not support HTML5 video.
  </video>--></span>
        </br>
        <a class="fancybox" href="#inline1"><?php echo $row['img_name'];?></a></a>        
        </div>
    <?php  }?>
    	<!--<div class="photo_box">
        <a href="#">
...
<div id="inline1" style="display: none; background:#000;">
   <?php
        $query = "select * from videos_master where status=1 limit 1";
		$result = mysql_query($query);
   ...
   <param name="movie" value="//kwms/Gjepc_intranet/gallary_videos/<?php echo $row['img_name'];?>"></param>
   <param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param>
   <embed src="//kwms/Gjepc_intranet/gallary_videos/<?php echo $row['img_name'];?>" type="application/x-shockwave-flash" width="185" height="150" allowscriptaccess="always" allowfullscreen="true">
   </embed>
   </object>
<!-- <video preload="none" height="180" width="320" controls="" src="//kwms/Gjepc_intranet/gallary_videos/<?php echo $row['img_name'];?>">
 ...
 <!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="800" height="500" id="FLVPlayer">
		 ...
		 <param name="flashVars" value="config={'playlist':['//kwms/Gjepc_intranet/gallary_images/desert.jpg',{'url':'//kwms/Gjepc_intranet/gallary_videos/<?php echo $row['img_name'];?>','autoPlay':false}]}" />
		  ...
		  <!--<object type="application/x-shockwave-flash" data="FLVPlayer_Progressive.swf" width="800" height="500">-->
		   ...
		   <!-- <param name="quality" value="high" />
		    ...
		    <param name="scale" value="noscale" />
		    <param name="salign" value="lt" />
		    <param name="FlashVars" value="&amp;MM_ComponentVersion=1&amp;skinName=Clear_Skin_2&amp;streamName=video/test&amp;autoPlay=false&amp;autoRewind=false" />
		    <param name="swfversion" value="8,0,0,0" />
		    <param name="expressinstall" value="Scripts/expressInstall.swf" />-->
