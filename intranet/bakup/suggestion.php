...
<div class="page_container">
	...
	<div class="page_title">Suggetions</div>
    
    <p>Kindly give your Suggestions below -</p>
...
<div class="clear" style="height:30px; background: url(images/nav_bg.png);"></div>
    <ul>
        ...
        <li  class="active"><a href="suggestion.php">Suggestion</a></li>
    </ul>
