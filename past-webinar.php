...
<section>
    ...
    <div class="container">
        ...
        $sql_webinars = "SELECT * FROM webinar_master WHERE type='webinar' AND status='1' AND post_date <= CURDATE() ORDER BY post_date DESC";
                            ...
                            <div class="p-4 webinarBrief">
                                ...
                                <div class="row ab_none justify-content-between mb-4">
                                    ...
                                    <div class="col pl-5">
                                        ...
                                        <?php if($row_webinars['start_time'] !=""){?>
        ...
        $sql_workshop = "SELECT * FROM webinar_master WHERE type='workshop' AND status='1' AND post_date <= CURDATE() ORDER BY post_date DESC";
                                ...
                                <div class="row ab_none justify-content-between mb-4">
                                    ...
                                    <div class="col pl-5">
                                        ...
                                        <div class="d-block webinarDay mb-2 goldBg"><?php echo date("l j M, Y ", strtotime($row_workshop['post_date']));?></div>
                                         <?php if($row_workshop['start_time'] !=""){?>
