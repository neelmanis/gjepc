...
include 'functions.php';
	...
	$sql="SELECT * from statistics_integration_hscode_master where 1 AND level='4' order by hs_code asc";	
                                ...
                                <table class="table table-bordered tableInfo">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>HS Code</th>
                                            <th>Commodity</th>
                                            <th>HS Code digit level option</th>
                                        </tr>
                                    </thead>
                                    <tbody>
									<?php 
									...
									{ ?>
										 <tr>
											...
											if(isset($_SESSION['commoditySel']) && $_SESSION['commoditySel']=="allCommodity"){
												if($row['level']=="4"){ ?><a target="_blank" href="hs_code_list6.php?hs=<?php echo $row['hs_code'];?>"><u>6</u></a> <a target="_blank" href="hs_code_list8.php?hs=<?php echo $row['hs_code'];?>"><u>8</u></a><?php } 
											} 
											if(isset($_SESSION['commoditySel']) && $_SESSION['commoditySel']=="SpecificCommodity"){
												if($row['level']=="2"){ ?>
												<a target="_blank" href="hs_code_list4.php?hs=<?php echo $row['hs_code'];?>"><u>4</u></a>
												<a target="_blank" href="hs_code_list6.php?hs=<?php echo $row['hs_code'];?>"><u>6</u></a>
												<a target="_blank" href="hs_code_list8.php?hs=<?php echo $row['hs_code'];?>"><u>8</u></a>
												<?php }
												else if($row['level']=="4"){ ?>
												<a target="_blank" href="hs_code_list6.php?hs=<?php echo $row['hs_code'];?>"><u>6</u></a>
												<a target="_blank" href="hs_code_list8.php?hs=<?php echo $row['hs_code'];?>"><u>8</u></a>
